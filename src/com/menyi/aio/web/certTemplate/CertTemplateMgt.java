	                   ...
	                   public void execute(Connection conn) throws
	                       ...
	                       try {
	                    	   ...
	                    	   for(CertificateTemplateBean tb:bean.getTempList()){
	                    		   ...
	                    		   selSql = "insert into certificateTemplate(id,tableName,accCode,dirc,fieldName,curFieldName,companyCode,departmentCode,employee,stockCode,goodsCode,currency,CurrencyRate,projectCode,comment ,f_ref,subAccount) " +
	                    		   		...
	                    		   		tb.getProjectCode()+"','"+tb.getComment()+"','"+bean.getId()+"','"+tb.getSubAccount()+"')" ;
        ...
        try {
    	   ...
    	   if(rss.next()){
    		  ...
    		  // selSql = "select id,tableName,accCode,dirc,fieldName,curFieldName,companyCode,departmentCode,employee,stockCode,goodsCode,currency,CurrencyRate,projectCode,comment from certificateTemplate where f_ref=?" ;
    		   selSql = "select id,tableName,accCode,dirc,fieldName,curFieldName,companyCode,departmentCode,employee,stockCode,goodsCode,currency,CurrencyRate,projectCode,comment,subAccount from certificateTemplate where f_ref=?" ;
        	   ps2 = conn.prepareStatement(selSql) ;
        	   ...
        	   while(rss.next()){
        		   ...
        		   tb.setSubAccount(rss.getString("subAccount"));
