	...
	public void cardscan(HttpServletRequest req, HttpServletResponse rsp) throws IOException{
    	...
    	try{
	    	...
	    	if("OK".equals(msg.getCode())){
	    		...
	    		//if("success".equals(r.get("code"))){ //通过bol88URL 返回调用接口的信息
	    		if(true){ //测试
	    			//HashMap map = (HashMap)r.get("data"); //通过bol88URL 返回调用接口的信息
	    			HashMap map = new HashMap();
	    			map.put("mykey", "LVhMw24P27B9ZF2rc3N2pU"); //测试
	    			map.put("secret", "d905245b82b34e0b925f40b54cb774c4");//测试
	    			map.put("BALANCE", 10.0);//测试
