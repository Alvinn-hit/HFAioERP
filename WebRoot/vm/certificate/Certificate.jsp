...
<script type="text/javascript"> 
	...
	$(function(){		
		$(".leftMenu2[val=$!tempNumber]").click();
	});
</script>	
		...
		<tr>
			<td width="120px" style="border-right:1px #a1a1a1 dashed;border-top:1px #a1a1a1 dashed;padding:0 5px 0 0;" valign="top">
				...
				<div class="leftMenu" id="t_lm" >
					...
					<div class="leftMenu2" id="lm_$!row.id" onclick="changeBill('$row.tempNumber','$row.tableName','$row.popupName','$row.tempName');" val='$row.tempNumber'>
