...
<form id="form" name="form" method="post" action="/CashierSettingAction.do" target="formFrame">
<input type="hidden" name="operation" value="$globals.getOP("OP_CASHIERSET_SAVE")"/>
<input type="hidden" name="tableName" id="tableName" value="tblCashierSetting" />
...
<div style="width:90%;margin:0 auto;padding:5px 0 5px 0;overflow:hidden;">
	<div style="float:left;display:inline-block;">
		...
		<h3 style="font: bold 14px '微软雅黑';float:left;display:inline-block;line-height:32px;">出纳设置</h3>
	</div>
