...
<script type="text/javascript">	
	var moduleId = "$LoginBean.getOperationMap().get("/CashierAction.do?operation=105").moduleId";
	var curAcc = "edit_refAcc";
	$(function(){
		#if(!$!accCode)
	...
	function quote_add(){		
		...
		data.way = $("input[name=quote_way]:checked").val();
		data.date = $("input[name=quote_date]:checked").val();
		...
		<ul class="edit_content">
			...
			<li class="edit_row">
				...
				<div class="edit_refAcc_div">
					<input type="text" class="edit_refAcc" id="edit_refAcc" onkeyup="Cashier_refAcc(this,'AccInfoAccDet','AccCodeName','选择科目')" />
		...
		<ul class="add_content">
			<li class="add_row">
				...
				<select class="add_accCode">
					#foreach($row in $AccCodes)
							<option value="$!row.AccNumber">$!row.AccName</option>
					#end
					<!-- <option value='1001'>1001 现金</option>-->
				</select>
				<span>币 别：</span>
			...
			<li class="add_row">
				...
				<div class="add_refAcc_div">
					<input type="text" class="add_refAcc" id="add_refAcc" onkeyup="Cashier_refAcc(this,'AccInfoAccDet','AccCodeName','选择科目')" />
		...
		<div class="data_body">
			<table>
				<thead>
					<tr>
						<th width=20>No</th>						
						<th width=16><input type="checkbox" class="checkSelected(this)" /></th>						
						<th width=15>审核</th>
						<th width=15>过账</th>
						<th>日期</th>
						<!--<th>序号</th>-->
