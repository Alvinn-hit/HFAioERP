...
<input type="hidden" id="type" name="type" value=""/>
	...
	<div class="btndiv">
		...
		<script type="text/javascript"> 
			...
			<thead >
				<tr id="trTitle" >
					<td class="tdDes3" rowspan="$!row">No.</td>
				...
				<tr style="line-height: 24px;" onclick="setBacks(this)">
					...
					#foreach ($element in $list)
							...
							#foreach($currency in $!currencyList)
								...
								<td id="moneys" class="$!classType tdDes1 hideBottom">$!curData</td>
								#set($curData = "")
								#set($curName = "")
								#set($curId = "")
							#end
						...
						<td id="moneys" class="$!classType tdDes1 hideBottom">$!valueData</td>
						#set($valueData="")
					#end
				</tr>
				#set($count = $!count+1)
