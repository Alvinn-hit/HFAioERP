...
//打印
function nowPrint(){
	var sHeight = jQuery("#contentDiv").height();
	jQuery("#contentDiv").height("100%");
	var htm = jQuery("#contentBox").html();		
	jQuery(document.body).html(htm);
	
	window.print();
	jQuery("#contentDiv").height(sHeight);
	jQuery(document.body).html("<div id='contentBox'>"+htm+"</div>");
}
