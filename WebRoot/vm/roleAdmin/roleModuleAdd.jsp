						...
						<tr>	
							...
							<td style="text-align:center;">
								...
								#foreach ($mop in $child.moduleoperationinfo)
										...
										#set($num=$num+1)
										<input id="check" val=$mop.operationID type="checkbox" mcd="$operation.value" mid="" mod="$child.getId().trim()" value="$mop.moduleOpId" mall=mall   name="moduleOperations" #if($roleModules.get($mop.moduleOpId)) #set($selectnum=$selectnum+1) checked #end style="border:0px;width:16px;"/>
									#end
