...
<title>$mainTable.display.get("$globals.getLocale()")123</title>
...
jQuery(document).ready(function(){
	...
	initCalculate();
	initMainCaculate();
	#if( "$!globals.getVersion()"=="3"  || "$!globals.getVersion()"=="12" || "$!globals.getVersion()"=="13" || "$!globals.getVersion()"=="11")
		initCountCal();
	#end 
...
<div class="Heading" >
	...
	<ul class="HeadingButton f-head-u">
		...
		<li><span class="btn btn-small"  defbtn="backList" onClick="saveDraft2();">$text.get("common.lb.saveDraft")</span></li>		
		#end
#end
