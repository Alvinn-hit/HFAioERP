					...
					if(data.code=='OK'){
						...
						for(var o in list){
							...
							htm += "<td>"+list[o].no+"</td><td colspan='3'>"+list[o].ComFullName+"</td><td>"+(list[o].year != undefined ? list[o].year:"")+"</td>"+
								   ...
								   "<td>"+(list[o].type != undefined ? list[o].type:"")+"</td><td colspan='2'>"+(list[o].name != undefined ? list[o].name:"")+"</td>"+
								   "<td>"+(list[o].GoodsSpec != undefined ? list[o].GoodsSpec:"")+"</td><td>"+(list[o].unit != undefined ? list[o].unit:"")+"</td>"+
								   "<td>"+(list[o].ProSalesPrice != undefined ? list[o].ProSalesPrice :"")+"</td><td>"+(list[o].salesCount != undefined ? list[o].salesCount:"")+"</td>"+
