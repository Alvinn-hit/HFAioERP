...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_feiyongbaoxiaodan','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_feiyongbaoxiaodan','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function checkTable(allHidFields){
 ...
 var labelText = $("input[name='field_11']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("金额1"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("金额1"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_12']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("报销用途2"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("报销用途2"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_13']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("金额2"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("金额2"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_14']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("报销用途3"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("报销用途3"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_15']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("金额3"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("金额3"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_16']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("报销用途4"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("报销用途4"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_17']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("金额4"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("金额4"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_18']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("拾万"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("拾万"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_19']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("万"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 ...
 var labelText = $("input[name='field_20']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("仟"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 ...
 var labelText = $("input[name='field_21']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("佰"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 ...
 var labelText = $("input[name='field_26']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("原借款"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("原借款"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("应退余款"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("应退余款"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("附件页"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("附件页"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
...
function countVal(Id){ 
 ...
 var result;
 if("field_3"==Id){
 var docText="count({field_11}+{field_13}+{field_15}+{field_17})";
 var re=/{.[^{}]*}/g; 
