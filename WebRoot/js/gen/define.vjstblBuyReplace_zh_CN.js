...
{ 
 cFireEvent('tblBuyReplaceDet_Qty',''); 
 cFireEvent('tblBuyReplaceDet_Price',''); 
 cFireEvent('tblBuyReplaceDetail_Qty',''); 
 cFireEvent('tblBuyReplaceDetail_Price',''); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblBuyReplace&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblBuyReplace&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblBuyReplace&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblBuyReplace&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblBuyReplaceDetTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblBuyReplaceDetailTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 ...
 var z=n('tblBuyReplaceDet_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDetail_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDetail_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDetail_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDetail_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDetail_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyReplaceDetail_Seq');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblBuyReplaceDet"){
 
 copyFields=n('tblBuyReplaceDet_StockCode');
 ...
 var tblBuyReplaceDet_tblStock_StockFullName1 = n('tblBuyReplaceDet_tblStock_StockFullName1');
 if(typeof(tblBuyReplaceDet_tblStock_StockFullName1) != 'undefined' && tblBuyReplaceDet_tblStock_StockFullName1.length >index){
 tblBuyReplaceDet_tblStock_StockFullName1[index].value = tblBuyReplaceDet_tblStock_StockFullName1[index-1].value;
 }
 }
 copyFields=n('tblBuyReplaceDet_GoodsCode');
 if((order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblBuyReplaceDet_tblGoods_GoodsNumber = n('tblBuyReplaceDet_tblGoods_GoodsNumber');
 if(typeof(tblBuyReplaceDet_tblGoods_GoodsNumber) != 'undefined' && tblBuyReplaceDet_tblGoods_GoodsNumber.length >index){
 tblBuyReplaceDet_tblGoods_GoodsNumber[index].value = tblBuyReplaceDet_tblGoods_GoodsNumber[index-1].value;
 }
 var tblBuyReplaceDet_tblGoods_GoodsFullName = n('tblBuyReplaceDet_tblGoods_GoodsFullName');
 if(typeof(tblBuyReplaceDet_tblGoods_GoodsFullName) != 'undefined' && tblBuyReplaceDet_tblGoods_GoodsFullName.length >index){
 tblBuyReplaceDet_tblGoods_GoodsFullName[index].value = tblBuyReplaceDet_tblGoods_GoodsFullName[index-1].value;
 }
 var tblBuyReplaceDet_tblGoods_GoodsSpec = n('tblBuyReplaceDet_tblGoods_GoodsSpec');
 if(typeof(tblBuyReplaceDet_tblGoods_GoodsSpec) != 'undefined' && tblBuyReplaceDet_tblGoods_GoodsSpec.length >index){
 tblBuyReplaceDet_tblGoods_GoodsSpec[index].value = tblBuyReplaceDet_tblGoods_GoodsSpec[index-1].value;
 }
 var tblBuyReplaceDet_tblGoods_BaseUnit = n('tblBuyReplaceDet_tblGoods_BaseUnit');
 if(typeof(tblBuyReplaceDet_tblGoods_BaseUnit) != 'undefined' && tblBuyReplaceDet_tblGoods_BaseUnit.length >index){
 tblBuyReplaceDet_tblGoods_BaseUnit[index].value = tblBuyReplaceDet_tblGoods_BaseUnit[index-1].value;
 }
 var tblBuyReplaceDet_ViewVirtualStock_UseQty = n('tblBuyReplaceDet_ViewVirtualStock_UseQty');
 if(typeof(tblBuyReplaceDet_ViewVirtualStock_UseQty) != 'undefined' && tblBuyReplaceDet_ViewVirtualStock_UseQty.length >index){
 tblBuyReplaceDet_ViewVirtualStock_UseQty[index].value = tblBuyReplaceDet_ViewVirtualStock_UseQty[index-1].value;
 }
 }
   }
 if(typeof(tableName)!="undefined" && tableName=="tblBuyReplaceDetail"){
 
 copyFields=n('tblBuyReplaceDetail_StockCode');
 if(copyFields[index].value !=0 && copyFields[index].value != ""){return}
 if((order > 0 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblBuyReplaceDetail_tblStock_StockFullName1 = n('tblBuyReplaceDetail_tblStock_StockFullName1');
 if(typeof(tblBuyReplaceDetail_tblStock_StockFullName1) != 'undefined' && tblBuyReplaceDetail_tblStock_StockFullName1.length >index){
 tblBuyReplaceDetail_tblStock_StockFullName1[index].value = tblBuyReplaceDetail_tblStock_StockFullName1[index-1].value;
 }
 }
 copyFields=n('tblBuyReplaceDetail_GoodsCode');
 if((order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblBuyReplaceDetail_tblGoods_GoodsNumber = n('tblBuyReplaceDetail_tblGoods_GoodsNumber');
 if(typeof(tblBuyReplaceDetail_tblGoods_GoodsNumber) != 'undefined' && tblBuyReplaceDetail_tblGoods_GoodsNumber.length >index){
 tblBuyReplaceDetail_tblGoods_GoodsNumber[index].value = tblBuyReplaceDetail_tblGoods_GoodsNumber[index-1].value;
 }
 var tblBuyReplaceDetail_tblGoods_GoodsFullName = n('tblBuyReplaceDetail_tblGoods_GoodsFullName');
 if(typeof(tblBuyReplaceDetail_tblGoods_GoodsFullName) != 'undefined' && tblBuyReplaceDetail_tblGoods_GoodsFullName.length >index){
 tblBuyReplaceDetail_tblGoods_GoodsFullName[index].value = tblBuyReplaceDetail_tblGoods_GoodsFullName[index-1].value;
 }
 var tblBuyReplaceDetail_tblGoods_GoodsSpec = n('tblBuyReplaceDetail_tblGoods_GoodsSpec');
 if(typeof(tblBuyReplaceDetail_tblGoods_GoodsSpec) != 'undefined' && tblBuyReplaceDetail_tblGoods_GoodsSpec.length >index){
 tblBuyReplaceDetail_tblGoods_GoodsSpec[index].value = tblBuyReplaceDetail_tblGoods_GoodsSpec[index-1].value;
 }
 var tblBuyReplaceDetail_tblGoods_BaseUnit = n('tblBuyReplaceDetail_tblGoods_BaseUnit');
 if(typeof(tblBuyReplaceDetail_tblGoods_BaseUnit) != 'undefined' && tblBuyReplaceDetail_tblGoods_BaseUnit.length >index){
 tblBuyReplaceDetail_tblGoods_BaseUnit[index].value = tblBuyReplaceDetail_tblGoods_BaseUnit[index-1].value;
 }
 }
   }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblBuyReplaceDet"){
 ...
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblBuyReplaceDetail"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="tblBuyReplaceDet"; 
 var goodsCodeLogicValidate_tblBuyReplaceDet='@GN:Seq:Qty:tblBuyReplaceDet_GoodsSeqSet:tblBuyReplaceDet_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblBuyReplaceDet',value:goodsCodeLogicValidate_tblBuyReplaceDet};
 tblName[1]="tblBuyReplaceDetail"; 
 var goodsCodeLogicValidate_tblBuyReplaceDetail='@GN:Seq:Qty:tblBuyReplaceDetail_GoodsSeqSet:tblBuyReplaceDetail_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblBuyReplaceDetail',value:goodsCodeLogicValidate_tblBuyReplaceDetail};
...
function execStat2(){
 execStatOne('tblBuyReplaceDet_Qty',2);
 execStatOne('tblBuyReplaceDet_Amount',2);
 execStatOne('tblBuyReplaceDet_CostAmount',2);
 execStatOne('tblBuyReplaceDetail_Qty',2);
 execStatOne('tblBuyReplaceDetail_Amount',2);
 setTotalCount(getTotalCount());
}
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblBuyReplace\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblBuyReplace\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblBuyReplaceDet_Qty',"tblBuyReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDet_Price',"tblBuyReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDet_Amount',"tblBuyReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDet_CostPrice',"tblBuyReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDet_CostAmount',"tblBuyReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDetail_Qty',"tblBuyReplaceDetail"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDetail_Price',"tblBuyReplaceDetail"); 
 delFireEventOne(rowId,tableName,'tblBuyReplaceDetail_Amount',"tblBuyReplaceDetail"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'AccountAmount',dis:'付款金额',digit:2,isMain:true};
 ...
 fieldDigit[fieldDigit.length] = {name:'tblBuyReplaceDet_Qty',dis:'数量',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyReplaceDet_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyReplaceDet_Amount',dis:'金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyReplaceDetail_Qty',dis:'数量',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyReplaceDetail_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyReplaceDetail_Amount',dis:'金额',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblBuyReplace",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblBuyReplace&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblBuyReplace&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_(case when isnull(tblCompany_Discount,0)=0 then 100 else isnull(tblCompany.Discount,0) end)");
 if(obj != null){
 obj.value = "";
 }
...
function initSeqQtySet(){
 if(false){
  ...
  if(false){
 var fields=n('tblBuyReplaceDet_Qty'); 
 for(var i = 0;i<fields.length;i++){ 
 fields[i].readOnly="readOnly";
 }
 }
       if(false){
 var fields=n('tblBuyReplaceDetail_Qty'); 
 for(var i = 0;i<fields.length;i++){ 
 fields[i].readOnly="readOnly";
 }
 }
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblBuyReplace"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblBuyReplace&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblBuyReplace&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
n('TotalAmount')[0].value=f(sm('tblBuyReplaceDetail_DisBackAmt')-sm('tblBuyReplaceDet_DisBackAmt'),2);

n('TotalTaxAmount')[0].value=f(sm('tblBuyReplaceDetail_TaxAmount')-sm('tblBuyReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);

n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);

n('TotalCoTaxAmt')[0].value=f(sm('tblBuyReplaceDetail_CoTaxAmt')-sm('tblBuyReplaceDet_CoTaxAmt'),2);

n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 n('CurTotalAmount')[0].value=f(sm('tblBuyReplaceDetail_CurAmount')-sm('tblBuyReplaceDet_CurAmount')-nn('CurDiscountAmount',0),2);
...
n('TotalAmount')[0].value=f(sm('tblBuyReplaceDetail_DisBackAmt')-sm('tblBuyReplaceDet_DisBackAmt')-nn('DiscountAmount',0),2);
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_Qty'); 
...
r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Price",p)*rn(0,"Qty",p),2);
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_Amount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_Discount'); 
 r(0,"DisPrice")[p].value=f(rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"DisBackAmt")[p].value=f(rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
r(0,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_DisPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_DisBackAmt'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_TaxPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_TaxAmount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_CurPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_CurAmount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_CostPrice'); 
 r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_CostAmount'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_PresentSampleType'); 
...
n('TotalTaxAmount')[0].value=f(sm('tblBuyReplaceDetail_TaxAmount')-sm('tblBuyReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDet_SecQty'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_Qty'); 
...
n('TotalCoTaxAmt')[0].value=f(sm('tblBuyReplaceDetail_CoTaxAmt')-sm('tblBuyReplaceDet_CoTaxAmt'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_Price'); 
 r(1,"Amount")[p].value=f(rn(1,"Price",p)*rn(1,"Qty",p),2);
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_Amount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_Discount'); 
 r(1,"DisPrice")[p].value=f(rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_DisPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_DisBackAmt'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_TaxPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_TaxAmount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_CurPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_CurAmount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyReplaceDetail_DisAmount')-sm('tblBuyReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_PresentSampleType'); 
...
n('TotalTaxAmount')[0].value=f(sm('tblBuyReplaceDetail_TaxAmount')-sm('tblBuyReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyReplaceDetail_SecQty'); 
...
childData[childCount]='tblBuyReplaceDet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='采购换货单退货明细';
childCount++;
 var tblBuyReplaceDetData = new gridData();
 gridDatas[gridDataNum] = tblBuyReplaceDetData;
 gridDataNum++;
 var tblBuyReplaceDet=1;
 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","0",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_StockCode','仓库','80',2,true,'',50,-2,'','',"","copy","0",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_StockCode","仓库","any","",true,minValue,50,true,''); 
 ...
 param4=param4+":0仓库@tblBuyReplaceDet_StockCode";
 param4=param4+":1供应商@CompanyCode"; 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_GoodsCode','退货商品名称','120',2,false,'',50,-2,'','',"","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblBuyReplaceDet_GoodsCode","退货商品名称","any","",false,minValue,50,false,'');
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblBuyReplaceDet:GoodsCode:tblBuyReplaceDet_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_tblGoods_GoodsFullName','退货商品名称','150',18,true,'',1000000,2,'tblBuyReplaceDet:GoodsCode:tblBuyReplaceDet_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_tblGoods_GoodsSpec','商品规格','200',2,true,'',1000000,2,'tblBuyReplaceDet:GoodsCode:tblBuyReplaceDet_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblBuyReplaceDet:GoodsCode:tblBuyReplaceDet_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_ViewVirtualStock_UseQty','虚拟库存','90',1,true,'',1000000,2,'tblBuyReplaceDet:GoodsCode:tblBuyReplaceDet_ViewVirtualStock_UseQty:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","12",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","15",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","18",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","21",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","24",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","27",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_color','色彩','60',2,true,'',100,-2,'','',"","","30",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_color","色彩","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Qty','数量','60',1,false,'',0,0,'','',"Qty","","50",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_Qty","数量","double","SeqQty",false,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Price','单价','80',1,true,'',0,0,'','',"priceIdentifier","","51",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_Price","单价","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Amount','金额','100',1,true,'',0,0,'','',"AmountIdentifier","","52",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Discount','折扣率%','100',1,true,'100',0,-2,'','',"Price","","58",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_Discount","折扣率%","double","BillDiscount",true,minValue,maxValue,true,'100'); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_DisPrice','折后单价','100',1,true,'',0,-2,'','',"priceIdentifier","","59",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_DisPrice","折后单价","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_DisBackAmt','折后金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","60",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_DisBackAmt","折后金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_DisAmount','折让金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","61",'',"8",false); 
 putChildValidateItem("tblBuyReplaceDet_DisAmount","折让金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_TaxPrice','含税单价','100',1,true,'',0,-2,'','',"priceIdentifier","","62",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_TaxPrice","含税单价","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_TaxAmount','含税金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","63",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_TaxAmount","含税金额","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_CoTaxAmt','税额','100',1,true,'0',0,-2,'','',"AmountIdentifier","","64",'',"8",false); 
 putChildValidateItem("tblBuyReplaceDet_CoTaxAmt","税额","double","BillTax",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_CurPrice','外币单价','100',1,true,'',0,-2,'','',"priceIdentifier","","65",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_CurPrice","外币单价","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_CurAmount','外币金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","66",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_CurAmount","外币金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_CostPrice','成本单价','80',1,true,'',999999999,-2,'','',"priceIdentifier","","96",'',"6",false); 
 putChildValidateItem("tblBuyReplaceDet_CostPrice","成本单价","double","",true,minValue,999999999,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_CostAmount','成本金额','80',1,true,'',999999999,-2,'','',"AmountIdentifier","","99",'',"6",false); 
 putChildValidateItem("tblBuyReplaceDet_CostAmount","成本金额","double","",true,minValue,999999999,false,''); 
 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_PresentSampleType','赠(样)品','80',2,true,'',10,-2,'','',"","","102",'',"1",false); 
 putChildValidateItem("tblBuyReplaceDet_PresentSampleType","赠(样)品","any","BillPresentSampleType",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_StockDetID','出入库明细ID','200',2,true,'',200,-2,'','',"","","108",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_StockDetID","出入库明细ID","any","",true,minValue,200,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_SourceID','源ID','0',2,true,'',60,-2,'','',"","","111",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_SourceID","源ID","any","",true,minValue,60,false,''); 
 ...
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","-118",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_NotPayQty','未付款数量','224',1,true,'',0,-2,'','',"Qty","","-115",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_NotPayQty","未付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_PayQty','付款数量','224',1,true,'',0,-2,'','',"Qty","","-112",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_PayQty","付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","-109",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_Remark','备注','100',2,true,'',8000,0,'','',"","","-1",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(tblBuyReplaceDetData,'tblBuyReplaceDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='tblBuyReplaceDetail';
tabIsNulls[childCount]='1';
tabDiss[childCount]='采购换货单入库明细';
childCount++;
 var tblBuyReplaceDetailData = new gridData();
 gridDatas[gridDataNum] = tblBuyReplaceDetailData;
 gridDataNum++;
 var tblBuyReplaceDetail=1;
 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_StockCode','仓库','80',2,true,'',50,-2,'','',"","copy","0",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_StockCode","仓库","any","",true,minValue,50,true,''); 
 ...
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_GoodsCode','入库商品名称','120',2,false,'',50,-2,'','',"","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblBuyReplaceDetail_GoodsCode","入库商品名称","any","",false,minValue,50,false,'');
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblBuyReplaceDetail:GoodsCode:tblBuyReplaceDetail_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_tblGoods_GoodsFullName','入库商品名称','150',18,true,'',1000000,2,'tblBuyReplaceDetail:GoodsCode:tblBuyReplaceDetail_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_tblGoods_GoodsSpec','商品规格','200',2,true,'',1000000,2,'tblBuyReplaceDetail:GoodsCode:tblBuyReplaceDetail_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblBuyReplaceDetail:GoodsCode:tblBuyReplaceDetail_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","9",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","12",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","15",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDetail_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","18",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDetail_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","21",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDetail_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Availably','保质期限','80',5,true,'',10,-2,'','',"","","23",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDetail_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","24",'',"2",false); 
 putChildValidateItem("tblBuyReplaceDetail_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_color','色彩','60',2,true,'',100,-2,'','',"","","29",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_color","色彩","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_colorNV','颜色名称','80',2,true,'',500,-2,'','',"","","31",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_colorNV","颜色名称","any","GoodsField",true,minValue,500,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Qty','数量','60',1,false,'',0,0,'','',"Qty","","51",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_Qty","数量","double","SeqQty",false,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Price','单价','80',1,true,'',0,0,'','',"priceIdentifier","","52",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_Price","单价","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Amount','金额','100',1,true,'',0,0,'','',"AmountIdentifier","","53",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Discount','折扣率%','100',1,true,'100',0,-2,'','',"Price","","59",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_Discount","折扣率%","double","BillDiscount",true,minValue,maxValue,true,'100'); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_DisPrice','折后单价','100',1,true,'',0,-2,'','',"priceIdentifier","","60",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_DisPrice","折后单价","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_DisBackAmt','折后金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","61",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_DisBackAmt","折后金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_DisAmount','折让金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","62",'',"8",false); 
 putChildValidateItem("tblBuyReplaceDetail_DisAmount","折让金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_TaxPrice','含税单价','100',1,true,'',0,-2,'','',"priceIdentifier","","63",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_TaxPrice","含税单价","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_TaxAmount','含税金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","64",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_TaxAmount","含税金额","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_CoTaxAmt','税额','100',1,true,'0',0,-2,'','',"AmountIdentifier","","65",'',"8",false); 
 putChildValidateItem("tblBuyReplaceDetail_CoTaxAmt","税额","double","BillTax",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_CurPrice','外币单价','100',1,true,'',0,-2,'','',"priceIdentifier","","66",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_CurPrice","外币单价","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_CurAmount','外币金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","67",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_CurAmount","外币金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_RelationGoods','关联商品名称','80',2,true,'',200,-2,'','',"","","96",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_RelationGoods","关联商品名称","any","",true,minValue,200,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_PresentSampleType','赠(样)品','80',2,true,'',10,-2,'','',"","","99",'',"1",false); 
 putChildValidateItem("tblBuyReplaceDetail_PresentSampleType","赠(样)品","any","BillPresentSampleType",true,minValue,10,false,''); 
 
 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_SourceID','源ID','0',2,true,'',60,-2,'','',"","","105",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_SourceID","源ID","any","",true,minValue,60,false,''); 
 ...
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_ApportionAmt','分摊金额','50',1,true,'0',50,-2,'','',"AmountIdentifier","","120",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_ApportionAmt","分摊金额","double","",true,minValue,50,true,'0'); 
 ...
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","-109",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_NotPayQty','未付款数量','224',1,true,'',0,-2,'','',"Qty","","-106",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_NotPayQty","未付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_PayQty','付款数量','224',1,true,'',0,-2,'','',"Qty","","-103",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_PayQty","付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","-100",'',"3",false); 
 putChildValidateItem("tblBuyReplaceDetail_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_Remark','备注','100',2,true,'',8000,0,'','',"","","-1",'',"0",false); 
 putChildValidateItem("tblBuyReplaceDetail_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(tblBuyReplaceDetailData,'tblBuyReplaceDetail_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblBuyReplace&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblBuyReplace,tblBuyReplaceDet,tblBuyReplaceDetail,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblBuyReplace&allTableName=tblBuyReplace,tblBuyReplaceDet,tblBuyReplaceDetail,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblBuyReplace&allTableName=tblBuyReplaceDet,tblBuyReplaceDetail,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblBuyReplace&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblBuyReplace&allTableName=tblBuyReplaceDet,tblBuyReplaceDetail,&colType=colWidth" ;
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblBuyReplace&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblBuyReplace&designId=&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblBuyReplace&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblBuyReplace&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi+"&moduleType="+moduleType,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblBuyReplace&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '采购换货';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblBuyReplace&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
