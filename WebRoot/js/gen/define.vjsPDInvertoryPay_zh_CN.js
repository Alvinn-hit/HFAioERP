...
{ 
 cFireEvent('PDInvertoryGoodsDet_Qty',''); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=PDInvertoryPay&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=PDInvertoryPay&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=PDInvertoryPay&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=PDInvertoryPay&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function addSeq(o,keyCode){
 ...
 var goodscodestr="";
 var isInstore = false ;
 if(seqFname=="PDInvertoryGoodsDet_Seq"){
 var ss="@IOO:Instore".split(":")
 if(ss[0]=="@GN"){
 goodscodestr=ss[4];
 ...
 if(seqFname=="PDInvertoryPayDet_Seq"){
  }
...
if(isInstore){
 ...
 var out=false;
 var ss="@GN:Seq:Qty:PDInvertoryGoodsDet_GoodsSeqSet:PDInvertoryGoodsDet_GoodsCode:StockCode".split(":")
...
function returnSeq(colNames,returnVales,compareVale,goodscodestr,ri,seqFname,inpVal){
 ...
 if("PDInvertoryGoodsDet"==seqFname.substr(0,seqFname.lastIndexOf("_"))){ 
  }
 if("PDInvertoryPayDet"==seqFname.substr(0,seqFname.lastIndexOf("_"))){ 
  }
...
function getInputVal(seqFname) {
 ...
 var param4="";
 var dd="";
 if('PDInvertoryGoodsDet'==tableName){
 }
 if('PDInvertoryPayDet'==tableName){
 }
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "PDInvertoryGoodsDetTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "PDInvertoryPayDetTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('PDInvertoryGoodsDet_Inch');
 ...
 var z=n('PDInvertoryGoodsDet_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDInvertoryGoodsDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDInvertoryGoodsDet_Seq');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDInvertoryPayDet_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDInvertoryPayDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="PDInvertoryGoodsDet"){
 
 copyFields=n('PDInvertoryGoodsDet_StockCode');
 ...
 var PDInvertoryGoodsDet_tblStock_StockNumber1 = n('PDInvertoryGoodsDet_tblStock_StockNumber1');
 if(typeof(PDInvertoryGoodsDet_tblStock_StockNumber1) != 'undefined' && PDInvertoryGoodsDet_tblStock_StockNumber1.length >index){
 PDInvertoryGoodsDet_tblStock_StockNumber1[index].value = PDInvertoryGoodsDet_tblStock_StockNumber1[index-1].value;
 }
 var PDInvertoryGoodsDet_tblStock_StockName1 = n('PDInvertoryGoodsDet_tblStock_StockName1');
 if(typeof(PDInvertoryGoodsDet_tblStock_StockName1) != 'undefined' && PDInvertoryGoodsDet_tblStock_StockName1.length >index){
 PDInvertoryGoodsDet_tblStock_StockName1[index].value = PDInvertoryGoodsDet_tblStock_StockName1[index-1].value;
 }
 }
 copyFields=n('PDInvertoryGoodsDet_WorkOrderID');
 if((order > 1 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var PDInvertoryGoodsDet_tblGoods_GoodsNumber = n('PDInvertoryGoodsDet_tblGoods_GoodsNumber');
 if(typeof(PDInvertoryGoodsDet_tblGoods_GoodsNumber) != 'undefined' && PDInvertoryGoodsDet_tblGoods_GoodsNumber.length >index){
 PDInvertoryGoodsDet_tblGoods_GoodsNumber[index].value = PDInvertoryGoodsDet_tblGoods_GoodsNumber[index-1].value;
 }
 var PDInvertoryGoodsDet_tblGoods_GoodsFullName = n('PDInvertoryGoodsDet_tblGoods_GoodsFullName');
 if(typeof(PDInvertoryGoodsDet_tblGoods_GoodsFullName) != 'undefined' && PDInvertoryGoodsDet_tblGoods_GoodsFullName.length >index){
 PDInvertoryGoodsDet_tblGoods_GoodsFullName[index].value = PDInvertoryGoodsDet_tblGoods_GoodsFullName[index-1].value;
 }
 var PDInvertoryGoodsDet_tblGoods_GoodsSpec = n('PDInvertoryGoodsDet_tblGoods_GoodsSpec');
 if(typeof(PDInvertoryGoodsDet_tblGoods_GoodsSpec) != 'undefined' && PDInvertoryGoodsDet_tblGoods_GoodsSpec.length >index){
 PDInvertoryGoodsDet_tblGoods_GoodsSpec[index].value = PDInvertoryGoodsDet_tblGoods_GoodsSpec[index-1].value;
 }
 }
  }
 if(typeof(tableName)!="undefined" && tableName=="PDInvertoryPayDet"){
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="PDInvertoryGoodsDet"){
 ...
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="PDInvertoryPayDet"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="PDInvertoryGoodsDet"; 
 var goodsCodeLogicValidate_PDInvertoryGoodsDet='@GN:Seq:Qty:PDInvertoryGoodsDet_GoodsSeqSet:PDInvertoryGoodsDet_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'PDInvertoryGoodsDet',value:goodsCodeLogicValidate_PDInvertoryGoodsDet};
 tblName[1]="PDInvertoryPayDet"; 
...
function openChildSelect(urlstr,obj,field,thisField,current){
 ...
 urlstr=urlstr.substring(0,index+"&seq=".length)+n(thisField.substr(0,thisField.lastIndexOf("_")))[ri].value+"&src=menu&seqFname="+thisField+"&newSeq="+mi[ri].value+"&tableName=PDInvertoryPay&childTableName="+thisField.split("_")[0]+"&fieldName="+field;
 var goodscode="";
 var goodscodestr="";
 var goodsProps = "";
 var stockCode = "" ;
 ...
 if(thisField=="PDInvertoryGoodsDet_Seq_hid"){
 ...
 stockCode = nz("PDInvertoryGoodsDet"+"_"+ss[5],ri) ;
 }
 }
 var ss="@IOO:Instore".split(":")
 if(ss[0]=="@GN"){
 ...
 if(thisField=="PDInvertoryPayDet_Seq_hid"){
 ...
 AjaxRequest(urlsgood) ;
 if("false"==response){
 asyncbox.tips("该商品未启用序列号456！！","alert",2000) ;
 return ;
 }
 }
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"PDInvertoryPay\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"PDInvertoryPay\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'PDInvertoryGoodsDet_QuaQty',"PDInvertoryGoodsDet"); 
 delFireEventOne(rowId,tableName,'PDInvertoryGoodsDet_Qty',"PDInvertoryGoodsDet"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'QuaQty',dis:'缴库数',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'Qty',dis:'合格数',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'labor',dis:'分摊人工费',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'prodCost',dis:'分摊制费',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'outFee',dis:'委外加工费',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'PDInvertoryGoodsDet_QuaQty',dis:'缴库数',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'PDInvertoryGoodsDet_Qty',dis:'合格数',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'PDInvertoryPayDet_Qty',dis:'扣料数',digit:4,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=PDInvertoryPay",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=PDInvertoryPay&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=PDInvertoryPay&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_tblStockMain_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblStockMain_StockNumber");
 saveField[0].value = ""; 
 m("tbl_tblStockMain_StockNumber").value = "" ;
 var saveField=n("tblStockMain_StockName");
 saveField[0].value = ""; 
 m("tbl_tblStockMain_StockName").value = "" ;
 }
 if(fieldName == "WorkOrderID"){
 var saveField=n("WorkOrderID"); 
 saveField[0].value = "";
 var obj = m("tbl_PDWorkOrder_id");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("CompanyCode"); 
 saveField[0].value = "";
 var obj = m("tbl_PDWorkOrder_CompanyCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("WOClassType"); 
 saveField[0].value = "";
 var obj = m("tbl_PDWorkOrder_WOClassType");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("GoodsCode"); 
 saveField[0].value = "";
 var obj = m("tbl_PDWorkOrder_GoodsCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("PDWorkOrder_BillNo");
 saveField[0].value = ""; 
 m("tbl_PDWorkOrder_BillNo").value = "" ;
 }
  }
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "PDInvertoryPay"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=PDInvertoryPay&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=PDInvertoryPay&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function initMainCaculate(){
 ...
 n('TotalAmount')[0].value=f(nn('Qty',0)*nn('Price',0),2);
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDInvertoryGoodsDet_QuaQty'); 
 n('QuaQty')[0].value=f(sm('PDInvertoryGoodsDet_QuaQty'),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDInvertoryGoodsDet_Qty'); 
 n('Qty')[0].value=f(sm('PDInvertoryGoodsDet_Qty'),4);
...
childData[childCount]='PDInvertoryGoodsDet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='成品缴库明细';
childCount++;
 var PDInvertoryGoodsDetData = new gridData();
 gridDatas[gridDataNum] = PDInvertoryGoodsDetData;
 gridDataNum++;
 var PDInvertoryGoodsDet=1;
 ...
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_StockCode','入库仓库','200',2,true,'Sess_StockCode',100,-2,'','',"","copy","0",'',"2",true);
 putChildValidateItem("PDInvertoryGoodsDet_StockCode","入库仓库","any","",true,minValue,100,true,'Sess_StockCode');
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_tblStock_StockNumber1','仓库编号','120',0,true,'Sess_StockFullName',1000000,2,'PDInvertoryGoodsDet:StockCode:PDInvertoryGoodsDet_tblStock_StockNumber1:'+param4,'',"","copy","0",'',"2",false); 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_tblStock_StockName1','仓库简称','100',0,true,'',1000000,2,'PDInvertoryGoodsDet:StockCode:PDInvertoryGoodsDet_tblStock_StockName1:'+param4,'',"","copy","0",'',"2",false); 
 ...
 var param4="";
 param4=param4+":1工令单号@WorkOrderID"; 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_WorkOrderID','工令单号','100',2,false,'',50,-2,'','',"","copy","1",'',"2",true);
 putChildValidateItem("PDInvertoryGoodsDet_WorkOrderID","工令单号","any","",false,minValue,50,false,'');
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_tblGoods_GoodsNumber','料件编号','120',2,true,'',1000000,2,'PDInvertoryGoodsDet:WorkOrderID:PDInvertoryGoodsDet_tblGoods_GoodsNumber:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_tblGoods_GoodsFullName','料件名称','150',2,true,'',1000000,2,'PDInvertoryGoodsDet:WorkOrderID:PDInvertoryGoodsDet_tblGoods_GoodsFullName:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_tblGoods_GoodsSpec','规格','150',20,true,'',1000000,2,'PDInvertoryGoodsDet:WorkOrderID:PDInvertoryGoodsDet_tblGoods_GoodsSpec:'+param4,'',"","copy","1",'',"2",false); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_GoodsCode','原料名称','100',2,false,'',100,-2,'','',"","","2",'',"3",false); 
 putChildValidateItem("PDInvertoryGoodsDet_GoodsCode","原料名称","any","",false,minValue,100,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_BatchNo','批号','200',2,true,'',100,0,'','',"","","3",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_BatchNo","批号","any","",true,minValue,100,false,'',true); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","4",'',"2",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","5",'',"2",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_yearNO','箱号','70',2,true,'',100,0,'','',"","triggerCopy","6",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_yearNO","箱号","any","GoodsField",true,minValue,100,false,'',true); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_ProDate','生产日期','200',5,true,'',10,-2,'','',"","","7",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_ProDate","生产日期","date","",true,minValue,10,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Availably','保质期限','200',5,true,'',10,-2,'','',"","","8",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Availably","保质期限","date","",true,minValue,10,false,''); 
 ...
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Seq','物流码','200',2,true,'',5000,-2,'','',"","triggerCopy","9",'',"2",false);
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Seq'+'_hid','物流码','200',2,true,'',5000,2,'@SEQ@IOO:Instore',"","","triggerCopy","9",'',"2",false);
 putChildValidateItem("PDInvertoryGoodsDet_Seq","物流码","any","GoodsField",true,minValue,5000,false,'',true);
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_QuaQty','缴库数','80',1,true,'',0,0,'','',"Qty","","10",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_QuaQty","缴库数","double","GoodsField",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Qty','合格数','80',1,true,'',0,0,'','',"Qty","","11",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Qty","合格数","double","GoodsField",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Price','本币未税单价','200',1,true,'',0,-2,'','',"priceIdentifier","","12",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Price","本币未税单价","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Amount','金额','200',1,true,'',0,-2,'','',"AmountIdentifier","","13",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Amount","金额","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_SecUnit','辅助单位','200',2,true,'',30,-2,'','',"Qty","","14",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_SecUnit","辅助单位","any","",true,minValue,30,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_UnitIntQty','辅助单位整数','200',0,true,'',0,-2,'','',"","","15",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_UnitIntQty","辅助单位整数","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_UnitBaseQty','辅助基本单位','200',1,true,'',0,-2,'','',"","","16",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_UnitBaseQty","辅助基本单位","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_UnitQty','辅助单位数量','200',1,true,'',0,-2,'','',"Qty","","17",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_UnitQty","辅助单位数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_UnitPrice','辅助单位单价','200',1,true,'',0,-2,'','',"priceIdentifier","","18",'',"2",false); 
 putChildValidateItem("PDInvertoryGoodsDet_UnitPrice","辅助单位单价","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_SecQty','辅助数量','200',0,true,'',0,-2,'','',"Qty","","19",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_SecQty","辅助数量","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_BaseQty','基本单位','200',0,true,'',0,-2,'','',"Qty","","20",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_BaseQty","基本单位","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_Remark','备注','200',3,true,'',8000,8,'','',"","","21",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_bakOutQty','扣备料','200',1,true,'',0,-2,'','',"Qty","","22",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_bakOutQty","扣备料","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_noBakOutQty','扣正常料','200',1,true,'',0,-2,'','',"Qty","","23",'',"0",false); 
 putChildValidateItem("PDInvertoryGoodsDet_noBakOutQty","扣正常料","double","",true,minValue,maxValue,false,''); 
 
 
 addCols(PDInvertoryGoodsDetData,'PDInvertoryGoodsDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='PDInvertoryPayDet';
tabIsNulls[childCount]='0';
tabDiss[childCount]='原材料扣除明细';
childCount++;
 var PDInvertoryPayDetData = new gridData();
 gridDatas[gridDataNum] = PDInvertoryPayDetData;
 gridDataNum++;
 var PDInvertoryPayDet=1;
 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_WorkOrderID','工令单号','200',2,true,'',50,-2,'','',"","","0",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_WorkOrderID","工令单号","any","",true,minValue,50,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_StockCode','出库仓库','200',2,true,'Sess_StockCode',100,-2,'','',"","","1",'',"2",false); 
 putChildValidateItem("PDInvertoryPayDet_StockCode","出库仓库","any","",true,minValue,100,true,'Sess_StockCode'); 
 ...
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_GoodsCode','原料名称','100',2,false,'',100,-2,'','',"","","2",'',"2",true);
 putChildValidateItem("PDInvertoryPayDet_GoodsCode","原料名称","any","",false,minValue,100,false,'');
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_tblGoods_GoodsNumber','料件编号','150',2,true,'',1000000,8,'PDInvertoryPayDet:GoodsCode:PDInvertoryPayDet_tblGoods_GoodsNumber:'+param4,'',"","","2",'',"2",false); 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_tblGoods_GoodsFullName','原料名称','150',2,true,'',1000000,8,'PDInvertoryPayDet:GoodsCode:PDInvertoryPayDet_tblGoods_GoodsFullName:'+param4,'',"","","2",'',"2",false); 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_tblGoods_GoodsSpec','规格','200',20,true,'',1000000,8,'PDInvertoryPayDet:GoodsCode:PDInvertoryPayDet_tblGoods_GoodsSpec:'+param4,'',"","","2",'',"2",false); 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_tblGoods_BaseUnit','单位','30',2,true,'',1000000,8,'PDInvertoryPayDet:GoodsCode:PDInvertoryPayDet_tblGoods_BaseUnit:'+param4,'',"","","2",'',"2",false); 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_tblGoods_BarCode','条码','100',2,true,'',1000000,8,'PDInvertoryPayDet:GoodsCode:PDInvertoryPayDet_tblGoods_BarCode:'+param4,'',"","","2",'',"2",false); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_BatchNo','批号','200',2,true,'',100,8,'','',"","","3",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_BatchNo","批号","any","",true,minValue,100,false,'',true); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","4",'',"2",false); 
 putChildValidateItem("PDInvertoryPayDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","5",'',"2",false); 
 putChildValidateItem("PDInvertoryPayDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_yearNO','箱号','70',2,true,'',100,8,'','',"","triggerCopy","6",'',"8",false); 
 putChildValidateItem("PDInvertoryPayDet_yearNO","箱号","any","GoodsField",true,minValue,100,false,'',true); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_ProDate','生产日期','200',5,true,'',10,-2,'','',"","","7",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_ProDate","生产日期","date","",true,minValue,10,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Availably','保质期限','200',5,true,'',10,-2,'','',"","","8",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_Availably","保质期限","date","",true,minValue,10,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Qty','扣料数','80',1,true,'',0,8,'','',"Qty","","9",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_Qty","扣料数","double","GoodsField",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Price','本币未税单价','200',1,true,'',0,-2,'','',"priceIdentifier","","10",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_Price","本币未税单价","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Amount','金额','200',1,true,'',0,-2,'','',"AmountIdentifier","","11",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_Amount","金额","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_SecUnit','辅助单位','200',2,true,'',30,-2,'','',"Qty","","12",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_SecUnit","辅助单位","any","",true,minValue,30,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_UnitIntQty','辅助单位整数','200',0,true,'',0,-2,'','',"","","13",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_UnitIntQty","辅助单位整数","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_UnitBaseQty','辅助基本单位','200',1,true,'',0,-2,'','',"","","14",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_UnitBaseQty","辅助基本单位","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_UnitQty','辅助单位数量','200',1,true,'',0,-2,'','',"Qty","","15",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_UnitQty","辅助单位数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_UnitPrice','辅助单位单价','200',1,true,'',0,-2,'','',"priceIdentifier","","16",'',"2",false); 
 putChildValidateItem("PDInvertoryPayDet_UnitPrice","辅助单位单价","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_SecQty','辅助数量','200',0,true,'',0,-2,'','',"Qty","","17",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_SecQty","辅助数量","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_BaseQty','基本单位','200',0,true,'',0,-2,'','',"Qty","","18",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_BaseQty","基本单位","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Remark','备注','200',3,true,'',8000,8,'','',"","","19",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_Seq','物流码','200',2,true,'',500,-2,'','',"","","20",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_Seq","物流码","any","",true,minValue,500,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_bakOutQty','扣备料','200',1,true,'',0,-2,'','',"Qty","","21",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_bakOutQty","扣备料","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_noBakOutQty','扣正常料','200',1,true,'',0,-2,'','',"Qty","","22",'',"0",false); 
 putChildValidateItem("PDInvertoryPayDet_noBakOutQty","扣正常料","double","",true,minValue,maxValue,false,''); 
 
 
 addCols(PDInvertoryPayDetData,'PDInvertoryPayDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=PDInvertoryPay&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "PDInvertoryPay,PDInvertoryGoodsDet,PDInvertoryPayDet,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=PDInvertoryPay&allTableName=PDInvertoryPay,PDInvertoryGoodsDet,PDInvertoryPayDet,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=PDInvertoryPay&allTableName=PDInvertoryGoodsDet,PDInvertoryPayDet,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=PDInvertoryPay&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=PDInvertoryPay&allTableName=PDInvertoryGoodsDet,PDInvertoryPayDet,&colType=colWidth" ;
...
function seqInput(){
 ...
 var cTabName = "PDInvertoryPayDet";
 var stockCode="";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=PDInvertoryPay&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=PDInvertoryPay&designId=16abe428_1603022154548061471&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=PDInvertoryPay&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=PDInvertoryPay&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=PDInvertoryPay&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '缴库单';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=PDInvertoryPay&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
