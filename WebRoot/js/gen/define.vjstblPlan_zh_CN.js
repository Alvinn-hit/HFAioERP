...
{ 
 cFireEvent('tblPlanDet_Qty','0'); 
 cFireEvent('tblPlanDet_Price','0'); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblPlan&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblPlan&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblPlan&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblPlan&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblPlanDetTable"){
 }
 }
function totalA(obj)
{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblPlanDet"){
 
 copyFields=n('tblPlanDet_GoodsCode');
 ...
 var tblPlanDet_tblGoods_GoodsNumber = n('tblPlanDet_tblGoods_GoodsNumber');
 if(typeof(tblPlanDet_tblGoods_GoodsNumber) != 'undefined' && tblPlanDet_tblGoods_GoodsNumber.length >index){
 tblPlanDet_tblGoods_GoodsNumber[index].value = tblPlanDet_tblGoods_GoodsNumber[index-1].value;
 }
 var tblPlanDet_tblGoods_GoodsFullName = n('tblPlanDet_tblGoods_GoodsFullName');
 if(typeof(tblPlanDet_tblGoods_GoodsFullName) != 'undefined' && tblPlanDet_tblGoods_GoodsFullName.length >index){
 tblPlanDet_tblGoods_GoodsFullName[index].value = tblPlanDet_tblGoods_GoodsFullName[index-1].value;
 }
 var tblPlanDet_tblGoods_GoodsFullNamePYM = n('tblPlanDet_tblGoods_GoodsFullNamePYM');
 if(typeof(tblPlanDet_tblGoods_GoodsFullNamePYM) != 'undefined' && tblPlanDet_tblGoods_GoodsFullNamePYM.length >index){
 tblPlanDet_tblGoods_GoodsFullNamePYM[index].value = tblPlanDet_tblGoods_GoodsFullNamePYM[index-1].value;
 }
 var tblPlanDet_tblGoods_GoodsSpec = n('tblPlanDet_tblGoods_GoodsSpec');
 if(typeof(tblPlanDet_tblGoods_GoodsSpec) != 'undefined' && tblPlanDet_tblGoods_GoodsSpec.length >index){
 tblPlanDet_tblGoods_GoodsSpec[index].value = tblPlanDet_tblGoods_GoodsSpec[index-1].value;
 }
 var tblPlanDet_tblGoods_Spec1 = n('tblPlanDet_tblGoods_Spec1');
 if(typeof(tblPlanDet_tblGoods_Spec1) != 'undefined' && tblPlanDet_tblGoods_Spec1.length >index){
 tblPlanDet_tblGoods_Spec1[index].value = tblPlanDet_tblGoods_Spec1[index-1].value;
 }
 var tblPlanDet_tblGoods_Spec2 = n('tblPlanDet_tblGoods_Spec2');
 if(typeof(tblPlanDet_tblGoods_Spec2) != 'undefined' && tblPlanDet_tblGoods_Spec2.length >index){
 tblPlanDet_tblGoods_Spec2[index].value = tblPlanDet_tblGoods_Spec2[index-1].value;
 }
 var tblPlanDet_tblGoods_Spec3 = n('tblPlanDet_tblGoods_Spec3');
 if(typeof(tblPlanDet_tblGoods_Spec3) != 'undefined' && tblPlanDet_tblGoods_Spec3.length >index){
 tblPlanDet_tblGoods_Spec3[index].value = tblPlanDet_tblGoods_Spec3[index-1].value;
 }
 var tblPlanDet_tblGoods_Validity = n('tblPlanDet_tblGoods_Validity');
 if(typeof(tblPlanDet_tblGoods_Validity) != 'undefined' && tblPlanDet_tblGoods_Validity.length >index){
 tblPlanDet_tblGoods_Validity[index].value = tblPlanDet_tblGoods_Validity[index-1].value;
 }
 }
 copyFields=n('tblPlanDet_Unit');
 if((order > 6 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && ((copyFields[index].value ==0) ||copyFields[index].value == "")){
 copyFields[index].value = copyFields[index-1].value;
 }
  }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblPlanDet"){
 ...
 copyFields=n('tblPlanDet_Unit'); 
 if( (order > 6 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && (copyFields[index].value ==0||copyFields[index].value == "")){
 copyFields[index].value = copyFields[index-1].value;
 }
  }
 }
...
function execStat2(){
 execStatOne('tblPlanDet_Qty',2);
 execStatOne('tblPlanDet_Amount',4);
 setTotalCount(getTotalCount());
}
...
function execDetailStat2(){
 execDetStatOne('tblPlanDet_Qty',2); 
 execDetStatOne('tblPlanDet_Amount',4); 
 }
...
function openSelect(urlstr,obj,field){
 ...
 urlstr += "&src=menu&MOID=1ce6503a_1401082042283050012&MOOP=add&popupWin=MainPopup";
...
function openChildSelect(urlstr,obj,field,thisField,current){
 ...
 url2='&src=menu&MOID=1ce6503a_1401082042283050012&MOOP=add&'+url2;
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblPlan\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" width=\"150\" border=\"0\"></a></div><div><em>"+str+"</em><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblPlan\",\"PIC\");'>删除</a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblPlanDet_Qty',"tblPlanDet"); 
 delFireEventOne(rowId,tableName,'tblPlanDet_Price',"tblPlanDet"); 
 delFireEventOne(rowId,tableName,'tblPlanDet_Amount',"tblPlanDet"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'tblPlanDet_Qty',dis:'数量',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblPlan",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblPlan&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblPlan&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'打印控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function mainSelect2(urlstr,openUrl,obj,field,isChild)
{
 ...
 MOID:"1ce6503a_1401082042283050012",
 MOOP:"add",
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_tblDepartment_classCode");
 if(obj != null){
 obj.value = "";
 }
...
function showUserGroup(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=1ce6503a_1401082042283050012&MOOP=add&LinkType=@URL:&displayName="+displayName,winObj,"dialogWidth=730px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
...
function showEmployee(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=1ce6503a_1401082042283050012&MOOP=query&LinkType=@URL:&displayName="+displayName,winObj,"dialogWidth=830px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var employees = str.split("|") ;
 for(var j=0;j<employees.length;j++){
 var field = employees[j].split(";") ;
...
function openCRMSelect(selectName,displayName){
 ...
 var str = window.showModalDialog("/UserFunctionAction.do?selectName="+selectName+"&operation=22&MOID=1ce6503a_1401082042283050012&MOOP=add&LinkType=@URL:&displayName="+displayName,"","dialogWidth=730px;dialogHeight=450px"); 
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblPlan&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblPlan&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function initCalculate(){
 ...
 var p =getrp(this,'tblPlanDet_Qty'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblPlanDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblPlanDet_Amount'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblPlanDet_ConversionRate'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),4);
...
childData[childCount]='tblPlanDet';
tabIsNulls[childCount]='0';
tabDiss[childCount]='生产计划单明细';
childCount++;
 var tblPlanDetData = new gridData();
 gridDatas[gridDataNum] = tblPlanDetData;
 gridDataNum++;
 var tblPlanDet=1;
 ...
 addCols(tblPlanDetData,'tblPlanDet_tblSalesOrder_BillNo','销售订单编号','120',2,true,'',1000000,2,'tblPlanDet:SalesOrderID:tblPlanDet_tblSalesOrder_BillNo:'+param4,"","","","0","","2",false);
 ...
 var param4="";
 param4=param4+":1商品名称@tblPlanDet_GoodsCode";
 ...
 addCols(tblPlanDetData,'tblPlanDet_tblGoods_GoodsNumber','商品编号','120',2,true,'',1000000,2,'tblPlanDet:GoodsCode:tblPlanDet_tblGoods_GoodsNumber:'+param4,"","","copy","1","","2",false);
 ...
 addCols(tblPlanDetData,'tblPlanDet_tblGoods_GoodsFullName','商品名称','150',2,true,'',1000000,2,'tblPlanDet:GoodsCode:tblPlanDet_tblGoods_GoodsFullName:'+param4,"","","copy","1","","2",false);
 ...
 param4=param4+":1商品名称@tblPlanDet_GoodsCode";
     ...
     var param4="";
 param4=param4+":1商品名称@tblPlanDet_GoodsCode";
 addCols(tblPlanDetData,'tblPlanDet_yearNO','规格尺码','70',2,true,'',100,2,'tblPlanDet:yearNO:tblPlanDet_yearNO:'+param4,"","","","5",'',"2",true);
 putChildValidateItem("tblPlanDet_yearNO","规格尺码","any","GoodsField",true,minValue,100,false,'',true);
     var param4="";
 param4=param4+":1商品名称@tblPlanDet_GoodsCode";
 addCols(tblPlanDetData,'tblPlanDet_Hue','颜色','70',2,true,'',100,2,'tblPlanDet:Hue:tblPlanDet_Hue:'+param4,"","","triggerCopy","4",'',"2",true);
 putChildValidateItem("tblPlanDet_Hue","颜色","any","GoodsField",true,minValue,100,false,'',true);
     var param4="";
 param4=param4+":1商品名称@tblPlanDet_GoodsCode";
 addCols(tblPlanDetData,'tblPlanDet_BatchNo','后工序','120',2,true,'',100,2,'tblPlanDet:BatchNo:tblPlanDet_BatchNo:'+param4,"","","","2",'',"2",true);
 putChildValidateItem("tblPlanDet_BatchNo","后工序","any","GoodsField",true,minValue,100,false,'',true);
     var param4="";
 param4=param4+":1商品名称@tblPlanDet_GoodsCode";
 addCols(tblPlanDetData,'tblPlanDet_Inch','厚度','70',2,true,'',100,2,'tblPlanDet:Inch:tblPlanDet_Inch:'+param4,"","","triggerCopy","3",'',"2",true);
 putChildValidateItem("tblPlanDet_Inch","厚度","any","GoodsField",true,minValue,100,false,'',true);
     addCols(tblPlanDetData,'tblPlanDet_Qty','数量','60',1,false,'0',0,0,'','',"Qty","","7",'',"0",false); 
 putChildValidateItem("tblPlanDet_Qty","数量","double","",false,minValue,maxValue,true,'0',true); 
     addCols(tblPlanDetData,'tblPlanDet_StartDate','开工日期','80',5,false,'',10,0,'','',"","","50",'',"0",false); 
 putChildValidateItem("tblPlanDet_StartDate","开工日期","date","",false,minValue,10,false,'',true); 
     addCols(tblPlanDetData,'tblPlanDet_FinishDate','完工日期','80',5,false,'',10,0,'','',"","","51",'',"0",false); 
 putChildValidateItem("tblPlanDet_FinishDate","完工日期","date","",false,minValue,10,false,'',true); 
     addCols(tblPlanDetData,'tblPlanDet_Remark','备注','100',2,true,'',8000,0,'','',"","","107",'',"0",false); 
 putChildValidateItem("tblPlanDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
     addCols(tblPlanDetData,'tblPlanDet_kehubm','客品编码','100',2,true,'',100,0,'','',"","","108",'',"0",false); 
 putChildValidateItem("tblPlanDet_kehubm","客品编码","any","",true,minValue,100,false,'',true); 
     addCols(tblPlanDetData,'tblPlanDet_providerNo','供应商编码','100',2,true,'',100,0,'','',"","","109",'',"0",false); 
 putChildValidateItem("tblPlanDet_providerNo","供应商编码","any","",true,minValue,100,false,'',true); 
     addCols(tblPlanDetData,'tblPlanDet_BZFS','包装方式','100',2,true,'',100,0,'','',"","","111",'',"0",false); 
 putChildValidateItem("tblPlanDet_BZFS","包装方式","any","",true,minValue,100,false,'',true); 
     addCols(tblPlanDetData,'tblPlanDet_kehuys','客品颜色','100',2,true,'',100,0,'','',"","","110",'',"0",false); 
 putChildValidateItem("tblPlanDet_kehuys","客品颜色","any","",true,minValue,100,false,'',true); 
  var param4="";
 addCols(tblPlanDetData,'tblPlanDet_SalesOrderID','销售订单编号','100',2,true,'',100,-2,'','','',"",'','',"2",false);
 putChildValidateItem("tblPlanDet_SalesOrderID","销售订单编号","any","",true,minValue,100,false,'',true);
    
 addCols(tblPlanDetData,'tblPlanDet_SalesOrderNo','销售订单编号','80',2,true,'',100,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblPlanDet_SalesOrderNo","销售订单编号","any","",true,minValue,100,false,''); 
 var param4="";
 addCols(tblPlanDetData,'tblPlanDet_GoodsCode','商品名称','100',2,false,'',30,-2,'','','',"copy",'','',"2",false);
 putChildValidateItem("tblPlanDet_GoodsCode","商品名称","any","",false,minValue,30,false,'',true);
         addCols(tblPlanDetData,'tblPlanDet_tblGoods_GoodsFullNamePYM','拼音码','100',2,false,'',30,-2,'',"2",false);
   addCols(tblPlanDetData,'tblPlanDet_tblGoods_GoodsSpec','商品规格','100',2,false,'',30,-2,'',"2",false);
   addCols(tblPlanDetData,'tblPlanDet_tblGoods_Spec1','原创设计师','100',2,false,'',30,-2,'',"2",false);
   addCols(tblPlanDetData,'tblPlanDet_tblGoods_Spec2','制图人','100',2,false,'',30,-2,'',"2",false);
   addCols(tblPlanDetData,'tblPlanDet_tblGoods_Spec3','自定义字段3','100',2,false,'',30,-2,'',"2",false);
   addCols(tblPlanDetData,'tblPlanDet_tblGoods_Validity','保质期','100',2,false,'',30,-2,'',"2",false);
             
 addCols(tblPlanDetData,'tblPlanDet_ProDate','生产日期','80',5,true,'',10,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblPlanDet_ProDate","生产日期","date","",true,minValue,10,false,''); 
 
 addCols(tblPlanDetData,'tblPlanDet_Unit','单位','80',2,true,'',30,-2,'','','',"copy",'','',"2",false); 
 putChildValidateItem("tblPlanDet_Unit","单位","any","",true,minValue,30,false,''); 
 
 addCols(tblPlanDetData,'tblPlanDet_Availably','保质期限','80',5,true,'',10,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblPlanDet_Availably","保质期限","date","",true,minValue,10,false,''); 
      addCols(tblPlanDetData,'tblPlanDet_Price','单价','80',1,true,'0',0,-2,'','',"priceIdentifier","","8",'',"0",false); 
 putChildValidateItem("tblPlanDet_Price","单价","double","",true,minValue,maxValue,true,'0'); 
    addCols(tblPlanDetData,'tblPlanDet_Amount','金额','100',1,true,'0',0,-2,'','',"AmountIdentifier","","9",'',"0",false); 
 putChildValidateItem("tblPlanDet_Amount","金额","double","",true,minValue,maxValue,true,'0'); 
 
 addCols(tblPlanDetData,'tblPlanDet_ConversionRate','换算率','80',2,true,'1',100,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblPlanDet_ConversionRate","换算率","any","",true,minValue,100,true,'1'); 
           addCols(tblPlanDetData,'tblPlanDet_attachMrpOper','参与MRP运算','100',2,true,'1',10,-2,'','',"","","100",'',"1",false); 
 putChildValidateItem("tblPlanDet_attachMrpOper","参与MRP运算","any","",true,minValue,10,true,'1'); 
 
 addCols(tblPlanDetData,'tblPlanDet_SourceID','源ID','200',2,true,'',60,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblPlanDet_SourceID","源ID","any","",true,minValue,60,false,''); 
                
 addCols(tblPlanDetData,'tblPlanDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblPlan&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblPlan,tblPlanDet,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblPlan&allTableName=tblPlan,tblPlanDet,&colType=bill&colSelect="+ strCols;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblPlan&allTableName=tblPlanDet,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblPlan&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblPlan&allTableName=tblPlanDet,&colType=colWidth" ;
...
function showDept(){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=1ce6503a_1401082042283050012&MOOP=add",winObj,"dialogWidth=750px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var depts = str.split("|") ;
...
function showEmployee(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=1ce6503a_1401082042283050012&MOOP=query&LinkType=@URL:",winObj,"dialogWidth=750px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var employees = str.split("|") ;
 for(var j=0;j<employees.length;j++){
 var field = employees[j].split(";") ;
...
function seqInput(){
 ...
 var urls="/UtilServlet?operation=validateBPSeq&MOID=1ce6503a_1401082042283050012&MOOP=add&StockCode="+stockCode+"&Seq="+obj.value+"&popupBean="+popBeanName;
 AjaxRequest(urls) ;
...
function RecAutoSettlement(){
 ...
 var url=url+"&operation=RecAutoSettlement&CompanyCode="+companyCode+"&"+AcceptTypeIDStr+"="+AcceptTypeID+"&BillDate="+BillDate+"&MOID=1ce6503a_1401082042283050012&MOOP=add&selectField=&selectValue=";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblPlan&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){
 location.href="/UserFunctionAction.do?tableName=tblPlan&designId=&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblPlan&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblPlan&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblPlan&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '生产计划单';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblPlan&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
