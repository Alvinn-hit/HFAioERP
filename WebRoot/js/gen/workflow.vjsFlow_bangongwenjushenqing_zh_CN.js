...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_bangongwenjushenqing','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_bangongwenjushenqing','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function checkTable(allHidFields){
 ...
 var labelText = $("input[name='field_23']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量1"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量1"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_24']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注1"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注1"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_25']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("1"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 ...
 var labelText = $("input[name='field_27']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("2"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 ...
 var labelText = $("input[name='field_28']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位2"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位2"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_29']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量2"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量2"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_30']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注2"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注2"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_31']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名3"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名3"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_32']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位3"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位3"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_33']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量3"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量3"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_34']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注3"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注3"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_35']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名4"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名4"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_36']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位4"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位4"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_37']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量4"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量4"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_38']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注4"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注4"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_39']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名5"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名5"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_40']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位5"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位5"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_41']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量5"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量5"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_42']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注5"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注5"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_43']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名6"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名6"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_44']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位6"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位6"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_45']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量6"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量6"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_46']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注6"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注6"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_47']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名7"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名7"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_48']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位7"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位7"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_49']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量7"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量7"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_50']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注7"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注7"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_51']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名8"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名8"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_52']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位8"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位8"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_53']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量8"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量8"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_54']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注8"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注8"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_55']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名9"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名9"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_56']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位9"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位9"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_57']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量9"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量9"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_58']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注9"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注9"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_59']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("品名10"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("品名10"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_60']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("单位10"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("单位10"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_61']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("数量10"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("数量10"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText = $("input[name='field_62']",document);
 var inputType = labelText.attr("inputtype");
 if(typeof(inputType)!="undefined"){
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("备注10"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("备注10"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
