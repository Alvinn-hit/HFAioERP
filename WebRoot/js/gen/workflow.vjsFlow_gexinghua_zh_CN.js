...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_gexinghua','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_gexinghua','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function countVal(Id){ 
 ...
 var result;
 if("field_6"==Id){
 var docText="count({field_4}+{field_5})";
 var re=/{.[^{}]*}/g; 
