...
{ 
 cFireEvent('tblApplyOutMaterialsDet_Qty','0'); 
 cFireEvent('tblApplyOutMaterialsDet_Price','0'); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblApplyOutMaterials&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblApplyOutMaterials&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblApplyOutMaterials&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblApplyOutMaterials&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblApplyOutMaterialsDetTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblApplyOutMaterialsDet_ProduceNo');
 ...
 var z=n('tblApplyOutMaterialsDet_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblApplyOutMaterialsDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblApplyOutMaterialsDet_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblApplyOutMaterialsDet_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblApplyOutMaterialsDet_Availably');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblApplyOutMaterialsDet_ProDate');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblApplyOutMaterialsDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblApplyOutMaterialsDet"){
 
 copyFields=n('tblApplyOutMaterialsDet_ProduceNo');
 ...
 copyFields=n('tblApplyOutMaterialsDet_Unit');
 if((order > 2 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && ((copyFields[index].value ==0) ||copyFields[index].value == "")){
 copyFields[index].value = copyFields[index-1].value;
 }
 copyFields=n('tblApplyOutMaterialsDet_GoodsCode');
 ...
 copyFields=n('tblApplyOutMaterialsDet_OutStockCode');
 if((order > 10 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && ((copyFields[index].value ==0) ||copyFields[index].value == "")){
 copyFields[index].value = copyFields[index-1].value;
 var tblApplyOutMaterialsDet_tblStock_OutStockFullName = n('tblApplyOutMaterialsDet_tblStock_OutStockFullName');
 if(typeof(tblApplyOutMaterialsDet_tblStock_OutStockFullName) != 'undefined' && tblApplyOutMaterialsDet_tblStock_OutStockFullName.length >index){
 tblApplyOutMaterialsDet_tblStock_OutStockFullName[index].value = tblApplyOutMaterialsDet_tblStock_OutStockFullName[index-1].value;
 }
 var tblApplyOutMaterialsDet_tblStocks_lastQty = n('tblApplyOutMaterialsDet_tblStocks_lastQty');
 if(typeof(tblApplyOutMaterialsDet_tblStocks_lastQty) != 'undefined' && tblApplyOutMaterialsDet_tblStocks_lastQty.length >index){
 tblApplyOutMaterialsDet_tblStocks_lastQty[index].value = tblApplyOutMaterialsDet_tblStocks_lastQty[index-1].value;
 }
 var tblApplyOutMaterialsDet_ViewVirtualStock_UseQty = n('tblApplyOutMaterialsDet_ViewVirtualStock_UseQty');
 if(typeof(tblApplyOutMaterialsDet_ViewVirtualStock_UseQty) != 'undefined' && tblApplyOutMaterialsDet_ViewVirtualStock_UseQty.length >index){
 tblApplyOutMaterialsDet_ViewVirtualStock_UseQty[index].value = tblApplyOutMaterialsDet_ViewVirtualStock_UseQty[index-1].value;
 }
 }
  }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblApplyOutMaterialsDet"){
 ...
 copyFields=n('tblApplyOutMaterialsDet_Unit'); 
 if( (order > 2 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && (copyFields[index].value ==0||copyFields[index].value == "")){
 copyFields[index].value = copyFields[index-1].value;
 }
 copyFields=n('tblApplyOutMaterialsDet_GoodsCode'); 
 ...
 copyFields=n('tblApplyOutMaterialsDet_OutStockCode'); 
 if( (order > 10 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && (copyFields[index].value ==0||copyFields[index].value == "")){
 copyFields[index].value = copyFields[index-1].value;
 var tblApplyOutMaterialsDet_tblStock_OutStockFullName = n('tblApplyOutMaterialsDet_tblStock_OutStockFullName'); 
 if(typeof(tblApplyOutMaterialsDet_tblStock_OutStockFullName) != 'undefined' && tblApplyOutMaterialsDet_tblStock_OutStockFullName.length >index){
 tblApplyOutMaterialsDet_tblStock_OutStockFullName[index].value = tblApplyOutMaterialsDet_tblStock_OutStockFullName[index-1].value;
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="tblApplyOutMaterialsDet"; 
...
function execStat2(){
 execStatOne('tblApplyOutMaterialsDet_Qty',4);
 execStatOne('tblApplyOutMaterialsDet_Price',4);
 execStatOne('tblApplyOutMaterialsDet_Amount',4);
 setTotalCount(getTotalCount());
}
...
function openSelect(urlstr,obj,field){
 ...
 urlstr += "&src=menu&MOID=e1ee434b_1205101044348590145&MOOP=add&popupWin=MainPopup";
...
function openChildSelect(urlstr,obj,field,thisField,current){
 ...
 urlstr=urlstr+'&src=menu&MOID=e1ee434b_1205101044348590145&MOOP=add'; 
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblApplyOutMaterials\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" width=\"150\" border=\"0\"></a></div><div><em>"+str+"</em><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblApplyOutMaterials\",\"PIC\");'>删除</a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblApplyOutMaterialsDet_Qty',"tblApplyOutMaterialsDet"); 
 delFireEventOne(rowId,tableName,'tblApplyOutMaterialsDet_Price',"tblApplyOutMaterialsDet"); 
 delFireEventOne(rowId,tableName,'tblApplyOutMaterialsDet_Amount',"tblApplyOutMaterialsDet"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'tblApplyOutMaterialsDet_Qty',dis:'数量',digit:4,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblApplyOutMaterials",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblApplyOutMaterials&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblApplyOutMaterials&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function mainSelect2(urlstr,openUrl,obj,field,isChild)
{
 ...
 MOID:"e1ee434b_1205101044348590145",
 MOOP:"add",
...
function resetSubmit(fieldName){
 ...
 var saveField=n("EntrustPro"); 
 saveField[0].value = "";
 var obj = m("tbl_(select (case when a_PlantType='1' then 'Inside' when a.PlantType='2' then 'Outside' end) from tblProductionPlant a where a.id=tblProductionPlant.id)");
 if(obj != null){
 obj.value = "";
 }
...
function showUserGroup(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=e1ee434b_1205101044348590145&MOOP=add&LinkType=@URL:&displayName="+displayName,winObj,"dialogWidth=730px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
...
function showEmployee(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=e1ee434b_1205101044348590145&MOOP=query&LinkType=@URL:&displayName="+displayName,winObj,"dialogWidth=830px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var employees = str.split("|") ;
 for(var j=0;j<employees.length;j++){
 var field = employees[j].split(";") ;
...
function openCRMSelect(selectName,displayName){
 ...
 var str = window.showModalDialog("/UserFunctionAction.do?selectName="+selectName+"&operation=22&MOID=e1ee434b_1205101044348590145&MOOP=add&LinkType=@URL:&displayName="+displayName,"","dialogWidth=730px;dialogHeight=450px"); 
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblApplyOutMaterials"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblApplyOutMaterials&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblApplyOutMaterials&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
r(0,"Qty")[j].value=f(nn('Qty',0)*rn(0,"MRate",j),4); 
 if(typeof(r(0,'Qty')[j].onchange)=='function'){r(0,'Qty')[j].onchange();}
}

for(var j=0;j<r(0,'Amount').length;j++){
r(0,"Amount")[j].value=f(rn(0,"Qty",j)*rn(0,"Price",j),4); 
 if(typeof(r(0,'Amount')[j].onchange)=='function'){r(0,'Amount')[j].onchange();}
}

n('BillAmt')[0].value=f(sm('tblApplyOutMaterialsDet_Amount'),4);
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblApplyOutMaterialsDet_Qty'); 
...
n('BillAmt')[0].value=f(sm('tblApplyOutMaterialsDet_Amount'),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblApplyOutMaterialsDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),4);
n('BillAmt')[0].value=f(sm('tblApplyOutMaterialsDet_Amount'),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblApplyOutMaterialsDet_Amount'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),4);
n('BillAmt')[0].value=f(sm('tblApplyOutMaterialsDet_Amount'),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblApplyOutMaterialsDet_ConversionRate'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),4);
n('BillAmt')[0].value=f(sm('tblApplyOutMaterialsDet_Amount'),4);
...
childData[childCount]='tblApplyOutMaterialsDet';
tabIsNulls[childCount]='0';
tabDiss[childCount]='补料申请明细';
childCount++;
 var tblApplyOutMaterialsDetData = new gridData();
 gridDatas[gridDataNum] = tblApplyOutMaterialsDetData;
 gridDataNum++;
 var tblApplyOutMaterialsDet=1;
 ...
 param4=param4+":1申请日期@BillDate"; 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ProduceID','生产单号','120',2,true,'',100,-2,'','',"","","0",'',"2",true);
 putChildValidateItem("tblApplyOutMaterialsDet_ProduceID","生产单号","any","",true,minValue,100,false,'');
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ViewProduceBillNo_BillNo','生产单号','140',2,true,'',1000000,2,'tblApplyOutMaterialsDet:ProduceID:tblApplyOutMaterialsDet_ViewProduceBillNo_BillNo:'+param4,'',"","","0",'',"2",false); 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ViewProduceBillNo_GoodsNumber','产品编号','140',2,true,'',1000000,2,'tblApplyOutMaterialsDet:ProduceID:tblApplyOutMaterialsDet_ViewProduceBillNo_GoodsNumber:'+param4,'',"","","0",'',"2",false); 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ViewProduceBillNo_GoodsFullName','产品名称','150',2,true,'',1000000,2,'tblApplyOutMaterialsDet:ProduceID:tblApplyOutMaterialsDet_ViewProduceBillNo_GoodsFullName:'+param4,'',"","","0",'',"2",false); 
 
 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ProduceNo','生产单号','140',2,true,'',100,-2,'','',"","triggerOrCopy","1",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_ProduceNo","生产单号","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Unit','单位','70',2,true,'',30,-2,'','',"","copy","2",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Unit","单位","any","",true,minValue,30,false,''); 
 ...
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_GoodsCode','物料名称','100',2,false,'',100,2,'tblApplyOutMaterialsDet:GoodsCode:tblApplyOutMaterialsDet_GoodsCode:'+param4,"","","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblApplyOutMaterialsDet_GoodsCode","物料名称","any","",false,minValue,100,false,'',true);
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","4",'',"2",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Inch','宽度','70',2,true,'',100,-2,'','',"","triggerCopy","5",'',"2",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Inch","宽度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","6",'',"2",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","triggerCopy","7",'',"0",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","triggerCopy","8",'',"0",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Seq','序列号','100',2,true,'',5000,-2,'','',"","","9",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_OutStockCode','领料仓库','100',2,true,'',100,-2,'','',"","copy","10",'',"2",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_OutStockCode","领料仓库","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_yearNO','高度','70',2,true,'',100,-2,'','',"","triggerCopy","11",'',"2",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_yearNO","高度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_StockCode','车间仓','100',2,true,'',100,-2,'','',"","","12",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_StockCode","车间仓","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Qty','数量','80',1,false,'0',0,0,'','',"Qty","","13",'',"0",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Qty","数量","double","",false,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Price','单价','100',1,true,'0',0,-2,'','',"priceIdentifier","","14",'',"6",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Price","单价","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Amount','金额','100',1,true,'0',0,-2,'','',"AmountIdentifier","","15",'',"6",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Amount","金额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_ConversionRate','换算率','224',2,true,'1',100,-2,'','',"","","16",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_ConversionRate","换算率","any","",true,minValue,100,true,'1'); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_BackQty','退料数量','224',1,true,'0',0,-2,'','',"Qty","","17",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_BackQty","退料数量","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_BackAmt','退料金額','224',1,true,'0',0,-2,'','',"SAmountIdentifier","","18",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_BackAmt","退料金額","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Validity','有效期','224',0,true,'',0,-2,'','',"","","19",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Validity","有效期","int","",true,minValue,maxValue,false,''); 
 ...
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_DrawMaterialTimes','领料次数','85',2,true,'',30,1,';2:二次领料;3:三次领料','',"","","25",'',"1",false);
 putChildValidateItem("tblApplyOutMaterialsDet_DrawMaterialTimes","领料次数","any","",true,minValue,30,false,'',true); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_MaterielType','物料类型','70',2,true,'MainMaterials',100,1,';MainMaterials :主料;publicMaterials:公用料','',"","","26",'',"1",false);
 putChildValidateItem("tblApplyOutMaterialsDet_MaterielType","物料类型","any","",true,minValue,100,true,'MainMaterials',true); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_BillType','单据类型','224',2,true,'tblProduce',100,-2,'','',"","","27",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_BillType","单据类型","any","",true,minValue,100,true,'tblProduce'); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_SourceID','源ID','224',2,true,'',100,-2,'','',"","","28",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_SourceID","源ID","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_MRate','物料比例','120',1,false,'',0,-2,'','',"","","29",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_MRate","物料比例","double","",false,minValue,maxValue,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_Remark','备注','200',2,true,'',500,0,'','',"","","30",'',"0",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_Remark","备注","any","",true,minValue,500,false,'',true); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_TrackNo','追踪单号','100',2,true,'',100,-2,'','',"","","31",'',"6",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_TrackNo","追踪单号","any","TrackNo",true,minValue,100,false,''); 
 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_OutQty','已发料数量','224',1,true,'',0,-2,'','',"Qty","","33",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_OutQty","已发料数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_NotOutQty','未发料数量','224',1,true,'',0,-2,'','',"Qty","","34",'',"3",false); 
 putChildValidateItem("tblApplyOutMaterialsDet_NotOutQty","未发料数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 
 addCols(tblApplyOutMaterialsDetData,'tblApplyOutMaterialsDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblApplyOutMaterials&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblApplyOutMaterials,tblApplyOutMaterialsDet,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblApplyOutMaterials&allTableName=tblApplyOutMaterials,tblApplyOutMaterialsDet,&colType=bill&colSelect="+ strCols;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblApplyOutMaterials&allTableName=tblApplyOutMaterialsDet,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblApplyOutMaterials&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblApplyOutMaterials&allTableName=tblApplyOutMaterialsDet,&colType=colWidth" ;
...
function showDept(){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=e1ee434b_1205101044348590145&MOOP=add",winObj,"dialogWidth=750px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var depts = str.split("|") ;
...
function showEmployee(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=e1ee434b_1205101044348590145&MOOP=query&LinkType=@URL:",winObj,"dialogWidth=750px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var employees = str.split("|") ;
 for(var j=0;j<employees.length;j++){
 var field = employees[j].split(";") ;
...
function seqInput(){
 ...
 var cTabName = "tblApplyOutMaterialsDet";
 var stockCode="";
 ...
 var urls="/UtilServlet?operation=validateBPSeq&MOID=e1ee434b_1205101044348590145&MOOP=add&StockCode="+stockCode+"&Seq="+obj.value+"&popupBean="+popBeanName;
 AjaxRequest(urls) ;
...
function RecAutoSettlement(){
 ...
 var url=url+"&operation=RecAutoSettlement&CompanyCode="+companyCode+"&"+AcceptTypeIDStr+"="+AcceptTypeID+"&BillDate="+BillDate+"&MOID=e1ee434b_1205101044348590145&MOOP=add&selectField=&selectValue=";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblApplyOutMaterials&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblApplyOutMaterials&designId=&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblApplyOutMaterials&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblApplyOutMaterials&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblApplyOutMaterials&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '补料申请';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblApplyOutMaterials&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
