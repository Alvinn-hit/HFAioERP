...
{ 
 cFireEvent('tblSalesReturnStockDet_Qty',''); 
 cFireEvent('tblSalesReturnStockDet_Price',''); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblSalesReturnStock&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblSalesReturnStock&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblSalesReturnStock&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblSalesReturnStock&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblSalesReturnStockDetTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblSalesReturnStockDet_GoodsCode');
 ...
 var z=n('tblSalesReturnStockDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReturnStockDet_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReturnStockDet_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReturnStockDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReturnStockDet_Seq');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblSalesReturnStockDet"){
 
 copyFields=n('tblSalesReturnStockDet_StockCode');
 ...
 copyFields=n('tblSalesReturnStockDet_GoodsCode');
 if((order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblSalesReturnStockDet_tblGoods_GoodsNumber = n('tblSalesReturnStockDet_tblGoods_GoodsNumber');
 if(typeof(tblSalesReturnStockDet_tblGoods_GoodsNumber) != 'undefined' && tblSalesReturnStockDet_tblGoods_GoodsNumber.length >index){
 tblSalesReturnStockDet_tblGoods_GoodsNumber[index].value = tblSalesReturnStockDet_tblGoods_GoodsNumber[index-1].value;
 }
 var tblSalesReturnStockDet_tblGoods_GoodsFullName = n('tblSalesReturnStockDet_tblGoods_GoodsFullName');
 if(typeof(tblSalesReturnStockDet_tblGoods_GoodsFullName) != 'undefined' && tblSalesReturnStockDet_tblGoods_GoodsFullName.length >index){
 tblSalesReturnStockDet_tblGoods_GoodsFullName[index].value = tblSalesReturnStockDet_tblGoods_GoodsFullName[index-1].value;
 }
 var tblSalesReturnStockDet_tblGoods_GoodsSpec = n('tblSalesReturnStockDet_tblGoods_GoodsSpec');
 if(typeof(tblSalesReturnStockDet_tblGoods_GoodsSpec) != 'undefined' && tblSalesReturnStockDet_tblGoods_GoodsSpec.length >index){
 tblSalesReturnStockDet_tblGoods_GoodsSpec[index].value = tblSalesReturnStockDet_tblGoods_GoodsSpec[index-1].value;
 }
 var tblSalesReturnStockDet_tblGoods_BaseUnit = n('tblSalesReturnStockDet_tblGoods_BaseUnit');
 if(typeof(tblSalesReturnStockDet_tblGoods_BaseUnit) != 'undefined' && tblSalesReturnStockDet_tblGoods_BaseUnit.length >index){
 tblSalesReturnStockDet_tblGoods_BaseUnit[index].value = tblSalesReturnStockDet_tblGoods_BaseUnit[index-1].value;
 }
 }
   }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblSalesReturnStockDet"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="tblSalesReturnStockDet"; 
 var goodsCodeLogicValidate_tblSalesReturnStockDet='@GN:Seq:Qty:tblSalesReturnStockDet_GoodsSeqSet:tblSalesReturnStockDet_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblSalesReturnStockDet',value:goodsCodeLogicValidate_tblSalesReturnStockDet};
...
function execStat2(){
 execStatOne('tblSalesReturnStockDet_Qty',2);
 execStatOne('tblSalesReturnStockDet_Amount',2);
 execStatOne('tblSalesReturnStockDet_ApplyQty',2);
 setTotalCount(getTotalCount());
}
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblSalesReturnStock\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblSalesReturnStock\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblSalesReturnStockDet_Qty',"tblSalesReturnStockDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReturnStockDet_Price',"tblSalesReturnStockDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReturnStockDet_Amount',"tblSalesReturnStockDet"); 
 }
...
var fieldDigit = new Array();
 ...
 fieldDigit[fieldDigit.length] = {name:'tblSalesReturnStockDet_Qty',dis:'数量',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReturnStockDet_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReturnStockDet_Amount',dis:'金额',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblSalesReturnStock",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblSalesReturnStock&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblSalesReturnStock&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function initSeqQtySet(){
 if(false){
  ...
  if(false){
 var fields=n('tblSalesReturnStockDet_Qty'); 
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblSalesReturnStock"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblSalesReturnStock&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblSalesReturnStock&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
n('TotalAmount')[0].value=f(sm('tblSalesReturnStockDet_DisBackAmt'),2);

n('TotalTaxAmount')[0].value=f(sm('tblSalesReturnStockDet_TaxAmount')-nn('DiscountAmount',0),2);
...
n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReturnStockDet_CoTaxAmt'),2);

for(var j=0;j<r(0,'DisAmount').length;j++){
r(0,"DisAmount")[j].value=f(rn(0,"Amount",j)-rn(0,"DisBackAmt",j),2);
}

n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_Qty'); 
...
r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Price",p)*rn(0,"Qty",p),2);
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_Amount'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_Discount'); 
 r(0,"DisPrice")[p].value=f(rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"DisBackAmt")[p].value=f(rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
r(0,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_DisPrice'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_DisBackAmt'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_TaxPrice'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_TaxAmount'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_CurPrice'); 
...
n('TotalAmount')[0].value=f(sm('tblSalesReturnStockDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReturnStockDet_TaxAmount')-nn('DiscountAmount',0),2);
n('CurTotalAmount')[0].value=f(sm('tblSalesReturnStockDet_CurAmount'),2);
r(0,"CoTaxAmt")[p].value=f(rn(0,"TaxAmount",p)-rn(0,"DisBackAmt",p),2);
n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReturnStockDet_CoTaxAmt'),2);
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_CurAmount'); 
 r(0,"TaxAmount")[p].value=f(rn(0,"CurAmount",p)*nn('CurrencyRate',0),2);
r(0,"DisBackAmt")[p].value=f(rn(0,"CurAmount",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),2);
r(0,"Amount")[p].value=f(rn(0,"CurAmount",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(0,"Discount",p)/100),2);
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_CostPrice'); 
 r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_CostAmount'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_PresentSampleType'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReturnStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReturnStockDet_SecQty'); 
...
childData[childCount]='tblSalesReturnStockDet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='销售退货单明细表';
childCount++;
 var tblSalesReturnStockDetData = new gridData();
 gridDatas[gridDataNum] = tblSalesReturnStockDetData;
 gridDataNum++;
 var tblSalesReturnStockDet=1;
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_StockCode','仓库','80',2,true,'',100,-2,'','',"","copy","0",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_StockCode","仓库","any","",true,minValue,100,true,''); 
 
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_SalesOutStockID','出库单号','80',2,true,'',32,-2,'','',"","","1",'',"2",false); 
 putChildValidateItem("tblSalesReturnStockDet_SalesOutStockID","出库单号","any","ManyBillQuote",true,minValue,32,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_SalesOrderID','订单编号','80',2,true,'',32,-2,'','',"","","2",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_SalesOrderID","订单编号","any","",true,minValue,32,false,''); 
 ...
 param4=param4+":0仓库@tblSalesReturnStockDet_StockCode";
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_GoodsCode','商品名称','120',2,false,'',100,-2,'','',"","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblSalesReturnStockDet_GoodsCode","商品名称","any","",false,minValue,100,false,'');
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblSalesReturnStockDet:GoodsCode:tblSalesReturnStockDet_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_tblGoods_GoodsFullName','商品名称','150',18,true,'',1000000,2,'tblSalesReturnStockDet:GoodsCode:tblSalesReturnStockDet_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_tblGoods_GoodsSpec','商品规格','200',2,true,'',1000000,2,'tblSalesReturnStockDet:GoodsCode:tblSalesReturnStockDet_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblSalesReturnStockDet:GoodsCode:tblSalesReturnStockDet_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","4",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","5",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","6",'',"2",false); 
 putChildValidateItem("tblSalesReturnStockDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","7",'',"2",false); 
 putChildValidateItem("tblSalesReturnStockDet_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","8",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","9",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","10",'',"2",false); 
 putChildValidateItem("tblSalesReturnStockDet_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Qty','数量','60',1,false,'',0,0,'','',"Qty","","11",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Qty","数量","double","SeqQty",false,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Price','单价','80',1,true,'',0,0,'','',"SPriceIdentifier","","12",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Price","单价","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Amount','金额','100',1,true,'',0,0,'','',"SAmountIdentifier","","13",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Discount','折扣率%','100',1,true,'100',0,-2,'','',"Price","","19",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Discount","折扣率%","double","BillDiscount",true,minValue,maxValue,true,'100'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_DisPrice','折后单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","20",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_DisPrice","折后单价","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_DisBackAmt','折后金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","21",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_DisBackAmt","折后金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_DisAmount','折让金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","22",'',"8",false); 
 putChildValidateItem("tblSalesReturnStockDet_DisAmount","折让金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_TaxPrice','含税单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","23",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_TaxPrice","含税单价","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_TaxAmount','含税金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","24",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_TaxAmount","含税金额","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_CoTaxAmt','税额','100',1,true,'0',0,-2,'','',"SAmountIdentifier","","25",'',"8",false); 
 putChildValidateItem("tblSalesReturnStockDet_CoTaxAmt","税额","double","BillTax",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_CurPrice','外币单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","26",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_CurPrice","外币单价","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_CurAmount','外币金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","27",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_CurAmount","外币金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_CheckBarCode','复核码','160',2,true,'',200,-2,'','',"","","28",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_CheckBarCode","复核码","any","",true,minValue,200,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_ApplyQty','申请数','80',1,false,'0',0,-2,'','',"Qty","","29",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_ApplyQty","申请数","double","",false,minValue,maxValue,true,'0'); 
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_CostPrice','成本单价','80',1,true,'',0,-2,'','',"priceIdentifier","","31",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_CostPrice","成本单价","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_CostAmount','成本总额','100',1,true,'0',0,-2,'','',"AmountIdentifier","","32",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_CostAmount","成本总额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_PresentSampleType','赠(样)品','60',2,true,'',20,-2,'','',"","","33",'',"1",false); 
 putChildValidateItem("tblSalesReturnStockDet_PresentSampleType","赠(样)品","any","BillPresentSampleType",true,minValue,20,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_NoInvoiceQty','未开票数','224',1,true,'0',0,-2,'','',"Qty","","34",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_NoInvoiceQty","未开票数","double","",true,minValue,maxValue,true,'0'); 
 ...
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_SourceID','源ID','200',2,true,'',60,-2,'','',"","","38",'',"100",false); 
 putChildValidateItem("tblSalesReturnStockDet_SourceID","源ID","any","",true,minValue,60,false,''); 
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_ChangeAmt','调价金额','224',1,true,'0',0,-2,'','',"","","40",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_ChangeAmt","调价金额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_AfterChangeAmt','调价后金额','224',1,true,'0',0,-2,'','',"","","41",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_AfterChangeAmt","调价后金额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_NoInvoiceAmount','未开票金额','224',1,true,'0',0,-2,'','',"","","44",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_NoInvoiceAmount","未开票金额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_NotPayQty','未付款数量','224',1,true,'',0,-2,'','',"Qty","","45",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_NotPayQty","未付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_PayQty','付款数量','224',1,true,'',0,-2,'','',"Qty","","48",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_PayQty","付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","49",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_InvoiceAmount','已开票金额','224',1,true,'0',0,-2,'','',"","","50",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_InvoiceAmount","已开票金额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","51",'',"3",false); 
 putChildValidateItem("tblSalesReturnStockDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_Remark','备注','100',2,true,'',8000,0,'','',"","","52",'',"0",false); 
 putChildValidateItem("tblSalesReturnStockDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 
 
 
 addCols(tblSalesReturnStockDetData,'tblSalesReturnStockDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblSalesReturnStock&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblSalesReturnStock,tblSalesReturnStockDet,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblSalesReturnStock&allTableName=tblSalesReturnStock,tblSalesReturnStockDet,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblSalesReturnStock&allTableName=tblSalesReturnStockDet,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblSalesReturnStock&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblSalesReturnStock&allTableName=tblSalesReturnStockDet,&colType=colWidth" ;
...
function seqInput(){
 ...
 var cTabName = "tblSalesReturnStockDet";
 var stockCode="";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblSalesReturnStock&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblSalesReturnStock&designId=&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblSalesReturnStock&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblSalesReturnStock&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi+"&moduleType="+moduleType,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblSalesReturnStock&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '销售退货';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblSalesReturnStock&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
