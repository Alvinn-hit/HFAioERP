...
{ 
 cFireEvent('tblGoodsAssemblySplitDet_Qty','0'); 
 cFireEvent('tblGoodsAssemblySplitDet_Price','0'); 
 cFireEvent('tblGoodsAssemblySplitDetail_Qty','0'); 
 cFireEvent('tblGoodsAssemblySplitDetail_Price','0'); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblGoodsAssemblySplit&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblGoodsAssemblySplit&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblGoodsAssemblySplit&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblGoodsAssemblySplit&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblGoodsAssemblySplitDetTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblGoodsAssemblySplitDetailTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblGoodsAssemblySplitDet_Seq');
 ...
 var z=n('tblGoodsAssemblySplitDet_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDet_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDet_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDet_Qty');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDetail_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDetail_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDetail_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDetail_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDetail_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsAssemblySplitDetail_Qty');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblGoodsAssemblySplitDet"){
 
 copyFields=n('tblGoodsAssemblySplitDet_StockCode');
 ...
 var tblGoodsAssemblySplitDet_tblStock_StockFullName1 = n('tblGoodsAssemblySplitDet_tblStock_StockFullName1');
 if(typeof(tblGoodsAssemblySplitDet_tblStock_StockFullName1) != 'undefined' && tblGoodsAssemblySplitDet_tblStock_StockFullName1.length >index){
 tblGoodsAssemblySplitDet_tblStock_StockFullName1[index].value = tblGoodsAssemblySplitDet_tblStock_StockFullName1[index-1].value;
 }
 }
 copyFields=n('tblGoodsAssemblySplitDet_GoodsCode');
 if((order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblGoodsAssemblySplitDet_tblGoods_GoodsNumber = n('tblGoodsAssemblySplitDet_tblGoods_GoodsNumber');
 if(typeof(tblGoodsAssemblySplitDet_tblGoods_GoodsNumber) != 'undefined' && tblGoodsAssemblySplitDet_tblGoods_GoodsNumber.length >index){
 tblGoodsAssemblySplitDet_tblGoods_GoodsNumber[index].value = tblGoodsAssemblySplitDet_tblGoods_GoodsNumber[index-1].value;
 }
 var tblGoodsAssemblySplitDet_tblGoods_GoodsFullName = n('tblGoodsAssemblySplitDet_tblGoods_GoodsFullName');
 if(typeof(tblGoodsAssemblySplitDet_tblGoods_GoodsFullName) != 'undefined' && tblGoodsAssemblySplitDet_tblGoods_GoodsFullName.length >index){
 tblGoodsAssemblySplitDet_tblGoods_GoodsFullName[index].value = tblGoodsAssemblySplitDet_tblGoods_GoodsFullName[index-1].value;
 }
 var tblGoodsAssemblySplitDet_tblGoods_GoodsSpec = n('tblGoodsAssemblySplitDet_tblGoods_GoodsSpec');
 if(typeof(tblGoodsAssemblySplitDet_tblGoods_GoodsSpec) != 'undefined' && tblGoodsAssemblySplitDet_tblGoods_GoodsSpec.length >index){
 tblGoodsAssemblySplitDet_tblGoods_GoodsSpec[index].value = tblGoodsAssemblySplitDet_tblGoods_GoodsSpec[index-1].value;
 }
 var tblGoodsAssemblySplitDet_tblGoods_BaseUnit = n('tblGoodsAssemblySplitDet_tblGoods_BaseUnit');
 if(typeof(tblGoodsAssemblySplitDet_tblGoods_BaseUnit) != 'undefined' && tblGoodsAssemblySplitDet_tblGoods_BaseUnit.length >index){
 tblGoodsAssemblySplitDet_tblGoods_BaseUnit[index].value = tblGoodsAssemblySplitDet_tblGoods_BaseUnit[index-1].value;
 }
 var tblGoodsAssemblySplitDet_tblStocks_lastQty = n('tblGoodsAssemblySplitDet_tblStocks_lastQty');
 if(typeof(tblGoodsAssemblySplitDet_tblStocks_lastQty) != 'undefined' && tblGoodsAssemblySplitDet_tblStocks_lastQty.length >index){
 tblGoodsAssemblySplitDet_tblStocks_lastQty[index].value = tblGoodsAssemblySplitDet_tblStocks_lastQty[index-1].value;
 }
 var tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty = n('tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty');
 if(typeof(tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty) != 'undefined' && tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty.length >index){
 tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty[index].value = tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty[index-1].value;
 }
 }
  }
 if(typeof(tableName)!="undefined" && tableName=="tblGoodsAssemblySplitDetail"){
 
 copyFields=n('tblGoodsAssemblySplitDetail_StockCode');
 if(copyFields[index].value !=0 && copyFields[index].value != ""){return}
 if((order > 0 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblGoodsAssemblySplitDetail_tblStock_StockFullName1 = n('tblGoodsAssemblySplitDetail_tblStock_StockFullName1');
 if(typeof(tblGoodsAssemblySplitDetail_tblStock_StockFullName1) != 'undefined' && tblGoodsAssemblySplitDetail_tblStock_StockFullName1.length >index){
 tblGoodsAssemblySplitDetail_tblStock_StockFullName1[index].value = tblGoodsAssemblySplitDetail_tblStock_StockFullName1[index-1].value;
 }
 }
 copyFields=n('tblGoodsAssemblySplitDetail_GoodsCode');
 if((order > 4 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber = n('tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber');
 if(typeof(tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber) != 'undefined' && tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber.length >index){
 tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber[index].value = tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber[index-1].value;
 }
 var tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName = n('tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName');
 if(typeof(tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName) != 'undefined' && tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName.length >index){
 tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName[index].value = tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName[index-1].value;
 }
 var tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec = n('tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec');
 if(typeof(tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec) != 'undefined' && tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec.length >index){
 tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec[index].value = tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec[index-1].value;
 }
 var tblGoodsAssemblySplitDetail_tblGoods_BaseUnit = n('tblGoodsAssemblySplitDetail_tblGoods_BaseUnit');
 if(typeof(tblGoodsAssemblySplitDetail_tblGoods_BaseUnit) != 'undefined' && tblGoodsAssemblySplitDetail_tblGoods_BaseUnit.length >index){
 tblGoodsAssemblySplitDetail_tblGoods_BaseUnit[index].value = tblGoodsAssemblySplitDetail_tblGoods_BaseUnit[index-1].value;
 }
 }
  }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblGoodsAssemblySplitDet"){
 ...
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblGoodsAssemblySplitDetail"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="tblGoodsAssemblySplitDet"; 
 var goodsCodeLogicValidate_tblGoodsAssemblySplitDet='@GN:Seq:Qty:tblGoodsAssemblySplitDet_GoodsSeqSet:tblGoodsAssemblySplitDet_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblGoodsAssemblySplitDet',value:goodsCodeLogicValidate_tblGoodsAssemblySplitDet};
 tblName[1]="tblGoodsAssemblySplitDetail"; 
 var goodsCodeLogicValidate_tblGoodsAssemblySplitDetail='@GN:Seq:Qty:tblGoodsAssemblySplitDetail_GoodsSeqSet:tblGoodsAssemblySplitDetail_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblGoodsAssemblySplitDetail',value:goodsCodeLogicValidate_tblGoodsAssemblySplitDetail};
...
function execStat2(){
 execStatOne('tblGoodsAssemblySplitDet_Qty',4);
 execStatOne('tblGoodsAssemblySplitDet_Amount',2);
 execStatOne('tblGoodsAssemblySplitDet_UnitPruQty',4);
 execStatOne('tblGoodsAssemblySplitDetail_Qty',4);
 execStatOne('tblGoodsAssemblySplitDetail_Amount',2);
 execStatOne('tblGoodsAssemblySplitDetail_UnitPruQty',4);
 setTotalCount(getTotalCount());
}
...
function openAttachUpload(type,btnId){
 ...
 ' <param name="movie" value="/flash/FileUpload.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#869ca7" /><param name="flashvars" value="maxSize=0&uploadUrl=/UploadServlet?path=/temp/@amp;fieldName='+btnId+'@amp;fileType='+type+'&filter='+filter+'&btnId='+btnId+'" />'+
 ...
 ' flashvars="maxSize=0&uploadUrl=/UploadServlet?path=/temp/@amp;fieldName='+btnId+'@amp;fileType='+type+'&filter='+filter+'&btnId='+btnId+'" quality="high" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http/'+'/www.adobe.com/go/getflashplayer"></embed></object>';
} 
...
function selectPIC(btnId){
 ...
 asyncbox.open({id:'popSelectPic',url:turl,title:'选择图片',width:width,height:height,btnsbar:jQuery.btn.OKCANCEL, 
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblGoodsAssemblySplit\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblGoodsAssemblySplitDet_Qty',"tblGoodsAssemblySplitDet"); 
 delFireEventOne(rowId,tableName,'tblGoodsAssemblySplitDet_Price',"tblGoodsAssemblySplitDet"); 
 delFireEventOne(rowId,tableName,'tblGoodsAssemblySplitDet_Amount',"tblGoodsAssemblySplitDet"); 
 delFireEventOne(rowId,tableName,'tblGoodsAssemblySplitDetail_Qty',"tblGoodsAssemblySplitDetail"); 
 delFireEventOne(rowId,tableName,'tblGoodsAssemblySplitDetail_Price',"tblGoodsAssemblySplitDetail"); 
 delFireEventOne(rowId,tableName,'tblGoodsAssemblySplitDetail_Amount',"tblGoodsAssemblySplitDetail"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'BillAmt',dis:'单据金额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'MainQty',dis:'数量',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDet_Qty',dis:'数量',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDet_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDet_Amount',dis:'金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDet_UnitPruQty',dis:'单位产品用量',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDetail_Qty',dis:'数量',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDetail_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDetail_Amount',dis:'金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblGoodsAssemblySplitDetail_UnitPruQty',dis:'单位产品用量',digit:4,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblGoodsAssemblySplit",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblGoodsAssemblySplit&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblGoodsAssemblySplit&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 if(fieldName == "SubCode"){
 var saveField=n("SubCode"); 
 saveField[0].value = "";
 var obj = m("tbl_tblBillAccSetup_SubCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblBillAccSetup_SubType");
 saveField[0].value = ""; 
 m("tbl_tblBillAccSetup_SubType").value = "" ;
 }
 }
...
function initSeqQtySet(){
 if(false){
   ...
   if(false){
 var fields=n('tblGoodsAssemblySplitDet_Qty'); 
 for(var i = 0;i<fields.length;i++){ 
 fields[i].readOnly="readOnly";
 }
 }
    if(false){
 var fields=n('tblGoodsAssemblySplitDetail_Qty'); 
 for(var i = 0;i<fields.length;i++){ 
 fields[i].readOnly="readOnly";
 }
 }
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblGoodsAssemblySplit"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblGoodsAssemblySplit&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblGoodsAssemblySplit&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function initMainCaculate(){
 ...
 for(var j=0;j<r(0,'Qty').length;j++){
r(0,"Qty")[j].value=f(rn(0,"UnitPruQty",j)*nn('MainQty',0),4);
}

for(var j=0;j<r(1,'Qty').length;j++){
r(1,"Qty")[j].value=f(rn(1,"UnitPruQty",j)*nn('MainQty',0),4);
}
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblGoodsAssemblySplitDet_Qty'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),2);
n('BillAmt')[0].value=f(sm('tblGoodsAssemblySplitDetail_Amount')-sm('tblGoodsAssemblySplitDet_Amount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblGoodsAssemblySplitDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Qty",p)*rn(0,"Price",p),2);
n('BillAmt')[0].value=f(sm('tblGoodsAssemblySplitDetail_Amount')-sm('tblGoodsAssemblySplitDet_Amount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblGoodsAssemblySplitDet_Amount'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblGoodsAssemblySplitDetail_Qty'); 
 r(1,"Amount")[p].value=f(rn(1,"Qty",p)*rn(1,"Price",p),2);
n('BillAmt')[0].value=f(sm('tblGoodsAssemblySplitDetail_Amount')-sm('tblGoodsAssemblySplitDet_Amount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblGoodsAssemblySplitDetail_Price'); 
 r(1,"Amount")[p].value=f(rn(1,"Qty",p)*rn(1,"Price",p),2);
n('BillAmt')[0].value=f(sm('tblGoodsAssemblySplitDetail_Amount')-sm('tblGoodsAssemblySplitDet_Amount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblGoodsAssemblySplitDetail_Amount'); 
...
childData[childCount]='tblGoodsAssemblySplitDet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='组拆装单领用明细';
childCount++;
 var tblGoodsAssemblySplitDetData = new gridData();
 gridDatas[gridDataNum] = tblGoodsAssemblySplitDetData;
 gridDataNum++;
 var tblGoodsAssemblySplitDet=1;
 
 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","0",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 ...
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_StockCode','领用仓库','100',2,false,'Sess_StockCode',100,-2,'','',"","copy","1",'',"2",true);
 putChildValidateItem("tblGoodsAssemblySplitDet_StockCode","领用仓库","any","",false,minValue,100,true,'Sess_StockCode');
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_tblStock_StockFullName1','领用仓库','75',0,true,'Sess_StockFullName',1000000,2,'tblGoodsAssemblySplitDet:StockCode:tblGoodsAssemblySplitDet_tblStock_StockFullName1:'+param4,'',"","copy","1",'',"2",false); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_OutStoreStateID','领用仓仓位','0',0,true,'',0,-2,'','',"","","2",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_OutStoreStateID","领用仓仓位","int","",true,minValue,maxValue,false,''); 
 ...
 var param4="";
 param4=param4+":1领用仓库@tblGoodsAssemblySplitDet_StockCode";
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_GoodsCode','领用商品','120',2,false,'',100,-2,'','',"","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblGoodsAssemblySplitDet_GoodsCode","领用商品","any","",false,minValue,100,false,'');
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblGoodsAssemblySplitDet:GoodsCode:tblGoodsAssemblySplitDet_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_tblGoods_GoodsFullName','领用商品','120',18,true,'',1000000,2,'tblGoodsAssemblySplitDet:GoodsCode:tblGoodsAssemblySplitDet_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_tblGoods_GoodsSpec','商品规格','60',2,true,'',1000000,2,'tblGoodsAssemblySplitDet:GoodsCode:tblGoodsAssemblySplitDet_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblGoodsAssemblySplitDet:GoodsCode:tblGoodsAssemblySplitDet_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_tblStocks_lastQty','实际库存','60',1,true,'',1000000,2,'tblGoodsAssemblySplitDet:GoodsCode:tblGoodsAssemblySplitDet_tblStocks_lastQty:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty','虚拟库存','60',1,true,'',1000000,2,'tblGoodsAssemblySplitDet:GoodsCode:tblGoodsAssemblySplitDet_ViewVirtualStock_UseQty:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 ...
 var param4="";
 param4=param4+":1领用商品@tblGoodsAssemblySplitDet_GoodsCode";
 param4=param4+":1领用仓库@tblGoodsAssemblySplitDet_StockCode";
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_BatchNo','批号','120',2,true,'',100,2,'tblGoodsAssemblySplitDet:BatchNo:tblGoodsAssemblySplitDet_BatchNo:'+param4,"","","triggerCopy","4",'',"2",true);
 putChildValidateItem("tblGoodsAssemblySplitDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,'',true);
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","5",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","6",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_color','色彩','60',2,true,'',100,-2,'','',"","","7",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_color","色彩","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","8",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","9",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","10",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_ItemNo','序号','0',0,true,'',0,-2,'','',"","","11",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_ItemNo","序号","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Qty','数量','80',1,true,'0',0,0,'','',"Qty","triggerCopy","12",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Qty","数量","double","SeqQty",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Price','单价','80',1,true,'0',0,8,'','',"priceIdentifier","","13",'',"8",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Price","单价","double","",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Amount','金额','100',1,true,'',0,8,'','',"AmountIdentifier","","14",'',"8",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_UnitPruQty','单位产品用量','200',1,true,'0',0,8,'','',"Qty","","20",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_UnitPruQty","单位产品用量","double","",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_BatchCode','批号','0',2,true,'',100,-2,'','',"","","21",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_BatchCode","批号","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","22",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","24",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_SourceID','源ID','200',2,true,'',100,-2,'','',"","","25",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_SourceID","源ID","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_Remark','备注','100',2,true,'',8000,0,'','',"","","26",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(tblGoodsAssemblySplitDetData,'tblGoodsAssemblySplitDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='tblGoodsAssemblySplitDetail';
tabIsNulls[childCount]='1';
tabDiss[childCount]='组拆装入库明细';
childCount++;
 var tblGoodsAssemblySplitDetailData = new gridData();
 gridDatas[gridDataNum] = tblGoodsAssemblySplitDetailData;
 gridDataNum++;
 var tblGoodsAssemblySplitDetail=1;
 ...
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_StockCode','入库仓库','100',2,false,'Sess_StockCode',100,-2,'','',"","copy","0",'',"2",true);
 putChildValidateItem("tblGoodsAssemblySplitDetail_StockCode","入库仓库","any","",false,minValue,100,true,'Sess_StockCode');
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_tblStock_StockFullName1','入库仓库','75',0,true,'Sess_StockFullName',1000000,2,'tblGoodsAssemblySplitDetail:StockCode:tblGoodsAssemblySplitDetail_tblStock_StockFullName1:'+param4,'',"","copy","0",'',"2",false); 
 
 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_inStoreStateID','入库仓仓位','0',0,true,'',0,-2,'','',"","","1",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_inStoreStateID","入库仓仓位","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_BatchCode','批号','0',2,true,'',100,-2,'','',"","","2",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_BatchCode","批号","any","",true,minValue,100,false,''); 
 ...
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_GoodsCode','入库商品','60',2,false,'',100,-2,'','',"","triggerOrCopy","4",'',"2",true);
 putChildValidateItem("tblGoodsAssemblySplitDetail_GoodsCode","入库商品","any","",false,minValue,100,false,'');
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblGoodsAssemblySplitDetail:GoodsCode:tblGoodsAssemblySplitDetail_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName','入库商品','120',18,true,'',1000000,2,'tblGoodsAssemblySplitDetail:GoodsCode:tblGoodsAssemblySplitDetail_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec','商品规格','60',2,true,'',1000000,2,'tblGoodsAssemblySplitDetail:GoodsCode:tblGoodsAssemblySplitDetail_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblGoodsAssemblySplitDetail:GoodsCode:tblGoodsAssemblySplitDetail_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_BatchNo','批号','120',2,true,'',100,0,'','',"","triggerCopy","5",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_BatchNo","批号","any","GoodsField",true,minValue,100,false,'',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","6",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","7",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_ItemNo','序号','0',0,true,'',0,-2,'','',"","","8",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_ItemNo","序号","int","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","9",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","10",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Availably','保质期限','80',5,true,'',10,-2,'','',"","","11",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Seq','序列号','130',2,true,'',5000,-2,'','',"","","12",'',"2",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Qty','数量','80',1,true,'0',0,0,'','',"Qty","triggerCopy","13",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Qty","数量","double","SeqQty",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Price','单价','80',1,true,'0',0,0,'','',"priceIdentifier","","14",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Price","单价","double","",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Amount','金额','100',1,true,'',0,0,'','',"AmountIdentifier","","15",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_UnitPruQty','单位产品用量','200',1,true,'0',0,8,'','',"Qty","","21",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_UnitPruQty","单位产品用量","double","",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_color','色彩','60',2,true,'',100,-2,'','',"","","22",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_color","色彩","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","23",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","25",'',"3",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_Remark','备注','100',2,true,'',8000,0,'','',"","","26",'',"0",false); 
 putChildValidateItem("tblGoodsAssemblySplitDetail_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(tblGoodsAssemblySplitDetailData,'tblGoodsAssemblySplitDetail_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblGoodsAssemblySplit&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblGoodsAssemblySplit,tblGoodsAssemblySplitDet,tblGoodsAssemblySplitDetail,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblGoodsAssemblySplit&allTableName=tblGoodsAssemblySplit,tblGoodsAssemblySplitDet,tblGoodsAssemblySplitDetail,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblGoodsAssemblySplit&allTableName=tblGoodsAssemblySplitDet,tblGoodsAssemblySplitDetail,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblGoodsAssemblySplit&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblGoodsAssemblySplit&allTableName=tblGoodsAssemblySplitDet,tblGoodsAssemblySplitDetail,&colType=colWidth" ;
...
function seqInput(){
 ...
 var cTabName = "tblGoodsAssemblySplitDet";
 var stockCode="";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblGoodsAssemblySplit&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblGoodsAssemblySplit&designId=f04fa846_1107191503511400010&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblGoodsAssemblySplit&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblGoodsAssemblySplit&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblGoodsAssemblySplit&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '组拆装单';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblGoodsAssemblySplit&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
