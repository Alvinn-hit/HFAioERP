...
function printData(){
 ...
 var urls = "/UserFunctionQueryAction.do?tableName=PDGoodsApply&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+bid+"&parentTableName=&winCurIndex="+winCurIndex;
...
function printLabelData(){
 ...
 var urls = "/UserFunctionQueryAction.do?tableName=PDGoodsApply&reportNumber=PrintSeqPDGoodsApply&printType=labelPrint&operation=18&keyId="+keyVal+"&parentTableName=&winCurIndex="+winCurIndex;
...
function onItemClick(str){
 ...
 if(currentId!=str){
 currentId = str ;
 setIframSrc2("/UserFunctionAction.do?tableName=PDGoodsApply&keyId="+str+"&operation=7&winCurIndex="+winCurIndex,currentId);
 }
}
...
function setColumnSet(str,lockName){
 ...
 lockName = "";
 var strURL = "/UtilServlet?operation=colconfig&tableName=PDGoodsApply&colType=list&lockName="+lockName+"&colSelect="+str ;
 AjaxRequest(strURL);
...
function onDefaultCol(){
 ...
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=PDGoodsApply&colType=list" ;
 AjaxRequest(strURL);
 if(location.href.indexOf("src=menu")!=-1)
 {
 window.location.reload();
...
function copyOperation()
{
 ...
 usrc="/UserFunctionAction.do?&operation=17&tableName=PDGoodsApply&saveDraft=&parentTableName=&moduleType="+moduleTypeValue+"&f_brother="+f_brother+"&noback=false&winCurIndex="+winCurIndex+"&keyId="+document.getElementById("varKeyIds").value.split("|")[0];
...
function telCall()
{
 ...
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=PDGoodsApply&keyId="+keyIds,"","dialogWidth=600px;dialogHeight=350px"); 
 } 
 }else
 {
 alert("请选择至少一条记录"); 
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=PDGoodsApply&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function addPrepare(){
 ...
 usrc ='/UserFunctionAction.do?tableName=PDGoodsApply&parentCode='+parentCode+'&operation=6&moduleType='+moduleTypeValue+'&f_brother='+f_brother+'&parentTableName=&winCurIndex='+winCurIndex;
...
function openSelect(selectName,fieldName,display){
 ...
 var urlstr = '/UserFunctionAction.do?operation=22&src=menu&parentTableName='+parentTableName+'&moduleType='+moduleType+'&displayName='+encodeURI(display)+'&LinkType=@URL:&tableName=PDGoodsApply&selectName='+selectName+encodeURI(linkStr) ;
...
function exePopdiv(returnValue){
 ...
 if(typeof(str)!="undefined"){
 if(selectName=="PDReportSelectGoodsBom"){
 document.getElementById("GoodsNumber2").value="";
 document.getElementById("GoodsFullName2").value="";
 document.getElementById("GoodsSpec2").value="";
 var group=str.split("#|#") ;
 var clear=true;
 for(var i=0;i<group.length;i++){
 if(group[i].length>0){
 var content = group[i].split("#;#") ;
 if(content[1-1].length>0){clear=false;document.getElementById("GoodsNumber2").value+=content[1-1]+',';} 
 if(content[2-1].length>0){clear=false;document.getElementById("GoodsFullName2").value+=content[2-1]+',';} 
 if(content[3-1].length>0){clear=false;document.getElementById("GoodsSpec2").value+=content[3-1]+',';} 
 }
 }
 if(clear){
 document.getElementById("GoodsNumber2").value="";
 ...
 document.getElementById("GoodsNumber2").value=document.getElementById("GoodsNumber2").value.substring(0,document.getElementById("GoodsNumber2").value.length-1) ;
 document.getElementById("GoodsFullName2").value=document.getElementById("GoodsFullName2").value.substring(0,document.getElementById("GoodsFullName2").value.length-1) ;
 document.getElementById("GoodsSpec2").value=document.getElementById("GoodsSpec2").value.substring(0,document.getElementById("GoodsSpec2").value.length-1) ;
 }
 }
 if(selectName=="PDReportSelectGoodsBom"){
 document.getElementById("GoodsNumber2").value="";
 ...
 if(selectName=="PDSelectSuppliersForReport"){
...
function exePopadvancediv(returnValue){
 ...
 if(typeof(str)!="undefined"){
 if(selectName=="PDReportSelectGoodsBom"){
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value="";
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsFullName2").value="";
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsSpec2").value="";
 var group=str.split("|") ;
 var clear=true;
 for(var i=0;i<group.length;i++){
 if(group[i].length>0){
 var content = group[i].split(";") ;
 if(content[1-1].length>0){clear=false;jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value+=content[1-1]+',';} 
 if(content[2-1].length>0){clear=false;jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsFullName2").value+=content[2-1]+',';} 
 if(content[3-1].length>0){clear=false;jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsSpec2").value+=content[3-1]+',';} 
 }
 }
 if(clear){
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value="";
 ...
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value=jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value.substring(0,jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value.length-1) ;
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsFullName2").value=jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsFullName2").value.substring(0,jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsFullName2").value.length-1) ;
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsSpec2").value=jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsSpec2").value.substring(0,jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsSpec2").value.length-1) ;
 }
 }
 if(selectName=="PDReportSelectGoodsBom"){
 jQuery.opener("advanceUpdatePanel").document.getElementById("GoodsNumber2").value="";
...
function setFieldValue(str,selectName,fieldName){
 ...
 if(selectName=="PDReportSelectGoodsBom"){
 document.getElementById("GoodsNumber2").value=fs[1-1];
 document.getElementById("GoodsFullName2").value=fs[2-1];
 document.getElementById("GoodsSpec2").value=fs[3-1];
 var lastObject = document.getElementById("GoodsSpec2");
...
function showDivCustomSetTable(){ 
 var returnValue = window.showModalDialog("/UserFunctionQueryAction.do?tableName=PDGoodsApply&operation=4&parentTableName=&configType=listConfig&checkTab=Y&winCurIndex="+winCurIndex,"","dialogWidth=670px;dialogHeight=450px") ;
...
function deliverToAll(){ 
 ...
 checkDialog("/OAMyWorkFlow.do?keyId="+keyIds+"&tableName=PDGoodsApply&moduleType="+moduleType+"&operation=82&fromPage=erp&type=deliverToAll");
...
function detail(str){
 ...
 turl="/UserFunctionAction.do?tableName=PDGoodsApply&keyId="+str.split(",")[0]+"&moduleType="+moduleType+"&f_brother="+f_brother+"&operation=5&winCurIndex="+winCurIndex+"&pageNo=&parentCode="+str.split(",")[1]+"&parentTableName=&saveDraft=";
...
function update(str){
 turl="/UserFunctionAction.do?tableName=PDGoodsApply&keyId="+str.split(",")[0]+"&moduleType="+moduleType+"&f_brother="+f_brother+"&operation=7&winCurIndex="+winCurIndex+"&pageNo=&parentCode="+str.split(",")[1]+"&parentTableName=&saveDraft=";
...
function next(str){
 location.href="/UserFunctionQueryAction.do?tableName=PDGoodsApply&keyId="+str.split(",")[0]+"&parentCode="+str.split(",")[1]+"&operation=4&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&parentTableName=&checkTab=Y&selectType="+$("#selectType").val();
}


function doChangeParent(parentCode,name,ttableName){
 location.href="/UserFunctionQueryAction.do?tableName=PDGoodsApply&parentCode="+parentCode+"&operation=4&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&parentTableName=&checkTab=Y&selectType="+$("#selectType").val();
}
...
function addClass(parentCodev){
 ...
 usrc ='/UserFunctionAction.do?tableName=PDGoodsApply&parentCode='+parentCodev+'&operation=6&moduleType='+moduleTypeValue+'&f_brother='+f_brother+'&parentTableName=&winCurIndex='+winCurIndex;
...
function hurryTrans(str){
 ...
 hurryTransDialog("/vm/oa/workflow/noteModel.jsp?tableName=PDGoodsApply&moduleName="+encodeURI(ren)+"&keyId="+str.split(",")[0],winObj,"dialogWidth=565px;dialogHeight=350px");
}
...
function check(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=PDGoodsApply&parentTableName=&moduleType="+moduleType+"&operation=25&ButtonType=saveCheckBill&varKeyIds="+str.split(",")[0]+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+str.split(",")[0]+"&tableName=PDGoodsApply&moduleType="+moduleType+"&operation=82&fromPage=erp");
 ...
 location.href="/UserFunctionQueryAction.do?tableName=PDGoodsApply&moduleType="+moduleType+"&keyId="+str.split(",")[0]+"&f_brother="+f_brother+"&operation=83&winCurIndex="+winCurIndex+"&pageNo=&parentTableName=&saveDraft=";
 }else if(str.split(",")[1]=="cancel"){
 if(confirm('确定撤回?')){
 location.href='/UserFunctionQueryAction.do?nextStep=cancel&moduleType='+moduleType+'&tableName=PDGoodsApply&lastNodeId='+str.split(",")[2]+'&keyId='+str.split(",")[0]+'&currNode='+str.split(",")[3]+'&f_brother='+f_brother+'&operation=79&winCurIndex='+winCurIndex+'&pageNo=&parentTableName=&saveDraft='
 }
 }
}
