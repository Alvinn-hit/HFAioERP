...
{ 
 cFireEvent('tblSalesReplaceDet_Qty',''); 
 cFireEvent('tblSalesReplaceDet_Price',''); 
 cFireEvent('tblSalesReplaceDetail_Qty',''); 
 cFireEvent('tblSalesReplaceDetail_Price',''); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblSalesReplace&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblSalesReplace&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblSalesReplace&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblSalesReplace&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblSalesReplaceDetTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblSalesReplaceDetailTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblSalesReplaceDet_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 z[i].addEventListener("blur",copyFields,false);
 }
 }
 var z=n('tblSalesReplaceDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDet_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDet_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDet_Seq');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDetail_Seq');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDetail_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDetail_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDetail_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDetail_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblSalesReplaceDetail_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblSalesReplaceDet"){
 
 copyFields=n('tblSalesReplaceDet_StockCode');
 ...
 var tblSalesReplaceDet_tblStock_StockFullName1 = n('tblSalesReplaceDet_tblStock_StockFullName1');
 if(typeof(tblSalesReplaceDet_tblStock_StockFullName1) != 'undefined' && tblSalesReplaceDet_tblStock_StockFullName1.length >index){
 tblSalesReplaceDet_tblStock_StockFullName1[index].value = tblSalesReplaceDet_tblStock_StockFullName1[index-1].value;
 }
 }
 copyFields=n('tblSalesReplaceDet_GoodsCode');
 if((order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblSalesReplaceDet_tblGoods_GoodsNumber = n('tblSalesReplaceDet_tblGoods_GoodsNumber');
 if(typeof(tblSalesReplaceDet_tblGoods_GoodsNumber) != 'undefined' && tblSalesReplaceDet_tblGoods_GoodsNumber.length >index){
 tblSalesReplaceDet_tblGoods_GoodsNumber[index].value = tblSalesReplaceDet_tblGoods_GoodsNumber[index-1].value;
 }
 var tblSalesReplaceDet_tblGoods_GoodsFullName = n('tblSalesReplaceDet_tblGoods_GoodsFullName');
 if(typeof(tblSalesReplaceDet_tblGoods_GoodsFullName) != 'undefined' && tblSalesReplaceDet_tblGoods_GoodsFullName.length >index){
 tblSalesReplaceDet_tblGoods_GoodsFullName[index].value = tblSalesReplaceDet_tblGoods_GoodsFullName[index-1].value;
 }
 var tblSalesReplaceDet_tblGoods_GoodsSpec = n('tblSalesReplaceDet_tblGoods_GoodsSpec');
 if(typeof(tblSalesReplaceDet_tblGoods_GoodsSpec) != 'undefined' && tblSalesReplaceDet_tblGoods_GoodsSpec.length >index){
 tblSalesReplaceDet_tblGoods_GoodsSpec[index].value = tblSalesReplaceDet_tblGoods_GoodsSpec[index-1].value;
 }
 var tblSalesReplaceDet_tblGoods_BaseUnit = n('tblSalesReplaceDet_tblGoods_BaseUnit');
 if(typeof(tblSalesReplaceDet_tblGoods_BaseUnit) != 'undefined' && tblSalesReplaceDet_tblGoods_BaseUnit.length >index){
 tblSalesReplaceDet_tblGoods_BaseUnit[index].value = tblSalesReplaceDet_tblGoods_BaseUnit[index-1].value;
 }
 }
   }
 if(typeof(tableName)!="undefined" && tableName=="tblSalesReplaceDetail"){
 
 copyFields=n('tblSalesReplaceDetail_StockCode');
 if(copyFields[index].value !=0 && copyFields[index].value != ""){return}
 if((order > 0 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblSalesReplaceDetail_tblStock_StockFullName1 = n('tblSalesReplaceDetail_tblStock_StockFullName1');
 if(typeof(tblSalesReplaceDetail_tblStock_StockFullName1) != 'undefined' && tblSalesReplaceDetail_tblStock_StockFullName1.length >index){
 tblSalesReplaceDetail_tblStock_StockFullName1[index].value = tblSalesReplaceDetail_tblStock_StockFullName1[index-1].value;
 }
 }
 copyFields=n('tblSalesReplaceDetail_GoodsCode');
 if((order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblSalesReplaceDetail_tblGoods_GoodsNumber = n('tblSalesReplaceDetail_tblGoods_GoodsNumber');
 if(typeof(tblSalesReplaceDetail_tblGoods_GoodsNumber) != 'undefined' && tblSalesReplaceDetail_tblGoods_GoodsNumber.length >index){
 tblSalesReplaceDetail_tblGoods_GoodsNumber[index].value = tblSalesReplaceDetail_tblGoods_GoodsNumber[index-1].value;
 }
 var tblSalesReplaceDetail_tblGoods_GoodsFullName = n('tblSalesReplaceDetail_tblGoods_GoodsFullName');
 if(typeof(tblSalesReplaceDetail_tblGoods_GoodsFullName) != 'undefined' && tblSalesReplaceDetail_tblGoods_GoodsFullName.length >index){
 tblSalesReplaceDetail_tblGoods_GoodsFullName[index].value = tblSalesReplaceDetail_tblGoods_GoodsFullName[index-1].value;
 }
 var tblSalesReplaceDetail_tblGoods_GoodsSpec = n('tblSalesReplaceDetail_tblGoods_GoodsSpec');
 if(typeof(tblSalesReplaceDetail_tblGoods_GoodsSpec) != 'undefined' && tblSalesReplaceDetail_tblGoods_GoodsSpec.length >index){
 tblSalesReplaceDetail_tblGoods_GoodsSpec[index].value = tblSalesReplaceDetail_tblGoods_GoodsSpec[index-1].value;
 }
 var tblSalesReplaceDetail_tblGoods_BaseUnit = n('tblSalesReplaceDetail_tblGoods_BaseUnit');
 if(typeof(tblSalesReplaceDetail_tblGoods_BaseUnit) != 'undefined' && tblSalesReplaceDetail_tblGoods_BaseUnit.length >index){
 tblSalesReplaceDetail_tblGoods_BaseUnit[index].value = tblSalesReplaceDetail_tblGoods_BaseUnit[index-1].value;
 }
 var tblSalesReplaceDetail_tblStocks_lastQty = n('tblSalesReplaceDetail_tblStocks_lastQty');
 if(typeof(tblSalesReplaceDetail_tblStocks_lastQty) != 'undefined' && tblSalesReplaceDetail_tblStocks_lastQty.length >index){
 tblSalesReplaceDetail_tblStocks_lastQty[index].value = tblSalesReplaceDetail_tblStocks_lastQty[index-1].value;
 }
 var tblSalesReplaceDetail_ViewVirtualStock_UseQty = n('tblSalesReplaceDetail_ViewVirtualStock_UseQty');
 if(typeof(tblSalesReplaceDetail_ViewVirtualStock_UseQty) != 'undefined' && tblSalesReplaceDetail_ViewVirtualStock_UseQty.length >index){
 tblSalesReplaceDetail_ViewVirtualStock_UseQty[index].value = tblSalesReplaceDetail_ViewVirtualStock_UseQty[index-1].value;
 }
 }
   }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblSalesReplaceDet"){
 ...
 copyFields=n('tblSalesReplaceDet_GoodsCode'); 
 if( (order > 3 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblSalesReplaceDet_tblGoods_GoodsNumber = n('tblSalesReplaceDet_tblGoods_GoodsNumber'); 
 if(typeof(tblSalesReplaceDet_tblGoods_GoodsNumber) != 'undefined' && tblSalesReplaceDet_tblGoods_GoodsNumber.length >index){
 tblSalesReplaceDet_tblGoods_GoodsNumber[index].value = tblSalesReplaceDet_tblGoods_GoodsNumber[index-1].value;
 ...
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblSalesReplaceDetail"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="tblSalesReplaceDet"; 
 var goodsCodeLogicValidate_tblSalesReplaceDet='@GN:Seq:Qty:tblSalesReplaceDet_GoodsSeqSet:tblSalesReplaceDet_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblSalesReplaceDet',value:goodsCodeLogicValidate_tblSalesReplaceDet};
 tblName[1]="tblSalesReplaceDetail"; 
 var goodsCodeLogicValidate_tblSalesReplaceDetail='@GN:Seq:Qty:tblSalesReplaceDetail_GoodsSeqSet:tblSalesReplaceDetail_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblSalesReplaceDetail',value:goodsCodeLogicValidate_tblSalesReplaceDetail};
...
function execStat2(){
 execStatOne('tblSalesReplaceDet_Qty',2);
 execStatOne('tblSalesReplaceDet_Amount',2);
 execStatOne('tblSalesReplaceDet_CostAmount',2);
 execStatOne('tblSalesReplaceDetail_Qty',2);
 execStatOne('tblSalesReplaceDetail_Amount',2);
 setTotalCount(getTotalCount());
}
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblSalesReplace\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblSalesReplace\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblSalesReplaceDet_Qty',"tblSalesReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDet_Price',"tblSalesReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDet_Amount',"tblSalesReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDet_CostPrice',"tblSalesReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDet_CostAmount',"tblSalesReplaceDet"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDetail_Qty',"tblSalesReplaceDetail"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDetail_Price',"tblSalesReplaceDetail"); 
 delFireEventOne(rowId,tableName,'tblSalesReplaceDetail_Amount',"tblSalesReplaceDetail"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'AccountAmount',dis:'收款金额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'DiscountAmount',dis:'优惠金额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'TotalAmount',dis:'单据差异金额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDet_Qty',dis:'数量',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDet_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDet_Amount',dis:'金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDet_CostPrice',dis:'成本单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDet_CostAmount',dis:'成本总额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDetail_Qty',dis:'数量',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDetail_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesReplaceDetail_Amount',dis:'金额',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblSalesReplace",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblSalesReplace&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblSalesReplace&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_tblDepartment_DeptFullName");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblEmployee_EmpFullName"); 
 saveField[0].value = "";
 var obj = m("tbl_tblEmployee_EmpFullName");
 if(obj != null){
 obj.value = "";
 }
 ...
 saveField[0].value = "";
 var obj = m("tbl_tblCompany_DepartmentCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("EmployeeID"); 
 saveField[0].value = "";
 var obj = m("tbl_tblCompany_EmployeeID");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("Tax"); 
 ...
 saveField[0].value = ""; 
 m("tbl_tblStock_StockFullName").value = "" ;
 }
 if(fieldName == "InStockCode"){
 var saveField=n("InStockCode"); 
 saveField[0].value = "";
 var obj = m("tbl_tblStock_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("ViewtblStocksChild_StockFullName");
 saveField[0].value = ""; 
 m("tbl_ViewtblStocksChild_StockFullName").value = "" ;
 }
...
function initSeqQtySet(){
 if(false){
  ...
  if(false){
 var fields=n('tblSalesReplaceDet_Qty'); 
 for(var i = 0;i<fields.length;i++){ 
 fields[i].readOnly="readOnly";
 }
 }
      if(false){
 var fields=n('tblSalesReplaceDetail_Qty'); 
 for(var i = 0;i<fields.length;i++){ 
 fields[i].readOnly="readOnly";
 }
 }
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblSalesReplace"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblSalesReplace&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblSalesReplace&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
for(var j=0;j<r(1,'TaxPrice').length;j++){
r(1,"TaxPrice")[j].value=f(((nn('Tax',0)/100)+1)*rn(1,"Discount",j)*rn(1,"Price",j)/100,4);
}

for(var j=0;j<r(1,'TaxAmount').length;j++){
r(1,"TaxAmount")[j].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",j)*rn(1,"Discount",j)/100,2);
}

for(var j=0;j<r(1,'CurPrice').length;j++){
r(1,"CurPrice")[j].value=f((((nn('Tax',0)/100)+1)*rn(1,"Discount",j)*rn(1,"Price",j)/100)/nn('CurrencyRate',0),4);
}

for(var j=0;j<r(1,'CurAmount').length;j++){
r(1,"CurAmount")[j].value=f((((nn('Tax',0)/100)+1)*rn(1,"Amount",j)*rn(1,"Discount",j)/100)/nn('CurrencyRate',0),2);
}

for(var j=0;j<r(1,'CoTaxAmt').length;j++){
r(1,"CoTaxAmt")[j].value=f(rn(1,"TaxAmount",j)-rn(1,"DisBackAmt",j),2);
}

for(var j=0;j<r(1,'DisAmount').length;j++){
r(1,"DisAmount")[j].value=f(rn(1,"Amount",j)-rn(1,"DisBackAmt",j),2);
}

n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);

n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);

n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);

n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReplaceDetail_CoTaxAmt')-sm('tblSalesReplaceDet_CoTaxAmt'),2);

n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 n('CurDiscountAmount')[0].value=f(nn('DiscountAmount',0)/nn('CurrencyRate',0),2);


 n('CurTotalAmount')[0].value=f(sm('tblSalesReplaceDetail_CurAmount')-sm('tblSalesReplaceDet_CurAmount')-nn('CurDiscountAmount',0),2);
 ...
 var z=n('CurDiscountAmount');
 for(i = 0;i<z.length;i++){ 
 z[i].onchange = function(){ 
 n('DiscountAmount')[0].value=f(nn('CurDiscountAmount',0)*nn('CurrencyRate',0),2);
...
for(var j=0;j<r(1,'Discount').length;j++){
r(1,"Discount")[j].value=f(nn('Discount',0),4);
}
...
for(var j=0;j<r(1,'DisPrice').length;j++){
r(1,"DisPrice")[j].value=f(rn(1,"Discount",j)*rn(1,"Price",j)/100,4);
}

for(var j=0;j<r(1,'DisBackAmt').length;j++){
r(1,"DisBackAmt")[j].value=f(rn(1,"Amount",j)*rn(1,"Discount",j)/100,2);
}
...
for(var j=0;j<r(1,'CoTaxAmt').length;j++){
r(1,"CoTaxAmt")[j].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",j)*rn(1,"Discount",j)/100-rn(1,"Amount",j)*rn(1,"Discount",j)/100,2);
}

for(var j=0;j<r(1,'DisAmount').length;j++){
r(1,"DisAmount")[j].value=f(rn(1,"Amount",j)-rn(1,"Amount",j)*rn(1,"Discount",j)/100,2);
}
...
r(1,"TaxPrice")[j].value=f(rn(1,"CurPrice",j)*nn('CurrencyRate',0),4);
}

for(var j=0;j<r(1,'DisPrice').length;j++){

r(1,"DisPrice")[j].value=f(rn(1,"CurPrice",j)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),4);
}

for(var j=0;j<r(1,'Price').length;j++){

r(1,"Price")[j].value=f(rn(1,"CurPrice",j)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(1,"Discount",j)/100),4);
}

for(var j=0;j<r(1,'TaxAmount').length;j++){

r(1,"TaxAmount")[j].value=f(rn(1,"CurAmount",j)*nn('CurrencyRate',0),2);
}

for(var j=0;j<r(1,'DisBackAmt').length;j++){

r(1,"DisBackAmt")[j].value=f(rn(1,"CurAmount",j)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),2);
}

for(var j=0;j<r(1,'Amount').length;j++){

r(1,"Amount")[j].value=f(rn(1,"CurAmount",j)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(1,"Discount",j)/100),2);
}


n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt')-nn('DiscountAmount',0),2);
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_Qty'); 
...
r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Price",p)*rn(0,"Qty",p),2);
...
r(0,"CurPrice")[p].value=f(rn(0,"Price",p)/nn('CurrencyRate',0),4);
r(0,"DisBackAmt")[p].value=f(rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
r(0,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_Amount'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_Discount'); 
 r(0,"DisPrice")[p].value=f(rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"DisBackAmt")[p].value=f(rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
r(0,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_DisPrice'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_DisBackAmt'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_TaxPrice'); 
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_TaxAmount'); 
 r(0,"TaxPrice")[p].value=f(rn(0,"TaxAmount",p)/rn(0,"Qty",p),4);
r(0,"DisPrice")[p].value=f(rn(0,"TaxPrice",p)/((nn('Tax',0)/100)+1),4);
r(0,"Price")[p].value=f((rn(0,"TaxPrice",p)/((nn('Tax',0)/100)+1))*100/rn(0,"Discount",p),4);
r(0,"CurPrice")[p].value=f(((rn(0,"TaxPrice",p)/((nn('Tax',0)/100)+1))*100/rn(0,"Discount",p))/nn('CurrencyRate',0),4);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_CurPrice'); 
...
r(0,"TaxAmount")[p].value=f(rn(0,"CurPrice",p)*rn(0,"Qty",p)*nn('CurrencyRate',0),2);
r(0,"DisBackAmt")[p].value=f(rn(0,"CurPrice",p)*rn(0,"Qty",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),2);
r(0,"Amount")[p].value=f(rn(0,"CurPrice",p)*rn(0,"Qty",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(0,"Discount",p)/100) ,2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_CurAmount'); 
...
r(0,"TaxPrice")[p].value=f((rn(0,"CurAmount",p)/rn(0,"Qty",p))*nn('CurrencyRate',0),4);

r(0,"DisPrice")[p].value=f((rn(0,"CurAmount",p)/rn(0,"Qty",p))*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),4);

r(0,"Price")[p].value=f((rn(0,"CurAmount",p)/rn(0,"Qty",p))*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(0,"Discount",p)/100),4);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_CostPrice'); 
 r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_CostAmount'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_PresentSampleType'); 
...
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDet_SecQty'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_Qty'); 
 r(1,"Amount")[p].value=f(rn(1,"Price",p)*rn(1,"Qty",p),2);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*(rn(1,"Amount",p)*rn(1,"Discount",p)/100),2);
r(1,"CurAmount")[p].value=f((((nn('Tax',0)/100)+1)*(rn(1,"Amount",p)*rn(1,"Discount",p)/100))/nn('CurrencyRate',0),2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);
r(1,"DisAmount")[p].value=f(rn(1,"Amount",p)-rn(1,"DisBackAmt",p),2);
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
r(1,"CoTaxAmt")[p].value=f(rn(1,"TaxAmount",p)-rn(1,"DisBackAmt",p),2);
n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReplaceDetail_CoTaxAmt')-sm('tblSalesReplaceDet_CoTaxAmt'),2);
r(1,"CostAmount")[p].value=f(rn(1,"CostPrice",p)*rn(1,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_Price'); 
 r(1,"Amount")[p].value=f(rn(1,"Price",p)*rn(1,"Qty",p),2);
r(1,"DisPrice")[p].value=f(rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"CurPrice")[p].value=f(rn(1,"Price",p)/nn('CurrencyRate',0),4);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_Amount'); 
 r(1,"Price")[p].value=f(rn(1,"Amount",p)/rn(1,"Qty",p),4);
r(1,"DisPrice")[p].value=f(rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*(rn(1,"Discount",p)*rn(1,"Price",p)/100),4);
r(1,"CurPrice")[p].value=f((((nn('Tax',0)/100)+1)*(rn(1,"Discount",p)*rn(1,"Price",p)/100))/nn('CurrencyRate',0),4);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_Discount'); 
 r(1,"DisPrice")[p].value=f(rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Discount",p)*rn(1,"Price",p)/100,4);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_DisPrice'); 
 r(1,"Discount")[p].value=f(rn(1,"DisPrice",p)/rn(1,"Price",p)*100,4);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"DisPrice",p),4);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);
...
n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReplaceDetail_CoTaxAmt')-sm('tblSalesReplaceDet_CoTaxAmt'),2);
r(1,"DisAmount")[p].value=f(rn(1,"Amount",p)-rn(1,"DisBackAmt",p),2);
r(1,"CurPrice")[p].value=f((((nn('Tax',0)/100)+1)*rn(1,"DisPrice",p))/nn('CurrencyRate',0),4);
r(1,"CurAmount")[p].value=f((((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100)/nn('CurrencyRate',0),2);
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 var z=r(1,'DisBackAmt');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_DisBackAmt'); 
 r(1,"DisPrice")[p].value=f(rn(1,"DisBackAmt",p)/rn(1,"Qty",p),4);
r(1,"Discount")[p].value=f(rn(1,"DisPrice",p)/rn(1,"Price",p)*100,4);
r(1,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"DisPrice",p),4);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"DisBackAmt",p),2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);
r(1,"CoTaxAmt")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"DisBackAmt",p)-rn(1,"DisBackAmt",p),2);
n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReplaceDetail_CoTaxAmt')-sm('tblSalesReplaceDet_CoTaxAmt'),2);
r(1,"DisAmount")[p].value=f(rn(1,"Amount",p)-rn(1,"DisBackAmt",p),2);
r(1,"CurAmount")[p].value=f((((nn('Tax',0)/100)+1)*rn(1,"DisBackAmt",p))/nn('CurrencyRate',0),2);
r(1,"CurPrice")[p].value=f((((nn('Tax',0)/100)+1)*rn(1,"DisPrice",p))/nn('CurrencyRate',0),4);
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_TaxPrice'); 
 r(1,"DisPrice")[p].value=f(rn(1,"TaxPrice",p)/((nn('Tax',0)/100)+1),4);
r(1,"Price")[p].value=f((rn(1,"TaxPrice",p)/((nn('Tax',0)/100)+1)*100)/rn(1,"Discount",p),4);
r(1,"CurPrice")[p].value=f(rn(1,"TaxPrice",p)/nn('CurrencyRate',0),4);
r(1,"Amount")[p].value=f(rn(1,"Price",p)*rn(1,"Qty",p),2);
r(1,"DisBackAmt")[p].value=f(rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
r(1,"DisAmount")[p].value=f(rn(1,"Amount",p)-rn(1,"DisBackAmt",p),2);
r(1,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(1,"Amount",p)*rn(1,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_TaxAmount'); 
 r(1,"TaxPrice")[p].value=f(rn(1,"TaxAmount",p)/rn(1,"Qty",p),4);
r(1,"DisPrice")[p].value=f(rn(1,"TaxPrice",p)/((nn('Tax',0)/100)+1),4);
r(1,"Price")[p].value=f((rn(1,"TaxPrice",p)/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p),4);
r(1,"CurPrice")[p].value=f(((rn(1,"TaxPrice",p)/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p))/nn('CurrencyRate',0),4);
r(1,"Amount")[p].value=f((((rn(1,"TaxAmount",p)/rn(1,"Qty",p))/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p))*rn(1,"Qty",p),2);
r(1,"DisBackAmt")[p].value=f(((((rn(1,"TaxAmount",p)/rn(1,"Qty",p))/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p))*rn(1,"Qty",p))*rn(1,"Discount",p)/100,2);
r(1,"DisAmount")[p].value=f(((((rn(1,"TaxAmount",p)/rn(1,"Qty",p))/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p))*rn(1,"Qty",p))-(((((rn(1,"TaxAmount",p)/rn(1,"Qty",p))/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p))*rn(1,"Qty",p))*rn(1,"Discount",p)/100),2);
n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
r(1,"CoTaxAmt")[p].value=f(rn(1,"TaxAmount",p)-(((((rn(1,"TaxAmount",p)/rn(1,"Qty",p))/((nn('Tax',0)/100)+1))*100/rn(1,"Discount",p))*rn(1,"Qty",p))*rn(1,"Discount",p)/100),2);
n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReplaceDetail_CoTaxAmt')-sm('tblSalesReplaceDet_CoTaxAmt'),2);
r(1,"CurAmount")[p].value=f(rn(1,"TaxAmount",p)/nn('CurrencyRate',0),2);
n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_CurPrice'); 
 r(1,"TaxPrice")[p].value=f(rn(1,"CurPrice",p)*nn('CurrencyRate',0),4);

r(1,"DisPrice")[p].value=f(rn(1,"CurPrice",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),4);

r(1,"Price")[p].value=f(rn(1,"CurPrice",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(1,"Discount",p)/100),4);
r(1,"CurAmount")[p].value=f(rn(1,"CurPrice",p)*rn(1,"Qty",p),2);

r(1,"TaxAmount")[p].value=f(rn(1,"CurPrice",p)*rn(1,"Qty",p)*nn('CurrencyRate',0),2);
r(1,"DisBackAmt")[p].value=f(rn(1,"CurPrice",p)*rn(1,"Qty",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),2);
r(1,"Amount")[p].value=f(rn(1,"CurPrice",p)*rn(1,"Qty",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(1,"Discount",p)/100) ,2);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_CurAmount'); 
 r(1,"TaxAmount")[p].value=f(rn(1,"CurAmount",p)*nn('CurrencyRate',0),2);

r(1,"DisBackAmt")[p].value=f(rn(1,"CurAmount",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),2);

r(1,"Amount")[p].value=f(rn(1,"CurAmount",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(1,"Discount",p)/100),2);

r(1,"CurPrice")[p].value=f(rn(1,"CurAmount",p)/rn(1,"Qty",p),4);

r(1,"TaxPrice")[p].value=f((rn(1,"CurAmount",p)/rn(1,"Qty",p))*nn('CurrencyRate',0),4);

r(1,"DisPrice")[p].value=f((rn(1,"CurAmount",p)/rn(1,"Qty",p))*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),4);

r(1,"Price")[p].value=f((rn(1,"CurAmount",p)/rn(1,"Qty",p))*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(1,"Discount",p)/100),4);
...
n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 var z=r(1,'PresentSampleType');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_PresentSampleType'); 
 r(1,"Price")[p].value=f(0,4);
 r(1,"Amount")[p].value=f(0,2);
 r(1,"DisPrice")[p].value=f(0,4);
 r(1,"TaxPrice")[p].value=f(0,4);
 r(1,"CurPrice")[p].value=f(0,4);
 r(1,"DisBackAmt")[p].value=f(0,2);
 r(1,"TaxAmount")[p].value=f(0,2);
 n('TotalAmount')[0].value=f(sm('tblSalesReplaceDetail_DisBackAmt')-sm('tblSalesReplaceDet_DisBackAmt')-nn('DiscountAmount',0),2);
n('TotalTaxAmount')[0].value=f(sm('tblSalesReplaceDetail_TaxAmount')-sm('tblSalesReplaceDet_TaxAmount')-nn('DiscountAmount',0),2);
 r(1,"CoTaxAmt")[p].value=f(0,2);
 r(1,"CurAmount")[p].value=f(0,2);
 r(1,"DisAmount")[p].value=f(0,2);
 n('CurTotalAmount')[0].value=f(sm('tblSalesReplaceDetail_CurAmount')-sm('tblSalesReplaceDet_CurAmount')-nn('CurDiscountAmount',0),2);
 n('TotalCoTaxAmt')[0].value=f(sm('tblSalesReplaceDetail_CoTaxAmt')-sm('tblSalesReplaceDet_CoTaxAmt'),2);
 n('DisAmount')[0].value=f(sm('tblSalesReplaceDetail_DisAmount')-sm('tblSalesReplaceDet_DisAmount'),2);
 ...
 var z=r(1,'CostAmount');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_CostAmount'); 
 r(1,"CostPrice")[p].value=f(rn(1,"CostAmount",p)/rn(1,"Qty",p),4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_CostPrice'); 
 r(1,"CostAmount")[p].value=f(rn(1,"CostPrice",p)*rn(1,"Qty",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesReplaceDetail_SecQty'); 
...
childData[childCount]='tblSalesReplaceDet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='销售换货单退货明细';
childCount++;
 var tblSalesReplaceDetData = new gridData();
 gridDatas[gridDataNum] = tblSalesReplaceDetData;
 gridDataNum++;
 var tblSalesReplaceDet=1;
 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_StockCode','仓库','80',2,true,'',100,-2,'','',"","copy","0",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_StockCode","仓库","any","",true,minValue,100,true,''); 
 ...
 var param4="";
 param4=param4+":1出库仓库@StockCode"; 
 param4=param4+":0仓库@tblSalesReplaceDet_StockCode";
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_GoodsCode','入库商品','120',2,false,'',100,-2,'','',"","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblSalesReplaceDet_GoodsCode","入库商品","any","",false,minValue,100,false,'');
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblSalesReplaceDet:GoodsCode:tblSalesReplaceDet_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_tblGoods_GoodsFullName','入库商品','150',18,true,'',1000000,2,'tblSalesReplaceDet:GoodsCode:tblSalesReplaceDet_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_tblGoods_GoodsSpec','商品规格','200',2,true,'',1000000,2,'tblSalesReplaceDet:GoodsCode:tblSalesReplaceDet_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblSalesReplaceDet:GoodsCode:tblSalesReplaceDet_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","9",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","12",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","15",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","18",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDet_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","21",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","24",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","25",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDet_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_color','色彩','60',2,true,'',100,-2,'','',"","","30",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_color","色彩","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Qty','数量','60',1,false,'',0,0,'','',"Qty","","50",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Qty","数量","double","SeqQty",false,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Price','单价','80',1,true,'',0,0,'','',"SPriceIdentifier","","51",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Price","单价","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Amount','金额','100',1,true,'',0,0,'','',"SAmountIdentifier","","52",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Discount','折扣率%','100',1,true,'100',0,-2,'','',"Price","","58",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Discount","折扣率%","double","BillDiscount",true,minValue,maxValue,true,'100'); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_DisPrice','折后单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","59",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_DisPrice","折后单价","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_DisBackAmt','折后金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","60",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_DisBackAmt","折后金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_DisAmount','折让金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","61",'',"8",false); 
 putChildValidateItem("tblSalesReplaceDet_DisAmount","折让金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_TaxPrice','含税单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","62",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_TaxPrice","含税单价","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_TaxAmount','含税金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","63",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_TaxAmount","含税金额","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_CoTaxAmt','税额','100',1,true,'0',0,-2,'','',"SAmountIdentifier","","64",'',"8",false); 
 putChildValidateItem("tblSalesReplaceDet_CoTaxAmt","税额","double","BillTax",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_CurPrice','外币单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","65",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_CurPrice","外币单价","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_CurAmount','外币金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","66",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_CurAmount","外币金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_CostPrice','成本单价','80',1,true,'0',0,0,'','',"priceIdentifier","","89",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_CostPrice","成本单价","double","",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_CostAmount','成本总额','100',1,true,'0',0,0,'','',"AmountIdentifier","","92",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_CostAmount","成本总额","double","",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_IsAssist','打印辅助数据','80',2,true,'',100,-2,'','',"","","95",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_IsAssist","打印辅助数据","any","",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_PresentSampleType','赠(样)品','60',2,true,'',20,-2,'','',"","","98",'',"1",false); 
 putChildValidateItem("tblSalesReplaceDet_PresentSampleType","赠(样)品","any","BillPresentSampleType",true,minValue,20,false,''); 
 ...
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_SourceID','源ID','200',2,true,'',60,-2,'','',"","","117",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_SourceID","源ID","any","",true,minValue,60,false,''); 
 ...
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","-112",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_NotPayQty','未付款数量','224',1,true,'',0,-2,'','',"","","-109",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_NotPayQty","未付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_PayQty','付款数量','224',1,true,'',0,-2,'','',"","","-106",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_PayQty","付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","-103",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_Remark','备注','100',2,true,'',8000,0,'','',"","","-1",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(tblSalesReplaceDetData,'tblSalesReplaceDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='tblSalesReplaceDetail';
tabIsNulls[childCount]='1';
tabDiss[childCount]='销售换货单出库明细';
childCount++;
 var tblSalesReplaceDetailData = new gridData();
 gridDatas[gridDataNum] = tblSalesReplaceDetailData;
 gridDataNum++;
 var tblSalesReplaceDetail=1;
 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","0",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDetail_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_StockCode','仓库','80',2,true,'',100,-2,'','',"","copy","0",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_StockCode","仓库","any","",true,minValue,100,true,''); 
 ...
 var param4="";
 param4=param4+":1出库仓库@StockCode"; 
 param4=param4+":0仓库@tblSalesReplaceDetail_StockCode";
 param4=param4+":0批号@tblSalesReplaceDetail_BatchNo";
 param4=param4+":0厚度@tblSalesReplaceDetail_Inch";
 param4=param4+":0颜色@tblSalesReplaceDetail_Hue";
 param4=param4+":0尺码@tblSalesReplaceDetail_yearNO";
 param4=param4+":0生产日期@tblSalesReplaceDetail_ProDate";
 param4=param4+":0保质期限@tblSalesReplaceDetail_Availably";
 param4=param4+":1客户@CompanyCode"; 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_GoodsCode','出库商品','100',2,false,'',100,-2,'','',"","triggerOrCopy","3",'',"2",true);
 putChildValidateItem("tblSalesReplaceDetail_GoodsCode","出库商品","any","",false,minValue,100,false,'');
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblSalesReplaceDetail:GoodsCode:tblSalesReplaceDetail_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_tblGoods_GoodsFullName','出库商品','150',18,true,'',1000000,2,'tblSalesReplaceDetail:GoodsCode:tblSalesReplaceDetail_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_tblGoods_GoodsSpec','商品规格','200',2,true,'',1000000,2,'tblSalesReplaceDetail:GoodsCode:tblSalesReplaceDetail_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblSalesReplaceDetail:GoodsCode:tblSalesReplaceDetail_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_tblStocks_lastQty','实际库存','90',1,true,'',1000000,2,'tblSalesReplaceDetail:GoodsCode:tblSalesReplaceDetail_tblStocks_lastQty:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_ViewVirtualStock_UseQty','虚拟库存','90',1,true,'',1000000,2,'tblSalesReplaceDetail:GoodsCode:tblSalesReplaceDetail_ViewVirtualStock_UseQty:'+param4,'',"","triggerOrCopy","3",'',"2",false); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","9",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDetail_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","12",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDetail_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_color','色彩','60',2,true,'',100,-2,'','',"","","15",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_color","色彩","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","18",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDetail_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_yearNO','尺码','70',2,true,'',100,-2,'','',"","triggerCopy","21",'',"2",false); 
 putChildValidateItem("tblSalesReplaceDetail_yearNO","尺码","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_ProDate','生产日期','80',2,true,'',10,-2,'','',"","","24",'',"8",false); 
 putChildValidateItem("tblSalesReplaceDetail_ProDate","生产日期","any","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Availably','保质期限','80',2,true,'',10,-2,'','',"","","27",'',"8",false); 
 putChildValidateItem("tblSalesReplaceDetail_Availably","保质期限","any","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Qty','数量','60',1,false,'',0,0,'','',"Qty","","50",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_Qty","数量","double","SeqQty",false,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Price','单价','80',1,true,'',0,0,'','',"SPriceIdentifier","","51",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_Price","单价","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Amount','金额','100',1,true,'',0,0,'','',"SAmountIdentifier","","52",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Discount','折扣率%','100',1,true,'100',0,-2,'','',"Price","","58",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_Discount","折扣率%","double","BillDiscount",true,minValue,maxValue,true,'100'); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_DisPrice','折后单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","59",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_DisPrice","折后单价","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_DisBackAmt','折后金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","60",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_DisBackAmt","折后金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_DisAmount','折让金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","61",'',"8",false); 
 putChildValidateItem("tblSalesReplaceDetail_DisAmount","折让金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_TaxPrice','含税单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","62",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_TaxPrice","含税单价","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_TaxAmount','含税金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","63",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_TaxAmount","含税金额","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_CoTaxAmt','税额','100',1,true,'0',0,-2,'','',"SAmountIdentifier","","64",'',"8",false); 
 putChildValidateItem("tblSalesReplaceDetail_CoTaxAmt","税额","double","BillTax",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_CurPrice','外币单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","65",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_CurPrice","外币单价","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_CurAmount','外币金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","66",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_CurAmount","外币金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_PresentSampleType','赠(样)品','80',2,true,'',10,-2,'','',"","","102",'',"1",false); 
 putChildValidateItem("tblSalesReplaceDetail_PresentSampleType","赠(样)品","any","BillPresentSampleType",true,minValue,10,false,''); 
 ...
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_CostAmount','成本总额','60',1,true,'0',0,-2,'','',"AmountIdentifier","","-127",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_CostAmount","成本总额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_CostPrice','成本单价','60',1,true,'0',0,-2,'','',"priceIdentifier","","-124",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_CostPrice","成本单价","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","-115",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_PayQty','付款数量','224',1,true,'',10,-2,'','',"","","-112",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_PayQty","付款数量","double","",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_NotPayQty','未付款数量','224',1,true,'',10,-2,'','',"","","-109",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_NotPayQty","未付款数量","double","",true,minValue,10,false,''); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","-106",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_SourceID','源ID','0',2,true,'',60,-2,'','',"","","-103",'',"3",false); 
 putChildValidateItem("tblSalesReplaceDetail_SourceID","源ID","any","",true,minValue,60,false,''); 
 
 
 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_Remark','备注','100',2,true,'',8000,0,'','',"","","-1",'',"0",false); 
 putChildValidateItem("tblSalesReplaceDetail_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(tblSalesReplaceDetailData,'tblSalesReplaceDetail_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblSalesReplace&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblSalesReplace,tblSalesReplaceDet,tblSalesReplaceDetail,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblSalesReplace&allTableName=tblSalesReplace,tblSalesReplaceDet,tblSalesReplaceDetail,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblSalesReplace&allTableName=tblSalesReplaceDet,tblSalesReplaceDetail,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblSalesReplace&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblSalesReplace&allTableName=tblSalesReplaceDet,tblSalesReplaceDetail,&colType=colWidth" ;
...
function seqInput(){
 ...
 var cTabName = "tblSalesReplaceDet";
 var stockCode="";
 ...
 var urls="/UtilServlet?operation=validateBPSeq&MOID="+MOID+"&MOOP=add&StockCode="+stockCode+"&Seq="+obj.value+"&popupBean="+popBeanName;
 AjaxRequest(urls) ;
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblSalesReplace&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblSalesReplace&designId=&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblSalesReplace&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblSalesReplace&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi+"&moduleType="+moduleType,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblSalesReplace&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '销售换货';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblSalesReplace&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
