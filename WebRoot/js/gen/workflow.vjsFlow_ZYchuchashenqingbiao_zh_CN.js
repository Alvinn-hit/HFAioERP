...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_ZYchuchashenqingbiao','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_ZYchuchashenqingbiao','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function checkTable(allHidFields){
 ...
 var labelText=$("#field_2",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_2")>-1)){ 
 alert("姓名"+"不能为空，请重新输入!");
 $("#field_2",document).focus();
 return false;
 }
 
 var labelText=$("#field_3",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_3")>-1)){ 
 alert("开始日期"+"不能为空，请重新输入!");
 $("#field_3",document).focus();
 return false;
 }
 
 var labelText=$("#field_4",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_4")>-1)){ 
 alert("结束日期"+"不能为空，请重新输入!");
 $("#field_4",document).focus();
 return false;
 }
 ...
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_6")>-1)){ 
 alert("目的地"+"不能为空，请重新输入!");
 $("#field_6",document).focus();
 return false;
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("销差记录"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("销差记录"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText=$("#field_8",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_8")>-1)){ 
 alert("出差事由"+"不能为空，请重新输入!");
 $("#field_8",document).focus();
 return false;
 }
...
function countVal(Id){ 
 ...
 var result;
 if("field_5"==Id){
 var docText="day({field_3}-{field_4})";
 var re=/{.[^{}]*}/g; 
