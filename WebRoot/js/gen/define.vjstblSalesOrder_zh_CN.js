...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblSalesOrderDetTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblSalesOrderDet_BatchNo');
 ...
 var z=n('tblSalesOrderDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 ...
 copyFields[index].value = copyFields[index-1].value;
   ...
   copyFields=n('tblSalesOrderDet_NotPayQty');
 if((order > 41 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 }
   }
 }
...
if(trigType=="dbClick" && index>0){
 ...
 copyFields[index].value = copyFields[index-1].value;
   ...
   copyFields=n('tblSalesOrderDet_NotPayQty'); 
 if( (order > 41 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 }
   }
 }
...
function execStat2(){
 execStatOne('tblSalesOrderDet_Qty',4);
 execStatOne('tblSalesOrderDet_Price',6);
 execStatOne('tblSalesOrderDet_Amount',2);
 execStatOne('tblSalesOrderDet_TaxAmount',2);
 execStatOne('tblSalesOrderDet_weight',4);
 execStatOne('tblSalesOrderDet_CurAmount',2);
 setTotalCount(getTotalCount());
}
...
function delFireEvent(rowId,tableName)
{
 ...
 delFireEventOne(rowId,tableName,'tblSalesOrderDet_pjPrice',"tblSalesOrderDet"); 
 delFireEventOne(rowId,tableName,'tblSalesOrderDet_packGrossWeight',"tblSalesOrderDet"); 
 delFireEventOne(rowId,tableName,'tblSalesOrderDet_weight',"tblSalesOrderDet"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'Tax',dis:'税率%',digit:6,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'CurrencyRate',dis:'汇率',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'TotalAmount',dis:'本币未税总额',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'TotalTaxAmount',dis:'本币含税总额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'TotalCoTaxAmt',dis:'实际总税额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'CurTotalAmount',dis:'原币总额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'weight',dis:'总重',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'FreightAmt',dis:'总运费',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'gsFreightAmt',dis:'公司承担运费',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'khFreightAmt',dis:'客户承担运费',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_Qty',dis:'数量',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_Price',dis:'本币未税单价',digit:6,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_Amount',dis:'本币未税金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_pjPrice',dis:'配件价格',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_pjAmount',dis:'配件金额',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_packGrossWeight',dis:'外包装毛重',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_TaxPrice',dis:'本币含税单价',digit:6,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_TaxAmount',dis:'本币含税金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_weight',dis:'重量',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_CurPrice',dis:'原币单价',digit:6,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblSalesOrderDet_CurAmount',dis:'原币金额',digit:2,isMain:false};
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_isnull(tblSetExchange_RecordExchange,1)");
 if(obj != null){
 obj.value = "";
 }
 ...
 var saveField=n("ShippingAddress"); 
 saveField[0].value = "";
 var obj = m("tbl_tblCompany_ShippingAddress");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("ZdAddress"); 
 saveField[0].value = "";
 var obj = m("tbl_tblCompany_ZdAddress");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("payType"); 
 saveField[0].value = "";
 var obj = m("tbl_tblCompany_payType");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("District"); 
 saveField[0].value = "";
 var obj = m("tbl_tblDistrict_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblDistrict_District"); 
 saveField[0].value = "";
 var obj = m("tbl_tblDistrict_District");
 if(obj != null){
 obj.value = "";
 }
 ...
 var saveField=n("ActiveId"); 
 saveField[0].value = "";
 var obj = m("tbl_HFComboRecord_ActiveId");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("ComboId"); 
 saveField[0].value = "";
 var obj = m("tbl_HFComboRecordDet1_ComboId");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblCombo_Combo");
 saveField[0].value = ""; 
 m("tbl_tblCombo_Combo").value = "" ;
 }
 if(fieldName == "GiftId"){
 var saveField=n("GiftId"); 
 saveField[0].value = "";
 var obj = m("tbl_tblGift_id");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGift_Gift");
 saveField[0].value = ""; 
 m("tbl_tblGift_Gift").value = "" ;
 }
 if(fieldName == "PartsId"){
 var saveField=n("PartsId"); 
 saveField[0].value = "";
 var obj = m("tbl_PDParts_id");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("PDParts_Parts");
 saveField[0].value = ""; 
 m("tbl_PDParts_Parts").value = "" ;
 }
 ...
 var saveField=n("tblDistrict_District");
 saveField[0].value = ""; 
 m("tbl_tblDistrict_District").value = "" ;
 }
   }
...
r(0,"Amount")[j].value=f(rn(0,"Price",j)*rn(0,"Qty",j),2);
}
...
n('TotalAmount')[0].value=f(sm('tblSalesOrderDet_DisBackAmt')+nn('khFreightAmt',0),2);

n('TotalTaxAmount')[0].value=f(sm('tblSalesOrderDet_TaxAmount')-nn('DiscountAmount',0)+nn('khFreightAmt',0),2);

for(var j=0;j<r(0,'CoTaxAmt').length;j++){
r(0,"CoTaxAmt")[j].value=f(rn(0,"TaxAmount",j)-rn(0,"DisBackAmt",j),2);
}

n('TotalCoTaxAmt')[0].value=f(nn('TotalTaxAmount',0)/1.17*0.17,2);
...
r(0,"DisAmount")[j].value=f(rn(0,"Amount",j)-rn(0,"DisBackAmt",j),6);
}

n('DisAmount')[0].value=f(sm('tblSalesOrderDet_DisAmount'),2);

for(var j=0;j<r(0,'pjAmount').length;j++){
r(0,"pjAmount")[j].value=f(rn(0,"Qty",j)*rn(0,"pjPrice",j),2);
}

for(var j=0;j<r(0,'weight').length;j++){
r(0,"weight")[j].value=f(rn(0,"Qty",j)*rn(0,"packGrossWeight",j),4);
}

n('weight')[0].value=f(sm('tblSalesOrderDet_weight'),2);
...
n('TotalTaxAmount')[0].value=f(sm('tblSalesOrderDet_TaxAmount')-nn('DiscountAmount',0)+nn('khFreightAmt',0),2);
n('CurTotalAmount')[0].value=f(nn('TotalTaxAmount',0)/nn('CurrencyRate',0),2);
r(0,"DisAmount")[p].value=f(rn(0,"Amount",p)-rn(0,"DisBackAmt",p),6);
n('DisAmount')[0].value=f(sm('tblSalesOrderDet_DisAmount'),2);
r(0,"CoTaxAmt")[p].value=f(rn(0,"TaxAmount",p)-rn(0,"DisBackAmt",p),2);
n('TotalCoTaxAmt')[0].value=f(nn('TotalTaxAmount',0)/1.17*0.17,2);
r(0,"CostAmount")[p].value=f(rn(0,"CostPrice",p)*rn(0,"Qty",p),2);
r(0,"pjAmount")[p].value=f(rn(0,"Qty",p)*rn(0,"pjPrice",p),2);
r(0,"weight")[p].value=f(rn(0,"Qty",p)*rn(0,"packGrossWeight",p),4);
n('weight')[0].value=f(sm('tblSalesOrderDet_weight'),2);
...
n('weight')[0].value=f(sm('tblSalesOrderDet_weight'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesOrderDet_pjPrice'); 
 r(0,"pjAmount")[p].value=f(rn(0,"Qty",p)*rn(0,"pjPrice",p),2);

 execStat(); 
 }
 }
 var z=r(0,'packGrossWeight');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesOrderDet_packGrossWeight'); 
 r(0,"weight")[p].value=f(rn(0,"Qty",p)*rn(0,"packGrossWeight",p),4);
n('weight')[0].value=f(sm('tblSalesOrderDet_weight'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblSalesOrderDet_weight'); 
 n('weight')[0].value=f(sm('tblSalesOrderDet_weight'),2);
 ...
 r(0,"CostPrice")[p].value=f(rn(0,"CostAmount",p)/rn(0,"Qty",p),6);
...
childCount++;
 ...
 addCols(tblSalesOrderDetData,'tblSalesOrderDet_tblGoods_GoodsNumber','料件编号','150',2,true,'',1000000,2,'tblSalesOrderDet:GoodsCode:tblSalesOrderDet_tblGoods_GoodsNumber:'+param4,"","","","2","","2",false);
 ...
 addCols(tblSalesOrderDetData,'tblSalesOrderDet_tblGoods_GoodsFullName','料件名称','150',2,true,'',1000000,2,'tblSalesOrderDet:GoodsCode:tblSalesOrderDet_tblGoods_GoodsFullName:'+param4,"","","","2","","2",false);
 ...
 addCols(tblSalesOrderDetData,'tblSalesOrderDet_tblGoods_GoodsSpec','规格','150',20,true,'',1000000,2,'tblSalesOrderDet:GoodsCode:tblSalesOrderDet_tblGoods_GoodsSpec:'+param4,"","","","2","","2",false);
 ...
 addCols(tblSalesOrderDetData,'tblSalesOrderDet_tblGoods_BaseUnit','单位','35',2,true,'',1000000,2,'tblSalesOrderDet:GoodsCode:tblSalesOrderDet_tblGoods_BaseUnit:'+param4,"","","","2","","2",false);
 ...
 var param4=""; 
         ...
         var param4="";
 addCols(tblSalesOrderDetData,'tblSalesOrderDet_FeeType','费用类别','80',2,true,'',100,2,'tblSalesOrderDet:FeeType:tblSalesOrderDet_FeeType:'+param4,"","","","3",'',"2",true);
 putChildValidateItem("tblSalesOrderDet_FeeType","费用类别","any","",true,minValue,100,false,'',true);
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_Qty','数量','60',1,false,'',0,0,'','',"Qty","","10",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_Qty","数量","double","",false,minValue,maxValue,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_TaxPrice','本币含税单价','100',1,true,'',0,8,'','',"SPriceIdentifier","","33",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_TaxPrice","本币含税单价","double","",true,minValue,maxValue,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_TaxAmount','本币含税金额','100',1,true,'',0,8,'','',"SAmountIdentifier","","34",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_TaxAmount","本币含税金额","double","",true,minValue,maxValue,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_pjPrice','配件价格','80',1,true,'',0,8,'','',"","","29",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_pjPrice","配件价格","double","",true,minValue,maxValue,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_pjAmount','配件金额','80',1,true,'',0,8,'','',"","","30",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_pjAmount","配件金额","double","",true,minValue,maxValue,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_packGrossWeight','外包装毛重','80',1,true,'',0,8,'','',"Qty","","32",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_packGrossWeight","外包装毛重","double","",true,minValue,maxValue,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_weight','重量','80',1,true,'0',0,8,'','',"Qty","","35",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_weight","重量","double","",true,minValue,maxValue,true,'0',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_ReplyDate','期望交期','70',5,true,'',10,0,'','',"","","15",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_ReplyDate","期望交期","date","",true,minValue,10,false,'',true); 
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_Remark','备注','100',2,true,'',8000,0,'','',"SPriceIdentifier","","67",'',"0",false); 
 ...
 var param4=""; 
         ...
         addCols(tblSalesOrderDetData,'tblSalesOrderDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","5",'',"0",false); 
 ...
 var param4=""; 
    ...
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_StockCode','仓库','80',2,true,'Sess_StockCode',100,-2,'','','',"copy",'','',"2",false); 
 putChildValidateItem("tblSalesOrderDet_StockCode","仓库","any","",true,minValue,100,true,'Sess_StockCode'); 
     addCols(tblSalesOrderDetData,'tblSalesOrderDet_PriceTraceID','报价单号','50',2,true,'',50,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_PriceTraceID","报价单号","any","",true,minValue,50,false,''); 
 var param4="";
 addCols(tblSalesOrderDetData,'tblSalesOrderDet_GoodsCode','料件编号','120',2,false,'',200,-2,'','','',"",'','',"2",false);
 putChildValidateItem("tblSalesOrderDet_GoodsCode","料件编号","any","",false,minValue,200,false,'',true);
                     addCols(tblSalesOrderDetData,'tblSalesOrderDet_BatchNo','批号','120',2,true,'',100,-2,'','','',"triggerCopy",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_BatchNo","批号","any","",true,minValue,100,false,''); 
        addCols(tblSalesOrderDetData,'tblSalesOrderDet_Hue','颜色','70',2,true,'',100,-2,'','','',"triggerCopy",'','',"2",false); 
 putChildValidateItem("tblSalesOrderDet_Hue","颜色","any","",true,minValue,100,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_yearNO','箱号','100',2,true,'',100,-2,'','','',"triggerCopy",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_yearNO","箱号","any","",true,minValue,100,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_ProDate','生产日期','80',5,true,'',10,-2,'','','',"",'','',"2",false); 
 putChildValidateItem("tblSalesOrderDet_ProDate","生产日期","date","",true,minValue,10,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_Availably','保质期限','80',5,true,'',10,-2,'','','',"",'','',"2",false); 
 putChildValidateItem("tblSalesOrderDet_Availably","保质期限","date","",true,minValue,10,false,''); 
        addCols(tblSalesOrderDetData,'tblSalesOrderDet_Price','本币未税单价','80',1,true,'',0,-2,'','',"Price","","11",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_Price","本币未税单价","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_OutGoodsCode','客户料号','100',2,true,'',100,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_OutGoodsCode","客户料号","any","",true,minValue,100,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_Amount','本币未税金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","13",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_Amount","本币未税金额","double","",true,minValue,maxValue,false,''); 
        addCols(tblSalesOrderDetData,'tblSalesOrderDet_Trading','交易地区','80',2,true,'',100,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_Trading","交易地区","any","",true,minValue,100,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_Customer','终端客户信息','100',2,true,'',500,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_Customer","终端客户信息","any","",true,minValue,500,false,''); 
     addCols(tblSalesOrderDetData,'tblSalesOrderDet_SalesGoodsType','费用类型','80',0,true,'0',0,-2,'','',"SPriceIdentifier","","21",'',"1",false); 
 putChildValidateItem("tblSalesOrderDet_SalesGoodsType","费用类型","int","",true,minValue,maxValue,true,'0'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_InvoiceStatus','开票状态','200',2,true,'0',10,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_InvoiceStatus","开票状态","any","",true,minValue,10,true,'0'); 
     addCols(tblSalesOrderDetData,'tblSalesOrderDet_Discount','折扣率%','100',1,true,'100',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_Discount","折扣率%","double","",true,minValue,maxValue,true,'100'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_DisPrice','折后单价','100',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_DisPrice","折后单价","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_DisBackAmt','折后金额','100',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_DisBackAmt","折后金额","double","",true,minValue,maxValue,false,''); 
           addCols(tblSalesOrderDetData,'tblSalesOrderDet_DisAmount','折让金额','100',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_DisAmount","折让金额","double","",true,minValue,maxValue,false,''); 
                  addCols(tblSalesOrderDetData,'tblSalesOrderDet_CoTaxAmt','税额','100',1,true,'0',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_CoTaxAmt","税额","double","",true,minValue,maxValue,true,'0'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_CurPrice','原币单价','100',1,true,'',0,-2,'','',"SPriceIdentifier","","37",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_CurPrice","原币单价","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_CurAmount','原币金额','100',1,true,'',0,-2,'','',"SAmountIdentifier","","38",'',"0",false); 
 putChildValidateItem("tblSalesOrderDet_CurAmount","原币金额","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_ViewTotalQty','当前库存','80',1,true,'',0,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_ViewTotalQty","当前库存","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_SendDate','最新交期回复','80',5,true,'',10,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_SendDate","最新交期回复","date","",true,minValue,10,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_NotPayQty','未收款数量','224',1,true,'',0,-2,'','','',"copy",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_NotPayQty","未收款数量","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_OutPayQty','已出库付款数','224',1,true,'',0,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_OutPayQty","已出库付款数","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_OutQty','已出数量','80',1,true,'',0,-2,'','','',"",'','',"100",false); 
 putChildValidateItem("tblSalesOrderDet_OutQty","已出数量","double","",true,minValue,maxValue,false,''); 
     addCols(tblSalesOrderDetData,'tblSalesOrderDet_NotOutQty','未出数量','80',1,true,'',0,-2,'','','',"",'','',"100",false); 
 putChildValidateItem("tblSalesOrderDet_NotOutQty","未出数量","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_EmployeeID','经手人','0',2,true,'Sess_UserId',100,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_EmployeeID","经手人","any","",true,minValue,100,true,'Sess_UserId'); 
     addCols(tblSalesOrderDetData,'tblSalesOrderDet_CostAmount','成本总额','60',1,true,'0',0,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_CostAmount","成本总额","double","",true,minValue,maxValue,true,'0'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_CostPrice','成本单价','60',1,true,'0',0,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_CostPrice","成本单价","double","",true,minValue,maxValue,true,'0'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_DepartmentCode','部门','0',2,true,'Sess_DepartmentCode',100,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_DepartmentCode","部门","any","",true,minValue,100,true,'Sess_DepartmentCode'); 
     addCols(tblSalesOrderDetData,'tblSalesOrderDet_UnitOutQty','辅助单位出库数量','200',1,true,'',0,-2,'','','',"",'','',"1",false); 
 putChildValidateItem("tblSalesOrderDet_UnitOutQty","辅助单位出库数量","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_PresentSampleType','类型','80',2,true,'0',10,-2,'','',"","","62",'',"1",false); 
 putChildValidateItem("tblSalesOrderDet_PresentSampleType","类型","any","",true,minValue,10,true,'0'); 
        addCols(tblSalesOrderDetData,'tblSalesOrderDet_BuyAppQty','采购申请数','80',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_BuyAppQty","采购申请数","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_NoBuyAppQty','未采购申请数','80',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_NoBuyAppQty","未采购申请数","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_SourceID','SourceID','50',2,true,'',50,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_SourceID","SourceID","any","",true,minValue,50,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_MRPQty','生产规划数','80',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_MRPQty","生产规划数","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_WorkOrderQty','已下工令数','80',1,true,'',0,-2,'','','',"",'','',"4",false); 
 putChildValidateItem("tblSalesOrderDet_WorkOrderQty","已下工令数","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_NoWorkOrderQty','未下工令数','80',1,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_NoWorkOrderQty","未下工令数","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_WorkOrderId','工令单Id','80',2,true,'',50,-2,'','','',"",'','',"3",false); 
 putChildValidateItem("tblSalesOrderDet_WorkOrderId","工令单Id","any","",true,minValue,50,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_StartDate','初次生产日期','80',5,true,'',10,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_StartDate","初次生产日期","date","",true,minValue,10,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_SendDate1','初次交期回复','80',5,true,'',0,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_SendDate1","初次交期回复","date","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_FixID','固定行代号','80',2,true,'',50,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_FixID","固定行代号","any","",true,minValue,50,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_PossesQty','占用库存','200',1,true,'',0,-2,'','','',"",'','',"1",false); 
 putChildValidateItem("tblSalesOrderDet_PossesQty","占用库存","double","",true,minValue,maxValue,false,''); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_IsCombo','套餐赠品','80',0,true,'2',0,-2,'','','',"",'','',"1",false); 
 putChildValidateItem("tblSalesOrderDet_IsCombo","套餐赠品","int","",true,minValue,maxValue,true,'2'); 
    addCols(tblSalesOrderDetData,'tblSalesOrderDet_fxBuyOrderDetID','分销明细ID','200',2,true,'',50,-2,'','','',"",'','',"0",false); 
 putChildValidateItem("tblSalesOrderDet_fxBuyOrderDetID","分销明细ID","any","",true,minValue,50,false,''); 
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblSalesOrder&designId=df66bd5c_1603022314157921421&keyId="+$("#id").val()+
