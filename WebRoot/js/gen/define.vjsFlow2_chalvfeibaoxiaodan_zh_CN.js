...
function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=Flow2_chalvfeibaoxiaodan&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=Flow2_chalvfeibaoxiaodan&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=Flow2_chalvfeibaoxiaodan&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=Flow2_chalvfeibaoxiaodan&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "chalvfeibaoxiaodanDetTable"){
 }
 }
function totalA(obj)
{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="chalvfeibaoxiaodanDet"){
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="chalvfeibaoxiaodanDet"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="chalvfeibaoxiaodanDet"; 
...
function execStat2(){
 execStatOne('chalvfeibaoxiaodanDet_DetDays',2);
 execStatOne('chalvfeibaoxiaodanDet_TravelFee',2);
 execStatOne('chalvfeibaoxiaodanDet_TrafficInCity',2);
 execStatOne('chalvfeibaoxiaodanDet_HotelExp',2);
 execStatOne('chalvfeibaoxiaodanDet_BoardWages',2);
 execStatOne('chalvfeibaoxiaodanDet_Other',2);
 execStatOne('chalvfeibaoxiaodanDet_Subtotal',2);
 setTotalCount(getTotalCount());
}
...
function openSelect(urlstr,obj,field){
 ...
 urlstr += "&src=menu&MOID=da6e3307_1311210936202401975&MOOP=add&popupWin=MainPopup";
...
function openChildSelect(urlstr,obj,field,thisField,current){
 ...
 urlstr=urlstr+'&src=menu&MOID=da6e3307_1311210936202401975&MOOP=add'; 
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" width=\"150\" border=\"0\"></a></div><div><em>"+str+"</em><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"Flow2_chalvfeibaoxiaodan\",\"PIC\");'>删除</a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'chalvfeibaoxiaodanDet_TravelFee',"chalvfeibaoxiaodanDet"); 
 delFireEventOne(rowId,tableName,'chalvfeibaoxiaodanDet_TrafficInCity',"chalvfeibaoxiaodanDet"); 
 delFireEventOne(rowId,tableName,'chalvfeibaoxiaodanDet_HotelExp',"chalvfeibaoxiaodanDet"); 
 delFireEventOne(rowId,tableName,'chalvfeibaoxiaodanDet_BoardWages',"chalvfeibaoxiaodanDet"); 
 delFireEventOne(rowId,tableName,'chalvfeibaoxiaodanDet_Other',"chalvfeibaoxiaodanDet"); 
 delFireEventOne(rowId,tableName,'chalvfeibaoxiaodanDet_Subtotal',"chalvfeibaoxiaodanDet"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'Days',dis:'天数',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'Amount',dis:'合计',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'Loan',dis:'借款金额',digit:2,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_DetDays',dis:'天数',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_TravelFee',dis:'车船费',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_TrafficInCity',dis:'市内交通费',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_HotelExp',dis:'住宿费',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_BoardWages',dis:'伙食费',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_Other',dis:'其他',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'chalvfeibaoxiaodanDet_Subtotal',dis:'小计',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=Flow2_chalvfeibaoxiaodan",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=Flow2_chalvfeibaoxiaodan&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=Flow2_chalvfeibaoxiaodan&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function mainSelect2(urlstr,openUrl,obj,field,isChild)
{
 ...
 MOID:"da6e3307_1311210936202401975",
 MOOP:"add",
...
function showUserGroup(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=da6e3307_1311210936202401975&MOOP=add&LinkType=@URL:&displayName="+displayName,winObj,"dialogWidth=730px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
...
function showEmployee(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=da6e3307_1311210936202401975&MOOP=query&LinkType=@URL:&displayName="+displayName,winObj,"dialogWidth=830px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var employees = str.split("|") ;
 for(var j=0;j<employees.length;j++){
 var field = employees[j].split(";") ;
...
function openCRMSelect(selectName,displayName){
 ...
 var str = window.showModalDialog("/UserFunctionAction.do?selectName="+selectName+"&operation=22&MOID=da6e3307_1311210936202401975&MOOP=add&LinkType=@URL:&displayName="+displayName,"","dialogWidth=730px;dialogHeight=450px"); 
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "Flow2_chalvfeibaoxiaodan"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=Flow2_chalvfeibaoxiaodan&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=Flow2_chalvfeibaoxiaodan&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'chalvfeibaoxiaodanDet_TravelFee'); 
 r(0,"Subtotal")[p].value=f(rn(0,"TravelFee",p)+rn(0,"TrafficInCity",p)+rn(0,"HotelExp",p)+rn(0,"BoardWages",p)+rn(0,"Other",p),2);

 execStat(); 
 }
 }
 var z=r(0,'TrafficInCity');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'chalvfeibaoxiaodanDet_TrafficInCity'); 
 r(0,"Subtotal")[p].value=f(rn(0,"TravelFee",p)+rn(0,"TrafficInCity",p)+rn(0,"HotelExp",p)+rn(0,"BoardWages",p)+rn(0,"Other",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'chalvfeibaoxiaodanDet_HotelExp'); 
 r(0,"Subtotal")[p].value=f(rn(0,"TravelFee",p)+rn(0,"TrafficInCity",p)+rn(0,"HotelExp",p)+rn(0,"BoardWages",p)+rn(0,"Other",p),2);

 execStat(); 
 }
 }
 var z=r(0,'BoardWages');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'chalvfeibaoxiaodanDet_BoardWages'); 
 r(0,"Subtotal")[p].value=f(rn(0,"TravelFee",p)+rn(0,"TrafficInCity",p)+rn(0,"HotelExp",p)+rn(0,"BoardWages",p)+rn(0,"Other",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'chalvfeibaoxiaodanDet_Other'); 
 r(0,"Subtotal")[p].value=f(rn(0,"TravelFee",p)+rn(0,"TrafficInCity",p)+rn(0,"HotelExp",p)+rn(0,"BoardWages",p)+rn(0,"Other",p),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'chalvfeibaoxiaodanDet_Subtotal'); 
 r(0,"Subtotal")[p].value=f(rn(0,"TravelFee",p)+rn(0,"TrafficInCity",p)+rn(0,"HotelExp",p)+rn(0,"BoardWages",p)+rn(0,"Other",p),2);
n('Amount')[0].value=f(sm('chalvfeibaoxiaodanDet_Subtotal'),2);
...
childData[childCount]='chalvfeibaoxiaodanDet';
tabIsNulls[childCount]='0';
tabDiss[childCount]='差旅费报销明细';
childCount++;
 var chalvfeibaoxiaodanDetData = new gridData();
 gridDatas[gridDataNum] = chalvfeibaoxiaodanDetData;
 gridDataNum++;
 var chalvfeibaoxiaodanDet=1;
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_DetSdate','开始日期','80',5,true,'',200,0,'','',"","","0",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_DetSdate","开始日期","date","",true,minValue,200,false,'',true); 
 ...
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_DetEdate','结束日期','80',5,true,'',200,0,'','',"","","1",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_DetEdate","结束日期","date","",true,minValue,200,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_StEnAdrr','起讫地点','150',2,true,'',500,0,'','',"","","2",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_StEnAdrr","起讫地点","any","",true,minValue,500,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_DetDays','天数','60',1,true,'',0,0,'','',"","","3",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_DetDays","天数","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_TravelFee','车船费','100',1,true,'',0,0,'','',"Price","","4",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_TravelFee","车船费","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_TrafficInCity','市内交通费','100',1,true,'',0,0,'','',"Price","","5",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_TrafficInCity","市内交通费","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_HotelExp','住宿费','100',1,true,'',0,0,'','',"Price","","6",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_HotelExp","住宿费","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_BoardWages','伙食费','100',1,true,'',0,0,'','',"Price","","7",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_BoardWages","伙食费","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_Other','其他','100',1,true,'',0,0,'','',"Price","","8",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_Other","其他","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_Subtotal','小计','100',1,true,'',0,0,'','',"Amount","","9",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_Subtotal","小计","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_Remark','备注','350',2,true,'',1000,0,'','',"","","10",'',"0",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_Remark","备注","any","",true,minValue,1000,false,'',true); 
 
 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_AirFee','机票费','200',1,true,'0',0,-2,'','',"","","100",'',"3",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_AirFee","机票费","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_HotelAllowance','住宿节约补助','224',1,true,'',0,-2,'','',"","","100",'',"3",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_HotelAllowance","住宿节约补助","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_TravelAllowance','出差补助','224',1,true,'',0,-2,'','',"","","100",'',"3",false); 
 putChildValidateItem("chalvfeibaoxiaodanDet_TravelAllowance","出差补助","double","",true,minValue,maxValue,false,''); 
 
 
 addCols(chalvfeibaoxiaodanDetData,'chalvfeibaoxiaodanDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=Flow2_chalvfeibaoxiaodan&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "Flow2_chalvfeibaoxiaodan,chalvfeibaoxiaodanDet,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=Flow2_chalvfeibaoxiaodan&allTableName=Flow2_chalvfeibaoxiaodan,chalvfeibaoxiaodanDet,&colType=bill&colSelect="+ strCols;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=Flow2_chalvfeibaoxiaodan&allTableName=chalvfeibaoxiaodanDet,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=Flow2_chalvfeibaoxiaodan&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=Flow2_chalvfeibaoxiaodan&allTableName=chalvfeibaoxiaodanDet,&colType=colWidth" ;
...
function showDept(){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=da6e3307_1311210936202401975&MOOP=add",winObj,"dialogWidth=750px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var depts = str.split("|") ;
...
function showEmployee(fieldName,fieldNameIds){
 ...
 var str = window.showModalDialog(urlstr+"&MOID=da6e3307_1311210936202401975&MOOP=query&LinkType=@URL:",winObj,"dialogWidth=750px;dialogHeight=450px"); 
 if(typeof(str)=="undefined") return ;
 var employees = str.split("|") ;
 for(var j=0;j<employees.length;j++){
 var field = employees[j].split(";") ;
...
function seqInput(){
 ...
 var cTabName = "Flow2_chalvfeibaoxiaodanDet";
 var stockCode="";
 ...
 var urls="/UtilServlet?operation=validateBPSeq&MOID=da6e3307_1311210936202401975&MOOP=add&StockCode="+stockCode+"&Seq="+obj.value+"&popupBean="+popBeanName;
 AjaxRequest(urls) ;
...
function RecAutoSettlement(){
 ...
 var url=url+"&operation=RecAutoSettlement&CompanyCode="+companyCode+"&"+AcceptTypeIDStr+"="+AcceptTypeID+"&BillDate="+BillDate+"&MOID=da6e3307_1311210936202401975&MOOP=add&selectField=&selectValue=";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=Flow2_chalvfeibaoxiaodan&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=Flow2_chalvfeibaoxiaodan&designId=da6e3307_1311210936202401975&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=Flow2_chalvfeibaoxiaodan&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=Flow2_chalvfeibaoxiaodan&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=Flow2_chalvfeibaoxiaodan&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '差旅费报销单';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=Flow2_chalvfeibaoxiaodan&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
