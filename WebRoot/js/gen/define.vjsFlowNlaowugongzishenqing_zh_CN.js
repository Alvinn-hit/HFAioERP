...
function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=FlowNlaowugongzishenqing&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=FlowNlaowugongzishenqing&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=FlowNlaowugongzishenqing&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=FlowNlaowugongzishenqing&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "laowugongzifafangbiaoTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "yonggongjihuabiaoTable"){
 }
 }
function totalA(obj)
{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="laowugongzifafangbiao"){
 
 }
 if(typeof(tableName)!="undefined" && tableName=="yonggongjihuabiao"){
 
 copyFields=n('yonggongjihuabiao_jihuajine');
 if(copyFields[index].value !=0 && copyFields[index].value != ""){return}
 if((order > 5 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="laowugongzifafangbiao"){
 
 }
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="yonggongjihuabiao"){
 
 copyFields=n('yonggongjihuabiao_jihuajine'); 
 if(copyFields[index].value !=0 && copyFields[index].value != ""){return}
 if( (order > 5 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 }
 }
 }
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="laowugongzifafangbiao"; 
 tblName[1]="yonggongjihuabiao"; 
...
function execStat2(){
 execStatOne('laowugongzifafangbiao_shifagongzi',2);
 execStatOne('yonggongjihuabiao_jihuagongshi',2);
 execStatOne('yonggongjihuabiao_jihuajine',2);
 setTotalCount(getTotalCount());
}
...
function openAttachUpload(type,btnId){
 ...
 ' <param name="movie" value="/flash/FileUpload.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#869ca7" /><param name="flashvars" value="maxSize=10000&uploadUrl=/UploadServlet;jsessionid='+aioSessionId+'?path=/temp/@amp;fieldName='+btnId+'@amp;fileType='+type+'&filter='+filter+'&btnId='+btnId+'" />'+
 ...
 ' flashvars="maxSize=10000&uploadUrl=/UploadServlet;jsessionid='+aioSessionId+'?path=/temp/@amp;fieldName='+btnId+'@amp;fileType='+type+'&filter='+filter+'&btnId='+btnId+'" quality="high" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http/'+'/www.adobe.com/go/getflashplayer"></embed></object>';
} 
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"FlowNlaowugongzishenqing\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"FlowNlaowugongzishenqing\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'yonggongjihuabiao_rigongzi',"yonggongjihuabiao"); 
 delFireEventOne(rowId,tableName,'yonggongjihuabiao_jihuagongshi',"yonggongjihuabiao"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'TotalAmount',dis:'单据总额',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'jiahuayonggongzonge',dis:'计划用工总额',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_rigongzi',dis:'日工资',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_gongshi',dis:'工时',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_yingfagongzi',dis:'应发工资',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_koukuan',dis:'扣款',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_jiangli',dis:'奖励',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_jiaban',dis:'加班',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_qita',dis:'其他',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'laowugongzifafangbiao_shifagongzi',dis:'实发工资',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'yonggongjihuabiao_xuhao',dis:'序号',digit:0,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'yonggongjihuabiao_rigongzi',dis:'日工资',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'yonggongjihuabiao_jihuagongshi',dis:'计划工时',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'yonggongjihuabiao_jihuajine',dis:'计划金额',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=FlowNlaowugongzishenqing",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=FlowNlaowugongzishenqing&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=FlowNlaowugongzishenqing&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "FlowNlaowugongzishenqing"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=FlowNlaowugongzishenqing&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=FlowNlaowugongzishenqing&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'yonggongjihuabiao_rigongzi'); 
 r(1,"jihuajine")[p].value=f(" ",2);
r(1,"jihuajine")[p].value=f(Number(rn(1,"jihuagongshi",p))*Number(rn(1,"rigongzi",p)),2);

 execStat(); 
 }
 }
 var z=r(1,'jihuagongshi');
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'yonggongjihuabiao_jihuagongshi'); 
 r(1,"jihuajine")[p].value=f(" ",2);
r(1,"jihuajine")[p].value=f(Number(rn(1,"jihuagongshi",p))*Number(rn(1,"rigongzi",p)),2);
...
childData[childCount]='laowugongzifafangbiao';
tabIsNulls[childCount]='0';
tabDiss[childCount]='劳务工资发放表';
childCount++;
 var laowugongzifafangbiaoData = new gridData();
 gridDatas[gridDataNum] = laowugongzifafangbiaoData;
 gridDataNum++;
 var laowugongzifafangbiao=1;
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_xuhao','序号','50',0,false,'',0,0,'','',"","","0",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_xuhao","序号","int","",false,minValue,maxValue,false,'',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_xingming','姓名','80',2,false,'',100,0,'','',"","","1",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_xingming","姓名","any","",false,minValue,100,false,'',true); 
   addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_gongzhong','工种','80',2,true,'',100,1,';1:综合技工;2:普工;3:焊工;4:钢筋工;5:木工;6:混凝土工','',"","","2",'',"1",false);
 putChildValidateItem("laowugongzifafangbiao_gongzhong","工种","any","",true,minValue,100,false,'',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_rigongzi','日工资','80',1,true,'0',0,0,'','',"","","3",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_rigongzi","日工资","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_gongshi','工时','80',1,true,'0',0,0,'','',"","","4",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_gongshi","工时","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_yingfagongzi','应发工资','80',1,true,'0',0,0,'','',"","","5",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_yingfagongzi","应发工资","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_koukuan','扣款','80',1,true,'0',0,0,'','',"","","6",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_koukuan","扣款","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_jiangli','奖励','80',1,true,'0',0,0,'','',"","","7",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_jiangli","奖励","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_jiaban','加班','80',1,true,'0',0,0,'','',"","","8",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_jiaban","加班","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_qita','其他','80',1,true,'0',0,0,'','',"","","9",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_qita","其他","double","",true,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_shifagongzi','实发工资','80',1,false,'0',0,0,'','',"","","10",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_shifagongzi","实发工资","double","",false,minValue,maxValue,true,'0',true); 
  addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_beizhu','备注','200',2,true,'',100,0,'','',"","","14",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_beizhu","备注","any","",true,minValue,100,false,'',true); 
                              addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_lingkuanren','领款人','80',2,true,'',100,-2,'','',"","","11",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_lingkuanren","领款人","any","",true,minValue,100,false,''); 
   addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_lingkuanshijian','领款时间','100',2,true,'',100,-2,'','',"","","12",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_lingkuanshijian","领款时间","any","",true,minValue,100,false,''); 
   addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_lianxifangshi','联系方式','200',2,true,'',200,-2,'','',"","","13",'',"0",false); 
 putChildValidateItem("laowugongzifafangbiao_lianxifangshi","联系方式","any","",true,minValue,200,false,''); 
   
 addCols(laowugongzifafangbiaoData,'laowugongzifafangbiao_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='yonggongjihuabiao';
tabIsNulls[childCount]='0';
tabDiss[childCount]='用工计划表';
childCount++;
 var yonggongjihuabiaoData = new gridData();
 gridDatas[gridDataNum] = yonggongjihuabiaoData;
 gridDataNum++;
 var yonggongjihuabiao=1;
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_xuhao','序号','60',1,true,'',0,0,'','',"","","0",'',"0",false); 
 putChildValidateItem("yonggongjihuabiao_xuhao","序号","double","Normal",true,minValue,maxValue,false,'',true); 
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_gongzuoneirong','工作内容','200',2,true,'',200,0,'','',"","","1",'',"0",false); 
 putChildValidateItem("yonggongjihuabiao_gongzuoneirong","工作内容","any","",true,minValue,200,false,'',true); 
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_gongzhong','工种','80',2,true,'',80,1,';1:综合技工;2:普工;3:焊工;4:钢筋工;5:木工;6:混凝土工','',"","","2",'',"1",false);
 putChildValidateItem("yonggongjihuabiao_gongzhong","工种","any","",true,minValue,80,false,'',true); 
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_rigongzi','日工资','80',1,true,'',0,0,'','',"Price","","3",'',"0",false); 
 putChildValidateItem("yonggongjihuabiao_rigongzi","日工资","double","",true,minValue,maxValue,false,'',true); 
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_jihuagongshi','计划工时','80',1,true,'',0,0,'','',"Qty","","4",'',"0",false); 
 putChildValidateItem("yonggongjihuabiao_jihuagongshi","计划工时","double","",true,minValue,maxValue,false,'',true); 
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_jihuajine','计划金额','80',1,true,'',0,0,'','',"Amount","copy","5",'',"0",false); 
 putChildValidateItem("yonggongjihuabiao_jihuajine","计划金额","double","Normal",true,minValue,maxValue,false,'',true); 
  addCols(yonggongjihuabiaoData,'yonggongjihuabiao_beizhu','备注','300',20,true,'',1000,0,'','',"","","6",'',"0",false); 
 putChildValidateItem("yonggongjihuabiao_beizhu","备注","any","",true,minValue,1000,false,'',true); 
            
 addCols(yonggongjihuabiaoData,'yonggongjihuabiao_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=FlowNlaowugongzishenqing&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "FlowNlaowugongzishenqing,laowugongzifafangbiao,yonggongjihuabiao,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=FlowNlaowugongzishenqing&allTableName=FlowNlaowugongzishenqing,laowugongzifafangbiao,yonggongjihuabiao,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=FlowNlaowugongzishenqing&allTableName=laowugongzifafangbiao,yonggongjihuabiao,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=FlowNlaowugongzishenqing&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=FlowNlaowugongzishenqing&allTableName=laowugongzifafangbiao,yonggongjihuabiao,&colType=colWidth" ;
...
function seqInput(){
 ...
 var cTabName = "FlowNlaowugongzishenqingDet";
 var stockCode="";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=FlowNlaowugongzishenqing&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=FlowNlaowugongzishenqing&designId=9f139cee_1603161404139875160&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=FlowNlaowugongzishenqing&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=FlowNlaowugongzishenqing&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=FlowNlaowugongzishenqing&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '劳务成本管理';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=FlowNlaowugongzishenqing&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
