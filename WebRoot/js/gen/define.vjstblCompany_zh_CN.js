...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblCompanyEmployeeDetTable"){
 }
 }
function totalA(obj)
{
...
var fieldDigit = new Array();
 ...
 fieldDigit[fieldDigit.length] = {name:'taxRate',dis:'税率',digit:0,isMain:true};
...
childCount++;
 ...
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_Role','角色','90',2,true,'',50,1,';24:职员;10:董事长;9:总经理;2:副总经理;3:总监;20:经理;21:副经理;22:主管;23:专员;11:董事;25:大区经理;26:区域经理;27:高级专员;28:生管员;29:物管员;30:业务员;31:业助;32:助理;33:工程师','',"","","2",'',"1",false);
 ...
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_Telephone','电话','100',2,true,'',50,0,'','',"","","6",'',"0",false); 
 putChildValidateItem("tblCompanyEmployeeDet_Telephone","电话","any","",true,minValue,50,false,'',true); 
 
 
 
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_fax','传真','100',2,true,'',50,0,'','',"","","7",'',"0",false); 
 putChildValidateItem("tblCompanyEmployeeDet_fax","传真","any","",true,minValue,50,false,'',true); 
 
 
 
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_ClientEmail','Email','100',8,true,'',50,0,'','',"","","8",'',"0",false); 
 putChildValidateItem("tblCompanyEmployeeDet_ClientEmail","Email","mail","",true,minValue,50,false,'',true); 
 
 
 
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_MSN','MSN','100',2,true,'',50,-2,'','',"","","9",'',"0",false); 
 putChildValidateItem("tblCompanyEmployeeDet_MSN","MSN","any","",true,minValue,50,false,''); 
 
 
 
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_QQ','QQ','100',2,true,'',50,-2,'','',"","","10",'',"0",false); 
 putChildValidateItem("tblCompanyEmployeeDet_QQ","QQ","any","",true,minValue,50,false,''); 
 
 
 
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_Hobby','爱好','120',2,true,'',500,-2,'','',"","","11",'',"0",false); 
 putChildValidateItem("tblCompanyEmployeeDet_Hobby","爱好","any","",true,minValue,500,false,''); 
 
 
 
 addCols(tblCompanyEmployeeDetData,'tblCompanyEmployeeDet_Remark','备注','120',2,true,'',8000,0,'','',"","","12",'',"0",false); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblCompany&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
