...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_fukuanshenqing','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_fukuanshenqing','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function checkTable(allHidFields){
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("帐号"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("帐号"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("开启行"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("开启行"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("金额"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("金额"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("附件"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("附件"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText=$("#field_18",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_18")>-1)){ 
 alert("申请人"+"不能为空，请重新输入!");
 $("#field_18",document).focus();
 return false;
 }
