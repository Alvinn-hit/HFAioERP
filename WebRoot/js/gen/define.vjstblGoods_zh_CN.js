...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblGoodsStockLimitTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblGoodsUnitTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblGoodsStockLimit_BatchNo');
 ...
 var z=n('tblGoodsStockLimit_Inch');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsStockLimit_Hue');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblGoodsStockLimit_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'inPackageNum',dis:'内包装数',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'outPackageNum',dis:'扫描基数',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'netWeight',dis:'单位净重',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'packNetWeight',dis:'外包装净重',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'packGrossWeight',dis:'外包装毛重',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'lowerQty',dis:'库存下限',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'upperQty',dis:'库存上限',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'reTimes',dis:'最低订货量',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'profitLower',dis:'毛利上限%',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'profitUpper',dis:'毛利下限%',digit:4,isMain:true};
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_(tblUnit_name+'')");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblUnit_name");
 saveField[0].value = ""; 
 m("tbl_tblUnit_name").value = "" ;
 }
 ...
 if(fieldName == "FeeType"){
 var saveField=n("FeeType"); 
 saveField[0].value = "";
 var obj = m("tbl_tblExpenses_Subclass");
 if(obj != null){
 obj.value = "";
 }
 }
...
childCount++;
 ...
 addCols(tblGoodsStockLimitData,'tblGoodsStockLimit_tblStock_StockNumber1','仓库编号','120',0,true,'',1000000,2,'tblGoodsStockLimit:StockCode:tblGoodsStockLimit_tblStock_StockNumber1:'+param4,'',"","","2",'',"2",false); 
 
 
 addCols(tblGoodsStockLimitData,'tblGoodsStockLimit_tblStock_StockName1','仓库简称','100',0,true,'',1000000,2,'tblGoodsStockLimit:StockCode:tblGoodsStockLimit_tblStock_StockName1:'+param4,'',"","","2",'',"2",false); 
 ...
 addCols(tblGoodsStockLimitData,'tblGoodsStockLimit_BatchNo','批号','120',2,true,'',100,0,'','',"","triggerCopy","5",'',"0",false); 
 putChildValidateItem("tblGoodsStockLimit_BatchNo","批号","any","GoodsField",true,minValue,100,false,'',true); 
 ...
 var param4="";
 param4=param4+":0尺码组@YearNoGroup"; 
 
 addCols(tblGoodsStockLimitData,'tblGoodsStockLimit_yearNO','箱号','100',2,true,'',100,2,'tblGoodsStockLimit:yearNO:tblGoodsStockLimit_yearNO:'+param4,"","","triggerCopy","8",'',"2",true);
 putChildValidateItem("tblGoodsStockLimit_yearNO","箱号","any","GoodsField",true,minValue,100,false,'',true);
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblGoods&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblGoods&designId=047d83ca_1606282228054311907&keyId="+$("#id").val()+
