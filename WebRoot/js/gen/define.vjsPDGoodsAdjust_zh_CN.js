...
{ 
 cFireEvent('PDGoodsAdjustAet_Qty',''); 
 cFireEvent('PDGoodsAdjustDet_Qty',''); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=PDGoodsAdjust&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=PDGoodsAdjust&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=PDGoodsAdjust&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=PDGoodsAdjust&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "PDGoodsAdjustAetTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "PDGoodsAdjustDetTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 ...
 var z=n('PDGoodsAdjustAet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDGoodsAdjustAet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDGoodsAdjustDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('PDGoodsAdjustDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="PDGoodsAdjustAet"){
 
 copyFields=n('PDGoodsAdjustAet_GoodsCode');
 ...
 var PDGoodsAdjustAet_tblGoods_GoodsNumber = n('PDGoodsAdjustAet_tblGoods_GoodsNumber');
 if(typeof(PDGoodsAdjustAet_tblGoods_GoodsNumber) != 'undefined' && PDGoodsAdjustAet_tblGoods_GoodsNumber.length >index){
 PDGoodsAdjustAet_tblGoods_GoodsNumber[index].value = PDGoodsAdjustAet_tblGoods_GoodsNumber[index-1].value;
 }
 var PDGoodsAdjustAet_tblGoods_GoodsFullName = n('PDGoodsAdjustAet_tblGoods_GoodsFullName');
 if(typeof(PDGoodsAdjustAet_tblGoods_GoodsFullName) != 'undefined' && PDGoodsAdjustAet_tblGoods_GoodsFullName.length >index){
 PDGoodsAdjustAet_tblGoods_GoodsFullName[index].value = PDGoodsAdjustAet_tblGoods_GoodsFullName[index-1].value;
 }
 var PDGoodsAdjustAet_tblGoods_GoodsSpec = n('PDGoodsAdjustAet_tblGoods_GoodsSpec');
 if(typeof(PDGoodsAdjustAet_tblGoods_GoodsSpec) != 'undefined' && PDGoodsAdjustAet_tblGoods_GoodsSpec.length >index){
 PDGoodsAdjustAet_tblGoods_GoodsSpec[index].value = PDGoodsAdjustAet_tblGoods_GoodsSpec[index-1].value;
 }
 var PDGoodsAdjustAet_tblGoods_BaseUnit = n('PDGoodsAdjustAet_tblGoods_BaseUnit');
 if(typeof(PDGoodsAdjustAet_tblGoods_BaseUnit) != 'undefined' && PDGoodsAdjustAet_tblGoods_BaseUnit.length >index){
 PDGoodsAdjustAet_tblGoods_BaseUnit[index].value = PDGoodsAdjustAet_tblGoods_BaseUnit[index-1].value;
 }
 }
 }
 if(typeof(tableName)!="undefined" && tableName=="PDGoodsAdjustDet"){
 
 copyFields=n('PDGoodsAdjustDet_GoodsCode');
 if(copyFields[index].value !=0 && copyFields[index].value != ""){return}
 if((order > 1 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var PDGoodsAdjustDet_tblGoods_GoodsNumber = n('PDGoodsAdjustDet_tblGoods_GoodsNumber');
 if(typeof(PDGoodsAdjustDet_tblGoods_GoodsNumber) != 'undefined' && PDGoodsAdjustDet_tblGoods_GoodsNumber.length >index){
 PDGoodsAdjustDet_tblGoods_GoodsNumber[index].value = PDGoodsAdjustDet_tblGoods_GoodsNumber[index-1].value;
 }
 var PDGoodsAdjustDet_tblGoods_GoodsFullName = n('PDGoodsAdjustDet_tblGoods_GoodsFullName');
 if(typeof(PDGoodsAdjustDet_tblGoods_GoodsFullName) != 'undefined' && PDGoodsAdjustDet_tblGoods_GoodsFullName.length >index){
 PDGoodsAdjustDet_tblGoods_GoodsFullName[index].value = PDGoodsAdjustDet_tblGoods_GoodsFullName[index-1].value;
 }
 var PDGoodsAdjustDet_tblGoods_GoodsSpec = n('PDGoodsAdjustDet_tblGoods_GoodsSpec');
 if(typeof(PDGoodsAdjustDet_tblGoods_GoodsSpec) != 'undefined' && PDGoodsAdjustDet_tblGoods_GoodsSpec.length >index){
 PDGoodsAdjustDet_tblGoods_GoodsSpec[index].value = PDGoodsAdjustDet_tblGoods_GoodsSpec[index-1].value;
 }
 var PDGoodsAdjustDet_tblGoods_BaseUnit = n('PDGoodsAdjustDet_tblGoods_BaseUnit');
 if(typeof(PDGoodsAdjustDet_tblGoods_BaseUnit) != 'undefined' && PDGoodsAdjustDet_tblGoods_BaseUnit.length >index){
 PDGoodsAdjustDet_tblGoods_BaseUnit[index].value = PDGoodsAdjustDet_tblGoods_BaseUnit[index-1].value;
 }
 }
 }
 }
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="PDGoodsAdjustAet"){
 ...
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="PDGoodsAdjustDet"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="PDGoodsAdjustAet"; 
 tblName[1]="PDGoodsAdjustDet"; 
...
function execStat2(){
 execStatOne('PDGoodsAdjustAet_BQty',4);
 execStatOne('PDGoodsAdjustAet_Qty',4);
 execStatOne('PDGoodsAdjustAet_Remark',2);
 execStatOne('PDGoodsAdjustDet_Remark',2);
 setTotalCount(getTotalCount());
}
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"PDGoodsAdjust\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'PDGoodsAdjustAet_BQty',"PDGoodsAdjustAet"); 
 delFireEventOne(rowId,tableName,'PDGoodsAdjustAet_Qty',"PDGoodsAdjustAet"); 
 delFireEventOne(rowId,tableName,'PDGoodsAdjustDet_Qty',"PDGoodsAdjustDet"); 
 }

var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'PlanQty',dis:'计划数量',digit:0,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'MainQty',dis:'入库数量',digit:4,isMain:true};
 fieldDigit[fieldDigit.length] = {name:'PDGoodsAdjustAet_BQty',dis:'配方比例',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'PDGoodsAdjustAet_Qty',dis:'数量',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'PDGoodsAdjustDet_Qty',dis:'数量',digit:4,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=PDGoodsAdjust",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=PDGoodsAdjust&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=PDGoodsAdjust&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 saveField[0].value = "";
 var obj = m("tbl_tblGoods_classCode");
 if(obj != null){
 obj.value = "";
 }
 ...
 var saveField=n("tblStock_StockNumber"); 
 saveField[0].value = "";
 var obj = m("tbl_tblStock_StockNumber");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblStock_StockName"); 
 saveField[0].value = "";
 var obj = m("tbl_tblStock_StockName");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGoods_GoodsNumber");
 saveField[0].value = ""; 
 m("tbl_tblGoods_GoodsNumber").value = "" ;
 var saveField=n("tblGoods_GoodsFullName");
 saveField[0].value = ""; 
 m("tbl_tblGoods_GoodsFullName").value = "" ;
 var saveField=n("tblGoods_GoodsSpec");
 saveField[0].value = ""; 
 m("tbl_tblGoods_GoodsSpec").value = "" ;
 var saveField=n("tblGoods_BaseUnit");
 saveField[0].value = ""; 
 m("tbl_tblGoods_BaseUnit").value = "" ;
 }
 ...
 var saveField=n("tblStock_StockNumber");
 saveField[0].value = ""; 
 m("tbl_tblStock_StockNumber").value = "" ;
 var saveField=n("tblStock_StockName");
 saveField[0].value = ""; 
 m("tbl_tblStock_StockName").value = "" ;
 }
 }
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "PDGoodsAdjust"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=PDGoodsAdjust&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=PDGoodsAdjust&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
r(0,"Qty")[j].value=f(rn(0,"BQty",j)*nn('PlanQty',0),4);
}

n('MainQty')[0].value=f(sm('PDGoodsAdjustAet_Qty')*1.03,4);
 ...
 for(i = 0;i<z.length;i++){ 
 z[i].onchange = function(){ 
 for(var j=0;j<r(0,'BQty').length;j++){
r(0,"BQty")[j].value=f(rn(0,"Qty",j)/(nn('MainQty',0)/1.03),4);
}
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustAet_BQty'); 
 r(0,"Qty")[p].value=f(rn(0,"BQty",p)*nn('PlanQty',0),4);
n('MainQty')[0].value=f(sm('PDGoodsAdjustAet_Qty')*1.03,4);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustAet_Qty'); 
 r(0,"BQty")[p].value=f(rn(0,"Qty",p)/nn('PlanQty',0),4);
n('MainQty')[0].value=f(sm('PDGoodsAdjustAet_Qty')*1.03,4);
 if(document.createEvent){ var evt = document.createEvent('HTMLEvents'); evt.initEvent('change',true,false);n('MainQty')[0].dispatchEvent(evt);
}else{ n('MainQty')[0].fireEvent('onchange'); } 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustAet_SecQty'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustDet_Qty'); 
 r(1,"CostAmount")[p].value=f(rn(1,"CostPrice",p)*rn(1,"Qty",p),6);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustDet_CostAmount'); 
 r(1,"CostPrice")[p].value=f(rn(1,"CostAmount",p)/rn(1,"Qty",p),6);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustDet_CostPrice'); 
 r(1,"CostAmount")[p].value=f(rn(1,"CostPrice",p)*rn(1,"Qty",p),6);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'PDGoodsAdjustDet_SecQty'); 
...
childData[childCount]='PDGoodsAdjustAet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='配方明细';
childCount++;
 var PDGoodsAdjustAetData = new gridData();
 gridDatas[gridDataNum] = PDGoodsAdjustAetData;
 gridDataNum++;
 var PDGoodsAdjustAet=1;
 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_Seq','物流码','130',2,true,'',5000,-2,'','',"","triggerCopy","0",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustAet_Seq","物流码","any","GoodsField",true,minValue,5000,false,''); 
 ...
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_GoodsCode','料件名称','100',2,false,'',100,-2,'','',"","copy","1",'',"2",true);
 putChildValidateItem("PDGoodsAdjustAet_GoodsCode","料件名称","any","",false,minValue,100,false,'');
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_tblGoods_GoodsNumber','原料油编号','120',2,true,'',1000000,2,'PDGoodsAdjustAet:GoodsCode:PDGoodsAdjustAet_tblGoods_GoodsNumber:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_tblGoods_GoodsFullName','原料油名称','120',2,true,'',1000000,2,'PDGoodsAdjustAet:GoodsCode:PDGoodsAdjustAet_tblGoods_GoodsFullName:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_tblGoods_GoodsSpec','原料油规格','120',20,true,'',1000000,2,'PDGoodsAdjustAet:GoodsCode:PDGoodsAdjustAet_tblGoods_GoodsSpec:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_tblGoods_BaseUnit','单位','80',2,true,'',1000000,2,'PDGoodsAdjustAet:GoodsCode:PDGoodsAdjustAet_tblGoods_BaseUnit:'+param4,'',"","copy","1",'',"2",false); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","2",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustAet_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","3",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustAet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","4",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustAet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_yearNO','箱号','100',2,true,'',100,-2,'','',"","triggerCopy","5",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustAet_yearNO","箱号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","6",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustAet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","7",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustAet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_BQty','配方比例','60',1,true,'',0,0,'','',"Qty","","8",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustAet_BQty","配方比例","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_Qty','数量','60',1,false,'',0,0,'','',"Qty","","9",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustAet_Qty","数量","double","Normal",false,minValue,maxValue,false,'',true); 
 ...
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_StockCode','仓库','80',2,false,'',100,-2,'','',"SPriceIdentifier","","10",'',"2",true);
 putChildValidateItem("PDGoodsAdjustAet_StockCode","仓库","any","",false,minValue,100,true,'');
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_tblStock_StockNumber1','仓库编号','120',0,true,'',1000000,2,'PDGoodsAdjustAet:StockCode:PDGoodsAdjustAet_tblStock_StockNumber1:'+param4,'',"SPriceIdentifier","","10",'',"2",false); 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_tblStock_StockName1','仓库简称','100',0,true,'',1000000,2,'PDGoodsAdjustAet:StockCode:PDGoodsAdjustAet_tblStock_StockName1:'+param4,'',"SPriceIdentifier","","10",'',"2",false); 
 ...
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"Price","","16",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustAet_BaseQty","基本单位","int","BillDiscount",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"Qty","","17",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustAet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_Remark','备注','100',2,true,'',8000,0,'','',"SAmountIdentifier","","18",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustAet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(PDGoodsAdjustAetData,'PDGoodsAdjustAet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='PDGoodsAdjustDet';
tabIsNulls[childCount]='0';
tabDiss[childCount]='调油扣料明细';
childCount++;
 var PDGoodsAdjustDetData = new gridData();
 gridDatas[gridDataNum] = PDGoodsAdjustDetData;
 gridDataNum++;
 var PDGoodsAdjustDet=1;
 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_Seq','物流码','130',2,true,'',5000,-2,'','',"","triggerCopy","0",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustDet_Seq","物流码","any","GoodsField",true,minValue,5000,false,''); 
 ...
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_GoodsCode','料件名称','100',2,false,'',100,-2,'','',"","copy","1",'',"2",true);
 putChildValidateItem("PDGoodsAdjustDet_GoodsCode","料件名称","any","",false,minValue,100,false,'');
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_tblGoods_GoodsNumber','原料油编号','120',2,true,'',1000000,8,'PDGoodsAdjustDet:GoodsCode:PDGoodsAdjustDet_tblGoods_GoodsNumber:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_tblGoods_GoodsFullName','原料油名称','120',2,true,'',1000000,8,'PDGoodsAdjustDet:GoodsCode:PDGoodsAdjustDet_tblGoods_GoodsFullName:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_tblGoods_GoodsSpec','原料油规格','120',20,true,'',1000000,8,'PDGoodsAdjustDet:GoodsCode:PDGoodsAdjustDet_tblGoods_GoodsSpec:'+param4,'',"","copy","1",'',"2",false); 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_tblGoods_BaseUnit','单位','80',2,true,'',1000000,8,'PDGoodsAdjustDet:GoodsCode:PDGoodsAdjustDet_tblGoods_BaseUnit:'+param4,'',"","copy","1",'',"2",false); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_BatchNo','批号','120',2,true,'',100,8,'','',"","triggerCopy","2",'',"8",false); 
 putChildValidateItem("PDGoodsAdjustDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,'',true); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_Inch','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","3",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustDet_Inch","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","4",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_yearNO','箱号','100',2,true,'',100,-2,'','',"","triggerCopy","5",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustDet_yearNO","箱号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","6",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","7",'',"2",false); 
 putChildValidateItem("PDGoodsAdjustDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_Qty','数量','60',1,false,'',0,8,'','',"Qty","","8",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustDet_Qty","数量","double","",false,minValue,maxValue,false,'',true); 
 ...
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_StockCode','仓库','80',2,true,'',100,-2,'','',"SPriceIdentifier","","9",'',"2",true);
 putChildValidateItem("PDGoodsAdjustDet_StockCode","仓库","any","",true,minValue,100,true,'');
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_tblStock_StockNumber1','仓库编号','120',0,true,'',1000000,8,'PDGoodsAdjustDet:StockCode:PDGoodsAdjustDet_tblStock_StockNumber1:'+param4,'',"SPriceIdentifier","","9",'',"2",false); 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_tblStock_StockName1','仓库简称','100',0,true,'',1000000,8,'PDGoodsAdjustDet:StockCode:PDGoodsAdjustDet_tblStock_StockName1:'+param4,'',"SPriceIdentifier","","9",'',"2",false); 
 ...
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_CostAmount','成本总额','60',1,true,'',0,-2,'','',"Price","","15",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustDet_CostAmount","成本总额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_CostPrice','成本单价','60',1,true,'',0,-2,'','',"priceIdentifier","","16",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustDet_CostPrice","成本单价","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"Amount","","17",'',"100",false); 
 putChildValidateItem("PDGoodsAdjustDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"Qty","","18",'',"3",false); 
 putChildValidateItem("PDGoodsAdjustDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_Remark','备注','100',2,true,'',8000,8,'','',"SAmountIdentifier","","19",'',"0",false); 
 putChildValidateItem("PDGoodsAdjustDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 addCols(PDGoodsAdjustDetData,'PDGoodsAdjustDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=PDGoodsAdjust&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "PDGoodsAdjust,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=PDGoodsAdjust&allTableName=PDGoodsAdjust,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=PDGoodsAdjust&allTableName=PDGoodsAdjustAet,PDGoodsAdjustDet,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=PDGoodsAdjust&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=PDGoodsAdjust&allTableName=PDGoodsAdjustAet,PDGoodsAdjustDet,&colType=colWidth" ;
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=PDGoodsAdjust&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=PDGoodsAdjust&designId=79B1086EB5BA405689894D7A24F7&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=PDGoodsAdjust&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=PDGoodsAdjust&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi+"&moduleType="+moduleType,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=PDGoodsAdjust&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '调油单';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=PDGoodsAdjust&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
