...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_luyongshenqingbiao','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_luyongshenqingbiao','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function checkTable(allHidFields){
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("学历"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("学历"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("身份证号码"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("身份证号码"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("联系电话"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("联系电话"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("户籍地址"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("户籍地址"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("其它"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("其它"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("来历其它"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("来历其它"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("试用期工资"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("试用期工资"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("转正后工资"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("转正后工资"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("其他补贴"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("其他补贴"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("工作地点"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("工作地点"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
