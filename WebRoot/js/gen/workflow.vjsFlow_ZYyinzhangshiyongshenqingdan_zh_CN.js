...
$(document).ready(function(){
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_ZYyinzhangshiyongshenqingdan','"+$(this).attr('value')+"','popup_"+Id+"','"+Id+"','"+isMutiplse+"')";
 ...
 var imgUrl="if(popMainInput(''))openPopup('Flow_ZYyinzhangshiyongshenqingdan','"+$(this).attr('value')+"','"+popupNames+"','"+Id+"','"+isMutiplse+"')";
...
function checkTable(allHidFields){
 ...
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_11")>-1)){ 
 alert("申请印章名称"+"不能为空，请重新输入!");
 $("#field_11",document).focus();
 return false;
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("用印编号"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("用印编号"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 if(inputType == "integer"){
 if(labelText.val().length>0 && !isInt(labelText.val())){
 alert("材料预留"+"必须为整形数字，请重新输入!");
 labelText.focus();
 return false;
 }
 }else if(inputType=="float"){
 if(labelText.val().length>0 && !isFloat(labelText.val())){
 alert("材料预留"+"必须为小数，请重新输入!");
 labelText.focus();
 return false;
 }
 }
 ...
 var labelText=$("#field_14",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_14")>-1)){ 
 alert("用章事由"+"不能为空，请重新输入!");
 $("#field_14",document).focus();
 return false;
 }
 ...
 alert("申请日期"+"不能为空，请重新输入!");
 $("#field_8",document).focus();
 return false;
 }
 
 var labelText=$("#field_9",document);
 if(typeof(labelText)!="string"){
 labelText = labelText.val();
 }
 
 if(typeof(labelText)!= "undefined" && labelText.length == 0 && !(allHidFields.indexOf("field_9")>-1)){ 
 alert("申请人"+"不能为空，请重新输入!");
 $("#field_9",document).focus();
 return false;
 }
