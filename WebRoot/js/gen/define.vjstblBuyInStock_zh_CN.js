...
{ 
 cFireEvent('tblBuyInStockDet_Qty',''); 
 cFireEvent('tblBuyInStockDet_Price',''); 
 }

function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblBuyInStock&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblBuyInStock&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblBuyInStock&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblBuyInStock&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function setRowTotal(objTd){
 ...
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblBuyInStockDetTable"){
 }
 if(objTd.parentElement.parentElement.parentElement.parentElement.getAttribute("name") == "tblBuyPayAccountTable"){
 }
 }
function totalA(obj)
{
...
function initCountCal(){
 var z=n('tblBuyInStockDet_BuyOrderID');
 ...
 var z=n('tblBuyInStockDet_BuyAskPriceID');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyInStockDet_GoodsCode');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyInStockDet_BatchNo');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
 ...
 var z=n('tblBuyInStockDet_yearNO');
 for(i = 0;i<z.length;i++){
 if(navigator.userAgent.indexOf("MSIE")!=-1){
 z[i].attachEvent("onblur",copyFields);
 }else{
...
function copyFields2(index,order,tableName,copyAll){
 if(index==0)return ;
 var copyFields;
 if(typeof(tableName)!="undefined" && tableName=="tblBuyInStockDet"){
 
 copyFields=n('tblBuyInStockDet_StockCode');
 ...
 copyFields=n('tblBuyInStockDet_GoodsCode');
 if((order > 4 || (typeof(copyAll)!="undefined" && "copyAll"==copyAll)) && typeof(copyFields[index])!="undefined" && (copyisNull(copyFields[index].value))){
 copyFields[index].value = copyFields[index-1].value;
 var tblBuyInStockDet_tblGoods_GoodsFullName = n('tblBuyInStockDet_tblGoods_GoodsFullName');
 if(typeof(tblBuyInStockDet_tblGoods_GoodsFullName) != 'undefined' && tblBuyInStockDet_tblGoods_GoodsFullName.length >index){
 tblBuyInStockDet_tblGoods_GoodsFullName[index].value = tblBuyInStockDet_tblGoods_GoodsFullName[index-1].value;
 }
 var tblBuyInStockDet_tblGoods_GoodsNumber = n('tblBuyInStockDet_tblGoods_GoodsNumber');
 if(typeof(tblBuyInStockDet_tblGoods_GoodsNumber) != 'undefined' && tblBuyInStockDet_tblGoods_GoodsNumber.length >index){
 tblBuyInStockDet_tblGoods_GoodsNumber[index].value = tblBuyInStockDet_tblGoods_GoodsNumber[index-1].value;
 }
 var tblBuyInStockDet_tblGoods_GoodsSpec = n('tblBuyInStockDet_tblGoods_GoodsSpec');
 if(typeof(tblBuyInStockDet_tblGoods_GoodsSpec) != 'undefined' && tblBuyInStockDet_tblGoods_GoodsSpec.length >index){
 tblBuyInStockDet_tblGoods_GoodsSpec[index].value = tblBuyInStockDet_tblGoods_GoodsSpec[index-1].value;
 }
 var tblBuyInStockDet_tblGoods_BaseUnit = n('tblBuyInStockDet_tblGoods_BaseUnit');
 if(typeof(tblBuyInStockDet_tblGoods_BaseUnit) != 'undefined' && tblBuyInStockDet_tblGoods_BaseUnit.length >index){
 tblBuyInStockDet_tblGoods_BaseUnit[index].value = tblBuyInStockDet_tblGoods_BaseUnit[index-1].value;
 }
 }
   }
 if(typeof(tableName)!="undefined" && tableName=="tblBuyPayAccount"){
...
if(trigType=="dbClick" && index>0){
 var copyFields;
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblBuyInStockDet"){
 ...
 if(typeof(curGridRowNum.curKey)!="undefined" && curGridRowNum.curKey=="tblBuyPayAccount"){
...
var goodsCodeLogicValidate =new Array();
 tblName[0]="tblBuyInStockDet"; 
 var goodsCodeLogicValidate_tblBuyInStockDet='@GN:Seq:Qty:tblBuyInStockDet_GoodsSeqSet:tblBuyInStockDet_GoodsCode:StockCode';
 goodsCodeLogicValidate[goodsCodeLogicValidate.length] = {key:'tblBuyInStockDet',value:goodsCodeLogicValidate_tblBuyInStockDet};
 tblName[1]="tblBuyPayAccount"; 
...
function execStat2(){
 execStatOne('tblBuyInStockDet_Qty',2);
 execStatOne('tblBuyInStockDet_Amount',2);
 execStatOne('tblBuyPayAccount_Amount',2);
 setTotalCount(getTotalCount());
}
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblBuyInStock\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblBuyInStock\",\"PIC\");'>删除</a><em>"+str+"</em></div><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" height=\"120\" border=\"0\"></a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
{
 delFireEventOne(rowId,tableName,'tblBuyInStockDet_Qty',"tblBuyInStockDet"); 
 delFireEventOne(rowId,tableName,'tblBuyInStockDet_Price',"tblBuyInStockDet"); 
 delFireEventOne(rowId,tableName,'tblBuyInStockDet_Amount',"tblBuyInStockDet"); 
 delFireEventOne(rowId,tableName,'tblBuyPayAccount_Amount',"tblBuyPayAccount"); 
 }
...
var fieldDigit = new Array();
 ...
 fieldDigit[fieldDigit.length] = {name:'tblBuyInStockDet_Qty',dis:'数量',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyInStockDet_Price',dis:'单价',digit:4,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyInStockDet_Amount',dis:'金额',digit:2,isMain:false};
 fieldDigit[fieldDigit.length] = {name:'tblBuyPayAccount_Amount',dis:'金额',digit:2,isMain:false};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblBuyInStock",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblBuyInStock&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblBuyInStock&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 var saveField=n("ProjectCode"); 
 saveField[0].value = "";
 var obj = m("tbl_tblProject_id");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblProject_ProjectName");
 saveField[0].value = ""; 
 m("tbl_tblProject_ProjectName").value = "" ;
 }
  }
...
function initSeqQtySet(){
 if(false){
  ...
  if(false){
 var fields=n('tblBuyInStockDet_Qty'); 
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblBuyInStock"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblBuyInStock&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblBuyInStock&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function initMainCaculate(){
 ...
 if(nn('InVoiceType',0)==2)n('Tax')[0].value=f("17",4);

if(nn('InVoiceType',0)==1)n('Tax')[0].value=f("3",4);
...
n('TotalAmount')[0].value=f(sm('tblBuyInStockDet_DisBackAmt'),2);

n('TotalTaxAmount')[0].value=f(sm('tblBuyInStockDet_TaxAmount')-nn('DiscountAmount',0),2);
...
n('TotalCoTaxAmt')[0].value=f(sm('tblBuyInStockDet_CoTaxAmt'),2);

for(var j=0;j<r(0,'DisAmount').length;j++){
r(0,"DisAmount")[j].value=f(rn(0,"Amount",j)-rn(0,"DisBackAmt",j),2);
}

n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 n('CurTotalAmount')[0].value=f(sm('tblBuyInStockDet_CurAmount')-nn('CurDiscountAmount',0),2);
 ...
 for(i = 0;i<z.length;i++){ 
 z[i].onchange = function(){ 
 n('CurTotalAmount')[0].value=f(sm('tblBuyInStockDet_CurAmount')+nn('CurProceDureExp',0)-nn('CurDiscountAmount',0),2);
...
n('FactOutcome')[0].value=f(sm('tblBuyPayAccount_Amount'),2);

n('PayAmount')[0].value=f(sm('tblBuyPayAccount_Amount'),2);

n('AccAmt')[0].value=f(sm('tblBuyPayAccount_Amount'),2);

n('CurAlrPayAmt')[0].value=f(nn('AccAmt',0)/nn('CurrencyRate',0),2);
...
function initCalculate(){
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_Qty'); 
...
n('TotalCoTaxAmt')[0].value=f(sm('tblBuyInStockDet_CoTaxAmt'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_Price'); 
 r(0,"Amount")[p].value=f(rn(0,"Price",p)*rn(0,"Qty",p),2);
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_Amount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_Discount'); 
 r(0,"DisPrice")[p].value=f(rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"DisBackAmt")[p].value=f(rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
r(0,"TaxPrice")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Discount",p)*rn(0,"Price",p)/100,4);
r(0,"TaxAmount")[p].value=f(((nn('Tax',0)/100)+1)*rn(0,"Amount",p)*rn(0,"Discount",p)/100,2);
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_DisPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_DisBackAmt'); 
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_TaxPrice'); 
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_TaxAmount'); 
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_CurPrice'); 
...
n('TotalAmount')[0].value=f(sm('tblBuyInStockDet_DisBackAmt'),2);
n('TotalTaxAmount')[0].value=f(sm('tblBuyInStockDet_TaxAmount')-nn('DiscountAmount',0),2);
n('CurTotalAmount')[0].value=f(sm('tblBuyInStockDet_CurAmount'),2);
r(0,"CoTaxAmt")[p].value=f(rn(0,"TaxAmount",p)-rn(0,"DisBackAmt",p),2);
n('TotalCoTaxAmt')[0].value=f(sm('tblBuyInStockDet_CoTaxAmt'),2);
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
n('CurTotalAmount')[0].value=f(sm('tblBuyInStockDet_CurAmount')+nn('CurProceDureExp',0)-nn('CurDiscountAmount',0),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_CurAmount'); 
 r(0,"TaxAmount")[p].value=f(rn(0,"CurAmount",p)*nn('CurrencyRate',0),2);
r(0,"DisBackAmt")[p].value=f(rn(0,"CurAmount",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1),2);
r(0,"Amount")[p].value=f(rn(0,"CurAmount",p)*nn('CurrencyRate',0)/((nn('Tax',0)/100)+1)/(rn(0,"Discount",p)/100),2);
...
n('CurTotalAmount')[0].value=f(sm('tblBuyInStockDet_CurAmount')+nn('CurProceDureExp',0)-nn('CurDiscountAmount',0),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_PresentSampleType'); 
...
n('DisAmount')[0].value=f(sm('tblBuyInStockDet_DisAmount'),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyInStockDet_SecQty'); 
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyPayAccount_Amount'); 
 n('FactOutcome')[0].value=f(Number(sm('tblBuyPayAccount_Amount')),2);
n('PayAmount')[0].value=f(Number(sm('tblBuyPayAccount_Amount'))-Number(nn('ProceDureExp',0)),2);
n('AccAmt')[0].value=f(sm('tblBuyPayAccount_Amount'),2);
r(1,"ExeBalFcAmt")[p].value=f(rn(1,"Amount",p)/nn('CurrencyRate',0),2);
n('CurAlrPayAmt')[0].value=f(nn('PayAmount',0)/nn('CurrencyRate',0),2);
 ...
 for(i = 0;i<z.length;i++){
 z[i].onchange = function(){ 
 var p =getrp(this,'tblBuyPayAccount_ExeBalFcAmt'); 
...
childData[childCount]='tblBuyInStockDet';
tabIsNulls[childCount]='1';
tabDiss[childCount]='采购入库单明细';
childCount++;
 var tblBuyInStockDetData = new gridData();
 gridDatas[gridDataNum] = tblBuyInStockDetData;
 gridDataNum++;
 var tblBuyInStockDet=1;
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_StockCode','仓库','80',2,true,'',50,-2,'','',"","copy","0",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_StockCode","仓库","any","",true,minValue,50,true,''); 
 
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_BuyOrderID','订单编号','80',2,true,'',32,-2,'','',"","triggerCopy","1",'',"2",false); 
 putChildValidateItem("tblBuyInStockDet_BuyOrderID","订单编号","any","ManyBillQuote",true,minValue,32,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_BuyAskPriceID','询价单号','80',2,true,'',32,-2,'','',"","triggerCopy","2",'',"2",false); 
 putChildValidateItem("tblBuyInStockDet_BuyAskPriceID","询价单号","any","ManyBillQuote",true,minValue,32,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_SalesOutID','出库单号','80',2,true,'',100,-2,'','',"","","3",'',"2",false); 
 putChildValidateItem("tblBuyInStockDet_SalesOutID","出库单号","any","ManyBillQuote",true,minValue,100,false,''); 
 ...
 param4=param4+":tblBuyInStockDet_BuyOrderID@tblBuyInStockDet_BuyOrderID"; 
 param4=param4+":tblBuyInStockDet_BuyAskPriceID@tblBuyInStockDet_BuyAskPriceID"; 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_GoodsCode','商品名称','120',2,false,'',50,-2,'','',"","triggerOrCopy","4",'',"2",true);
 putChildValidateItem("tblBuyInStockDet_GoodsCode","商品名称","any","",false,minValue,50,false,'');
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_tblGoods_GoodsFullName','商品名称','150',18,true,'',1000000,2,'tblBuyInStockDet:GoodsCode:tblBuyInStockDet_tblGoods_GoodsFullName:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_tblGoods_GoodsNumber','商品编号','100',2,true,'',1000000,2,'tblBuyInStockDet:GoodsCode:tblBuyInStockDet_tblGoods_GoodsNumber:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_tblGoods_GoodsSpec','商品规格','200',2,true,'',1000000,2,'tblBuyInStockDet:GoodsCode:tblBuyInStockDet_tblGoods_GoodsSpec:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_tblGoods_BaseUnit','单位','30',2,true,'',1000000,2,'tblBuyInStockDet:GoodsCode:tblBuyInStockDet_tblGoods_BaseUnit:'+param4,'',"","triggerOrCopy","4",'',"2",false); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_BatchNo','批号','120',2,true,'',100,-2,'','',"","triggerCopy","5",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_BatchNo","批号","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Inch','尺寸','70',2,true,'',100,-2,'','',"","triggerCopy","6",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Inch","尺寸","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Hue','颜色','70',2,true,'',100,-2,'','',"","triggerCopy","7",'',"2",false); 
 putChildValidateItem("tblBuyInStockDet_Hue","颜色","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_yearNO','厚度','70',2,true,'',100,-2,'','',"","triggerCopy","8",'',"2",false); 
 putChildValidateItem("tblBuyInStockDet_yearNO","厚度","any","GoodsField",true,minValue,100,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_ProDate','生产日期','80',5,true,'',10,-2,'','',"","","9",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_ProDate","生产日期","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Availably','保质期限','80',5,true,'',10,-2,'','',"","","10",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Availably","保质期限","date","GoodsField",true,minValue,10,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Seq','序列号','130',2,true,'',5000,-2,'','',"","triggerCopy","11",'',"2",false); 
 putChildValidateItem("tblBuyInStockDet_Seq","序列号","any","GoodsField",true,minValue,5000,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Qty','数量','60',1,false,'',0,0,'','',"Qty","","12",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Qty","数量","double","SeqQty",false,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Price','单价','80',1,true,'',0,0,'','',"priceIdentifier","","13",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Price","单价","double","",true,minValue,maxValue,false,'',true); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Amount','金额','100',1,true,'',0,0,'','',"AmountIdentifier","","14",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Amount","金额","double","",true,minValue,maxValue,false,'',true); 
 ...
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Discount','折扣率%','100',1,true,'100',0,-2,'','',"Price","","21",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Discount","折扣率%","double","BillDiscount",true,minValue,maxValue,true,'100'); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_DisPrice','折后单价','100',1,true,'',0,-2,'','',"priceIdentifier","","22",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_DisPrice","折后单价","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_DisBackAmt','折后金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","23",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_DisBackAmt","折后金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_DisAmount','折让金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","24",'',"8",false); 
 putChildValidateItem("tblBuyInStockDet_DisAmount","折让金额","double","BillDiscount",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_TaxPrice','含税单价','100',1,true,'',0,-2,'','',"priceIdentifier","","25",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_TaxPrice","含税单价","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_TaxAmount','含税金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","26",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_TaxAmount","含税金额","double","BillTax",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_CoTaxAmt','税额','100',1,true,'0',0,-2,'','',"AmountIdentifier","","27",'',"8",false); 
 putChildValidateItem("tblBuyInStockDet_CoTaxAmt","税额","double","BillTax",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_CurPrice','外币单价','100',1,true,'',0,-2,'','',"priceIdentifier","","28",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_CurPrice","外币单价","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_CurAmount','外币金额','100',1,true,'',0,-2,'','',"AmountIdentifier","","29",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_CurAmount","外币金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_ApportionAmt','分摊金额','50',1,true,'',50,-2,'','',"SAmountIdentifier","","32",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_ApportionAmt","分摊金额","double","",true,minValue,50,false,''); 
 
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_SourceID','源ID','0',2,true,'',60,-2,'','',"","","35",'',"100",false); 
 putChildValidateItem("tblBuyInStockDet_SourceID","源ID","any","",true,minValue,60,false,''); 
 ...
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_InvoiceAmount','已开票金额','200',1,true,'0',0,-2,'','',"AmountIdentifier","","49",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_InvoiceAmount","已开票金额","double","",true,minValue,maxValue,true,'0'); 
 
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_PresentSampleType','赠(样)品','80',2,true,'',10,-2,'','',"","","52",'',"1",false); 
 putChildValidateItem("tblBuyInStockDet_PresentSampleType","赠(样)品","any","BillPresentSampleType",true,minValue,10,false,''); 
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_NotPayQty','未付款数量','224',1,true,'',0,-2,'','',"Qty","","54",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_NotPayQty","未付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_PayQty','付款数量','224',1,true,'',0,-2,'','',"Qty","","55",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_PayQty","付款数量","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_SecQty','辅助数量','224',0,true,'0',0,-2,'','',"","","56",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_SecQty","辅助数量","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_BaseQty','基本单位','224',0,true,'0',0,-2,'','',"","","57",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_BaseQty","基本单位","int","",true,minValue,maxValue,true,'0'); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_CheckBarCode','复核码','160',2,true,'',200,-2,'','',"","","58",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_CheckBarCode","复核码","any","",true,minValue,200,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_BackPayQty','退货付款数','224',1,true,'',0,-2,'','',"Qty","","59",'',"3",false); 
 putChildValidateItem("tblBuyInStockDet_BackPayQty","退货付款数","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_PreferAmount','优惠金额','80',1,true,'',0,-2,'','',"AmountIdentifier","","60",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_PreferAmount","优惠金额","double","",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_Remark','备注','100',2,true,'',8000,0,'','',"","","61",'',"0",false); 
 putChildValidateItem("tblBuyInStockDet_Remark","备注","any","",true,minValue,8000,false,'',true); 
 
 
 
 
 addCols(tblBuyInStockDetData,'tblBuyInStockDet_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
 
childData[childCount]='tblBuyPayAccount';
tabIsNulls[childCount]='0';
tabDiss[childCount]='入库单付款账户明细';
childCount++;
 var tblBuyPayAccountData = new gridData();
 gridDatas[gridDataNum] = tblBuyPayAccountData;
 gridDataNum++;
 var tblBuyPayAccount=1;
 ...
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_Paytype','付款方式','80',2,true,'1',100,1,';1:现金;2:支票;3:电汇;4:商业汇票;5:银行汇票','',"","","1",'',"1",false);
 putChildValidateItem("tblBuyPayAccount_Paytype","付款方式","any","",true,minValue,100,true,'1',true); 
 ...
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_Account','账户','150',2,false,'Sess_Account',100,-2,'','',"","","2",'',"2",true);
 putChildValidateItem("tblBuyPayAccount_Account","账户","any","",false,minValue,100,true,'Sess_Account');
 
 
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_tblAccTypeInfo_AccName','账户','150',2,true,'Sess_AccName',1000000,2,'tblBuyPayAccount:Account:tblBuyPayAccount_tblAccTypeInfo_AccName:'+param4,'',"","","2",'',"2",false); 
 
 
 
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_Amount','金额','100',1,true,'0',0,0,'','',"Amount","","3",'',"0",false); 
 putChildValidateItem("tblBuyPayAccount_Amount","金额","double","RowMarker",true,minValue,maxValue,true,'0',true); 
 
 
 
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_ExeBalFcAmt','外币结算金额','80',1,true,'',0,-2,'','',"AmountIdentifier","","4",'',"0",false); 
 putChildValidateItem("tblBuyPayAccount_ExeBalFcAmt","外币结算金额","double","currency",true,minValue,maxValue,false,''); 
 
 
 
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_Remark','账户备注','150',2,true,'',8000,0,'','',"","","5",'',"0",false); 
 putChildValidateItem("tblBuyPayAccount_Remark","账户备注","any","",true,minValue,8000,false,'',true); 
 
 
 
 addCols(tblBuyPayAccountData,'tblBuyPayAccount_detsId','明细ID','0',2,true,'',100,-2,'','',"","","",'','3'); 
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblBuyInStock&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblBuyInStock,tblBuyInStockDet,tblBuyPayAccount,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblBuyInStock&allTableName=tblBuyInStock,tblBuyInStockDet,tblBuyPayAccount,&colType=bill";
 jQuery.ajax({url: strURL,type: "POST",data:"colSelect="+strCols,async: false}); 
 document.location.href = document.location.href ;
 return;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblBuyInStock&allTableName=tblBuyInStockDet,tblBuyPayAccount,&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblBuyInStock&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblBuyInStock&allTableName=tblBuyInStockDet,tblBuyPayAccount,&colType=colWidth" ;
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblBuyInStock&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblBuyInStock&designId=&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblBuyInStock&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblBuyInStock&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi+"&moduleType="+moduleType,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblBuyInStock&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '采购入库';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblBuyInStock&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
