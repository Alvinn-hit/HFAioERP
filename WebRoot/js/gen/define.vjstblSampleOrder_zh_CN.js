...
function auditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=submit&tableName=tblSampleOrder&workFlowNode="+workFlowNode,
...
function backAuditing(){
 var varReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=back&keyId="+valueId+"&tableName=tblSampleOrder&workFlowNode="+workFlowNode,
 winObj,"dialogWidth:600px;dialogHeight:400px;center:yes;help:no;resizable:no;status:no;scroll:no;");
 if(typeof(varReturn)=="undefined")return false ;
 var strFile = varReturn.split("||") ;
 m("varWakeUp").value = strFile[0] ;
...
function auditLogList(){
 var file = window.showModalDialog("/UserFunctionAction.do?tableName=tblSampleOrder&keyId="+valueId+"&checkTab=Y&optionType=Auditing&type=audtiting&operation=5&fromPage=yes",
...
function selectReadPerson(){
 var varPerson = window.showModalDialog("/vm/oa/fileflow/selectReadPerson.jsp?keyId="+valueId+"&tableName=tblSampleOrder&wakeup="+strWakeUp,
 winObj,"dialogWidth:700px;dialogHeight:300px;center:yes;help:no;resizable:no;status:no;scroll:no;") ;
}
function newSave()
{ 
...
function onCompleteUpload(retstr,btnId){ 
 ...
 if(str == "") continue;
 var ul=$('#'+buttonId);
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div class='showAffix'>"+str+"</div><a class='showAffixDel' href='javascript:deleteupload(\""+str+"\",\"true\",\"tblSampleOrder\",\"AFFIX\");'>删除</a><a class='showAffixDown' href=\"/ReadFile?fileName="+encodeURI(str)+"&realName="+encodeURI(str)+"&tempFile=true&type=AFFIX\" target=_blank>下载</a></li>";
 ul.append(imgstr);
 }
 } 
 var attachUpload = document.getElementById("attachUpload");
...
function linkPIC(btnId){
 ...
 　　　if(action == 'ok'){
 　　　　　str = val;
 var imgstr = "<li style='background:url();' id='uploadfile_"+str+"'><input type=hidden name="+hiddenName+" value='"+str+"'><div><a href=\""+str+"\" target=\"_blank\"><img src=\""+str+"\" width=\"150\" border=\"0\"></a></div><div><em>"+str+"</em><a style=\"cursor:pointer;\" href='javascript:void(0);' onclick='deleteupload(\""+str+"\",\"false\",\"tblSampleOrder\",\"PIC\");'>删除</a></div></li>";
 ul.append(imgstr);
 　　　}
 }); 
}
...
var fieldDigit = new Array();
 fieldDigit[fieldDigit.length] = {name:'Price',dis:'试制单价',digit:4,isMain:true};
...
function beforSubmit(form){ 
 ...
 var strReturn = window.showModalDialog("/OAFileWorkFlowAction.do?operation=94&type=add&tableName=tblSampleOrder",
...
function printData(billId,reportNumber){ 
 if(printRight){
 if(confirm("是否打印单据?")){
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblSampleOrder&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&printType=savePrint&winCurIndex="+winCurIndex ;
...
function prints(billId,reportNumber){
 ...
 billId2=billId
 var strUrl = "/UserFunctionQueryAction.do?tableName=tblSampleOrder&reportNumber="+reportNumber+"&moduleType="+moduleType+"&operation=18&BillID="+billId+"&parentTableName=&winCurIndex="+winCurIndex;
 asyncbox.open({id:'printPopup',title:'科荣控件',url:strUrl,width:300,height:280});
 enableForm(form);
}
...
function resetSubmit(fieldName){
 ...
 var saveField=n("MovementID"); 
 saveField[0].value = "";
 var obj = m("tbl_tblSampleOrder_MovementID");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGoods_MovementNo"); 
 saveField[0].value = "";
 var obj = m("tbl_tblMovement_GoodsNumber");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("BTCode"); 
 saveField[0].value = "";
 var obj = m("tbl_tblSampleOrder_BTCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("Brand"); 
 saveField[0].value = "";
 var obj = m("tbl_tblSampleOrder_Brand");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("Price"); 
 saveField[0].value = "";
 var obj = m("tbl_tblSampleOrder_Price");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("Remark"); 
 saveField[0].value = "";
 var obj = m("tbl_tblSampleOrder_Remark");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("leOrder_Bill");
 saveField[0].value = ""; 
 m("tbl_leOrder_Bill").value = "" ;
 }
 ...
 var saveField=n("tblGoods_MovementNo");
 saveField[0].value = ""; 
 m("tbl_tblGoods_MovementNo").value = "" ;
 }
 if(fieldName == "MovementID1"){
 var saveField=n("MovementID1"); 
 saveField[0].value = "";
 var obj = m("tbl_tblGoods_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGoods_MovementNo1");
 saveField[0].value = ""; 
 m("tbl_tblGoods_MovementNo1").value = "" ;
 }
 if(fieldName == "MovementID2"){
 var saveField=n("MovementID2"); 
 saveField[0].value = "";
 var obj = m("tbl_tblGoods_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGoods_MovementNo2");
 saveField[0].value = ""; 
 m("tbl_tblGoods_MovementNo2").value = "" ;
 }
 if(fieldName == "MovementID3"){
 var saveField=n("MovementID3"); 
 saveField[0].value = "";
 var obj = m("tbl_tblGoods_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGoods_MovementNo3");
 saveField[0].value = ""; 
 m("tbl_tblGoods_MovementNo3").value = "" ;
 }
 if(fieldName == "MovementID4"){
 var saveField=n("MovementID4"); 
 saveField[0].value = "";
 var obj = m("tbl_tblGoods_classCode");
 if(obj != null){
 obj.value = "";
 }
 var saveField=n("tblGoods_MovementNo4");
 saveField[0].value = ""; 
 m("tbl_tblGoods_MovementNo4").value = "" ;
 }
 if(fieldName == "Brand"){
 var saveField=n("Brand"); 
 saveField[0].value = "";
...
function dyGetCalculate(url,obj){
 ...
 fieldName = "tblSampleOrder"+"_"+obj.name ;
 }
...
function sendBillMsg(action){
 ...
 var strurl = "/vm/classFunction/sendBillMsg.jsp?tableName=tblSampleOrder&action="+action
...
function telCall()
{
 var str = window.showModalDialog("/TelAction.do?operator=callTel&from=tblSampleOrder&keyId="+valueId,"","dialogWidth=600px;dialogHeight=350px"); 
}
...
function showDivCustomSetTable(){ 
 ...
 var strUrl = "/UserFunctionAction.do?tableName=tblSampleOrder&moduleType="+moduleType+"&winCurIndex="+winCurIndex+"&f_brother=&noback="+noback+"&parentCode=&operation=6&parentTableName=&configType=colConfig" ;
...
function fillColConfig(returnValue){
 ...
 var tables = "tblSampleOrder,".split(",") ;
 ...
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblSampleOrder&allTableName=tblSampleOrder,&colType=bill&colSelect="+ strCols;
 }else if("defaultConfig"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblSampleOrder&allTableName=&colType=bill" ;
 }else if("colWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=colconfig&tableName=tblSampleOrder&colType=colWidth&colSelect="+strType[1] ;
 }else if("defaultWidth"==strType[0]){
 var strURL = "/UtilServlet?operation=defaultConfig&tableName=tblSampleOrder&allTableName=&colType=colWidth" ;
...
function seqInput(){
 ...
 var cTabName = "tblSampleOrderDet";
 var stockCode="";
...
function extendSubmit(vars,vname,selected)
{
 ...
 var varValue = window.showModalDialog("/vm/oa/oaPublicMsg/folderRight.jsp?tableName=tblSampleOrder&keyId="+keyIdStr,"","dialogWidth=565px;dialogHeight=350px") ;
 if(typeof(varValue)=="undefined")return ;
...
function update(){ 
 location.href="/UserFunctionAction.do?tableName=tblSampleOrder&designId=tblSampleOrder&keyId="+$("#id").val()+
...
{ 
 form.target = ""; 
 form.action="/UserFunctionAction.do?&operation=17&tableName=tblSampleOrder&saveDraft=&&keyId="+keyId+
...
function checkSave(str){ 
 ...
 jQuery.post("/UserFunctionQueryAction.do?tableName=tblSampleOrder&operation=25&ButtonType=saveCheckBill&varKeyIds="+cid+defi,
 {ButtonTypeName:'审核保存'},
 function(data){
 if(data=="OK"){
 checkDialog("/OAMyWorkFlow.do?keyId="+cid+"&tableName=tblSampleOrder&operation=82&fromPage=erp");
...
function hurryTrans(){
 ren = '样板订单';
 var url="/vm/oa/workflow/noteModel.jsp?tableName=tblSampleOrder&moduleName="+encodeURI(ren)+"&keyId="+$("#id").val();
 asyncbox.open({ 
